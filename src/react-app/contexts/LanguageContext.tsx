...
const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    // Hero Section
    'hero.title.part1': 'Recupera el teu',
    'hero.title.part2': 'Equilibri',
    'hero.subtitle': 'Teràpies holístiques avançades a Barcelona. On la ciència es troba amb la serenitat per restaurar el teu cos i ment.',
    'hero.cta.primary': 'Reserva la teva Sessió',
    'hero.cta.secondary': 'Descobreix el teu Camí',
    'hero.badge': 'Benestar Holístic a Barcelona',
  ...
  en: {
    ...
    'hero.title': 'Restore Your Natural Balance',
    'hero.subtitle': 'A sanctuary in Barcelona where therapeutic massage, somatic education, and advanced kinesiology converge. We don’t just treat pain; we help you rediscover the wisdom of your body.',
    'hero.firstTime': 'New to EKA Balance?',
    'hero.dontKnowWhatToChoose': 'Not sure where to start?',
    'hero.discoverServices': 'Explore Our Services',
    'hero.stats.sessions': 'Sessions Given',
    'hero.stats.clients': 'Lives Transformed',
    ...
    'services.massage.subtitle': 'Beyond Relaxation: Deep Restoration',
    'services.massage.description': 'Experience a true therapeutic reset. We combine myofascial release with deep tissue techniques to dissolve chronic tension, enhance your mobility, and quiet your mind. It’s not just about feeling good for an hour; it’s about lasting relief.',
    'services.kinesiology.title': 'Holistic Kinesiology',
    'services.kinesiology.subtitle': 'Decode Your Body’s Signals',
    'services.kinesiology.description': 'Your body holds the answers. Through precise muscle testing, we uncover the hidden sources of imbalance—be it physical trauma, emotional stress, or biochemical needs. Kinesiology is the key to understanding exactly what your system needs right now to heal.',
    'services.nutrition.title': 'Conscious Nutrition',
    'services.nutrition.subtitle': 'Fuel Your Vitality, Heal from Within',
    'services.nutrition.description': 'True nutrition is about biochemistry, not just calories. We design personalized plans that optimize your energy, heal your gut, and support your nervous system, giving you the foundation for vibrant health.',
    'services.revision360.title': '360° Health Review',
    'services.revision360.subtitle': 'The Blueprint of Your Well-being',
    'services.revision360.description': 'A comprehensive diagnostic session that analyzes your posture, movement patterns, and metabolic health. We create a precise, actionable roadmap for your recovery and long-term vitality.',
    ...
    'casos.problems.backPain.description': 'More than just discomfort—it’s a burden you don’t have to carry. Whether it’s lumbar pain, cervical stiffness, or that feeling of "carrying the world on your shoulders," we can help.',
    'casos.problems.stress.title': 'Stress and Anxiety',
    'casos.problems.stress.description': 'When your mind won’t stop, your body pays the price. If you feel stuck in "permanent alert," experiencing palpitations, chest tension, or insomnia, it’s time to reset.',
    'casos.problems.digestive.title': 'Digestive Issues',
    'casos.problems.digestive.description': 'Your gut is your second brain. When it’s blocked, it affects everything—from your energy to your emotions. We help you find flow again.',
    'casos.problems.migraines.title': 'Migraines and Head Tension',
    'casos.problems.migraines.description': 'Recurring headaches, photophobia, or extreme fatigue can stop life in its tracks. We help you clear the fog and release the tension holding you back.',
    'casos.problems.lowEnergy.title': 'Low Energy & Fatigue',
    'casos.problems.lowEnergy.description': 'Waking up tired? Feeling like you’re running on autopilot? It’s not laziness—it’s a sign your internal battery needs a recharge.',
    'casos.problems.hormonal.title': 'Hormonal Imbalances',
    'casos.problems.hormonal.description': 'Your cycle is a vital sign. Pain, irregularity, or exhaustion are messages that your body needs balance. We help you tune in.',
    'casos.problems.sleep.title': 'Sleep Difficulties',
    'casos.problems.sleep.description': 'Rest is the foundation of health. If your mind races at night or you wake up unrefreshed, we can help you rediscover deep, restorative sleep.',
    'casos.problems.recovery.title': 'Injury Recovery',
    'casos.problems.recovery.description': 'After an accident or surgery, the body can hold onto stiffness and fear. We guide you back to confidence and fluid movement.',
  ...
  es: {
    ...
    // Hero Section
    'hero.title.part1': 'Recupera tu',
    'hero.title.part2': 'Equilibrio',
    'hero.subtitle': 'Terapias holísticas avanzadas en Barcelona. Donde la ciencia se encuentra con la serenidad para restaurar tu cuerpo y mente.',
    'hero.cta.primary': 'Reserva tu Sesión',
    'hero.cta.secondary': 'Descubre tu Camino',
    'hero.badge': 'Bienestar Holístico en Barcelona',
    'hero.stats.clients': 'Clientes Satisfechos',
    'hero.stats.experience': 'Años de Experiencia',
    'hero.stats.rating': 'Valoración 5 Estrellas',

    // About Section
    'about.badge': 'Sobre Mí',
    'about.title': 'Hola, soy Elena',
    'about.role': 'Terapeuta Holística Senior & Experta en Kinesiología',
    'about.description1': 'Con más de 15 años de experiencia clínica, he dedicado mi vida a entender el lenguaje del cuerpo humano. Mi enfoque no es solo aliviar el dolor, sino desbloquear el potencial de tu cuerpo para sanarse a sí mismo.',
    'about.description2': 'Combino la precisión de la kinesiología moderna con la sabiduría de las terapias manuales tradicionales. Cada sesión es un diálogo con tu sistema nervioso, buscando la raíz de la tensión en lugar de solo tratar los síntomas.',
    'about.cta': 'Conoce mi Historia',

    // Services Section
    'services.badge': 'Mis Servicios',
    'services.title': 'Terapias Diseñadas para Ti',
    'services.subtitle': 'Un enfoque integral que combina técnicas manuales, energéticas y neurológicas para resultados profundos y duraderos.',
    'services.cta': 'Ver Todos los Servicios',

    // Service: Massage
    'massage.title': 'Masaje Terapéutico',
    'massage.desc': 'Más que un masaje, es una restauración estructural. Combinamos técnicas de tejido profundo con liberación miofascial para disolver la tensión crónica y restaurar la movilidad.',
    'massage.benefit1': 'Alivio del dolor profundo',
    'massage.benefit2': 'Mejora de la postura',
    'massage.benefit3': 'Reducción del estrés',
    'massage.benefit4': 'Recuperación muscular',

    // Service: Kinesiology
    'kinesiology.title': 'Kinesiología Aplicada',
    'kinesiology.desc': 'Un diálogo directo con tu cuerpo. Utilizamos el test muscular para identificar desequilibrios estructurales, químicos y emocionales, corrigiéndolos desde la raíz.',
    'kinesiology.benefit1': 'Diagnóstico preciso',
    'kinesiology.benefit2': 'Equilibrio energético',
    'kinesiology.benefit3': 'Corrección postural',
    'kinesiology.benefit4': 'Bienestar integral',

    // Service: Nutrition
    'nutrition.title': 'Nutrición Consciente',
    'nutrition.desc': 'Alimenta tu vitalidad. Planes nutricionales personalizados que no solo nutren tu cuerpo, sino que apoyan tu sistema nervioso y equilibrio hormonal.',
    'nutrition.benefit1': 'Energía sostenida',
    'nutrition.benefit2': 'Digestión saludable',
    'nutrition.benefit3': 'Claridad mental',
    'nutrition.benefit4': 'Equilibrio hormonal',

    // Problems / Casos Section
    'problems.badge': 'Soluciones Reales',
    'problems.title': 'Entendemos tu Dolor',
    'problems.subtitle': 'No estás solo. Hemos ayudado a cientos de personas a superar estos mismos desafíos.',

    // Problem: Back Pain
    'problems.backpain.title': 'Dolor de Espalda Crónico',
    'problems.backpain.desc': 'Esa molestia constante que no te deja descansar ni trabajar en paz.',
    'problems.backpain.solution': 'Nuestra Solución',
    'problems.backpain.solutionDesc': 'Descompresión vertebral y reeducación postural para un alivio duradero.',

    // Problem: Stress
    'problems.stress.title': 'Estrés y Ansiedad',
    'problems.stress.desc': 'La mente no para, el pecho oprime y el descanso no es reparador.',
    'problems.stress.solution': 'Nuestra Solución',
    'problems.stress.solutionDesc': 'Regulación del sistema nervioso mediante terapia craneosacral y respiración.',

    // Problem: Fatigue
    'problems.fatigue.title': 'Fatiga y Baja Energía',
    'problems.fatigue.desc': 'Te levantas cansado y llegas al final del día agotado.',
    'problems.fatigue.solution': 'Nuestra Solución',
    'problems.fatigue.solutionDesc': 'Reactivación metabólica y desbloqueo energético para recuperar tu vitalidad.',

    // Problem: Injuries
    'problems.injuries.title': 'Lesiones Deportivas',
    'problems.injuries.desc': 'Dolores que limitan tu rendimiento y te impiden entrenar al 100%.',
    'problems.injuries.solution': 'Nuestra Solución',
    'problems.injuries.solutionDesc': 'Rehabilitación funcional acelerada y prevención de recaídas.',
