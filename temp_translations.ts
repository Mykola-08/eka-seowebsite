export const translations = {
  ...
  'hero.subtitle': {
    ca: 'Escolta el teu cos. Entén la teva història. Recupera la teva vida.',
    en: 'Listen to your body. Understand your story. Reclaim your life.',
    es: 'Escucha tu cuerpo. Entiende tu historia. Recupera tu vida.',
    ru: 'Слушайте свое тело. Поймите свою историю. Верните свою жизнь.'
  },
  'hero.description': {
    ca: 'Un viatge de 90 minuts per mapar el teu paisatge físic, emocional i energètic. No és només un diagnòstic — és el primer pas per tornar a casa, al teu cos.',
    en: 'A 90-minute journey to map your physical, emotional, and energetic landscape. It\'s not just a diagnosis — it\'s the first step to coming home to your body.',
    es: 'Un viaje de 90 minutos para mapear tu paisaje físico, emocional y energético. No es solo un diagnóstico — es el primer paso para volver a casa, a tu cuerpo.',
    ru: '90-минутное путешествие для картирования вашего физического, эмоционального и энергетического ландшафта. Это не просто диагностика — это первый шаг к возвращению домой, в свое тело.'
  },
  'hero.cta': {
    ca: 'Comença el Teu Viatge',
    en: 'Begin Your Journey',
    es: 'Comienza Tu Viaje',
    ru: 'Начните Свое Путешествие'
  },
  'hero.scroll': {
    ca: 'Descobreix l\'Enfocament 360°',
    en: 'Discover the 360° Approach',
    es: 'Descubre el Enfoque 360°',
    ru: 'Откройте Подход 360°'
  },
  'why.title': {
    ca: 'Per què 360°?',
    en: 'Why 360°?',
  ...
  'why.subtitle': {
    ca: 'Perquè no ets només una col·lecció de parts. Ets un sistema complet.',
    en: 'Because you are not just a collection of parts. You are a whole system.',
    es: 'Porque no eres solo una colección de partes. Eres un sistema completo.',
    ru: 'Потому что вы не просто набор частей. Вы — целая система.'
  },
  'why.physical.title': {
    ca: 'El Cos Físic',
  ...
  'why.physical.desc': {
    ca: 'On viu la tensió. Llegim l\'estructura, la fàscia i la postura per trobar on estàs aguantant.',
    en: 'Where tension lives. We read structure, fascia, and posture to find where you are holding on.',
    es: 'Donde vive la tensión. Leemos la estructura, la fascia y la postura para encontrar dónde estás aguantando.',
    ru: 'Где живет напряжение. Мы читаем структуру, фасцию и осанку, чтобы найти, где вы держитесь.'
  },
  'why.emotional.title': {
    ca: 'El Cos Emocional',
    en: 'The Emotional Body',
    es: 'El Cuerpo Emocional',
    ru: 'Эмоциональное Тело'
  },
  'why.emotional.desc': {
    ca: 'On s\'emmagatzema la història. Les emocions no processades es converteixen en bloquejos físics.',
    en: 'Where history is stored. Unprocessed emotions become physical blockages.',
    es: 'Donde se almacena la historia. Las emociones no procesadas se convierten en bloqueos físicos.',
    ru: 'Где хранится история. Необработанные эмоции становятся физическими блоками.'
  },
  'why.energetic.title': {
    ca: 'El Cos Energètic',
    en: 'The Energetic Body',
    es: 'El Cuerpo Energético',
    ru: 'Энергетическое Тело'
  },
  'why.energetic.desc': {
    ca: 'On flueix la vitalitat. Restaurem el flux perquè la sanació pugui ocórrer naturalment.',
    en: 'Where vitality flows. We restore flow so healing can happen naturally.',
    es: 'Donde fluye la vitalidad. Restauramos el flujo para que la sanación pueda ocurrir naturalmente.',
    ru: 'Где течет жизненная сила. Мы восстанавливаем поток, чтобы исцеление могло происходить естественно.'
  },
  'service.title': {
    ca: 'L\'Experiència',
    en: 'The Experience',
  ...
  'service.step1.title': {
    ca: '1. L\'Entrevista Profunda',
    en: '1. The Deep Interview',
    es: '1. La Entrevista Profunda',
    ru: '1. Глубокое Интервью'
  },
  'service.step1.desc': {
    ca: 'Més enllà de l\'historial mèdic. Parlem de la teva vida, el teu estrès, els teus somnis i el que el teu cos ha estat intentant dir-te.',
    en: 'Beyond medical history. We talk about your life, your stress, your dreams, and what your body has been trying to tell you.',
    es: 'Más allá del historial médico. Hablamos de tu vida, tu estrés, tus sueños y lo que tu cuerpo ha estado tratando de decirte.',
    ru: 'За пределами медицинской истории. Мы говорим о вашей жизни, вашем стрессе, ваших мечтах и о том, что ваше тело пыталось вам сказать.'
  },
  'service.step2.title': {
    ca: '2. El Mapeig Corporal',
    en: '2. The Body Mapping',
    es: '2. El Mapeo Corporal',
    ru: '2. Телесное Картирование'
  },
  'service.step2.desc': {
    ca: 'Una lectura pràctica de la teva estructura. Identifiquem desequilibris, restriccions fascials i àrees d\'energia estancada.',
    en: 'A hands-on reading of your structure. We identify imbalances, fascial restrictions, and areas of stagnant energy.',
    es: 'Una lectura práctica de tu estructura. Identificamos desequilibrios, restricciones fasciales y áreas de energía estancada.',
    ru: 'Практическое чтение вашей структуры. Мы выявляем дисбалансы, фасциальные ограничения и области застойной энергии.'
  },
  'service.step3.title': {
    ca: '3. La Sessió d\'Integració',
    en: '3. The Integration Session',
    es: '3. La Sesión de Integración',
    ru: '3. Сессия Интеграции'
  },
  'service.step3.desc': {
    ca: 'Utilitzant una barreja de modalitats (massatge, kinesiologia, treball energètic) per començar el procés de desbloqueig i realineament.',
    en: 'Using a blend of modalities (massage, kinesiology, energy work) to begin the process of unlocking and realigning.',
    es: 'Utilizando una mezcla de modalidades (masaje, kinesiología, trabajo energético) para comenzar el proceso de desbloqueo y realineación.',
    ru: 'Использование смеси модальностей (массаж, кинезиология, энергетическая работа) для начала процесса разблокировки и выравнивания.'
  },
  'service.step4.title': {
    ca: '4. El Pla de Ruta',
    en: '4. The Roadmap',
    es: '4. El Mapa de Ruta',
    ru: '4. Дорожная Карта'
  },
  'service.step4.desc': {
    ca: 'No marxes amb les mans buides. Rebràs un pla personalitzat amb exercicis, consells d\'estil de vida i recomanacions de tractament.',
    en: 'You don\'t leave empty-handed. You receive a personalized plan with exercises, lifestyle tips, and treatment recommendations.',
    es: 'No te vas con las manos vacías. Recibes un plan personalizado con ejercicios, consejos de estilo de vida y recomendaciones de tratamiento.',
    ru: 'Вы не уходите с пустыми руками. Вы получаете персонализированный план с упражнениями, советами по образу жизни и рекомендациями по лечению.'
  },
  'variants.title': {
    ca: 'Tria el Teu Camí',
    en: 'Choose Your Path',
  ...
  'variants.mapping.desc': {
    ca: 'La sessió fonamental. Diagnòstic complet + primer tractament.',
    en: 'The foundational session. Full diagnosis + first treatment.',
    es: 'La sesión fundamental. Diagnóstico completo + primer tratamiento.',
    ru: 'Фундаментальная сессия. Полная диагностика + первое лечение.'
  },
  ...
  'variants.alignment.duration': {
    ca: 'Pack de 3 Sessions',
    en: '3 Session Pack',
    es: 'Pack de 3 Sesiones',
    ru: 'Пакет из 3 сессий'
  },
  'variants.alignment.desc': {
    ca: 'Per a un treball més profund. Inclou Mapeig + 2 sessions de seguiment focalitzades.',
    en: 'For deeper work. Includes Mapping + 2 focused follow-up sessions.',
    es: 'Para un trabajo más profundo. Incluye Mapeo + 2 sesiones de seguimiento focalizadas.',
    ru: 'Для более глубокой работы. Включает Картирование + 2 сфокусированные последующие сессии.'
  },
  'variants.integral.title': {
    ca: 'Transformació Integral',
    en: 'Integral Transformation',
    es: 'Transformación Integral',
    ru: 'Интегральная Трансформация'
  },
  'variants.integral.price': {
    ca: '450€',
    en: '€450',
    es: '450€',
    ru: '450€'
  ...
  'variants.integral.duration': {
    ca: 'Programa de 6 Setmanes',
    en: '6 Week Program',
    es: 'Programa de 6 Semanas',
    ru: '6-недельная программа'
  },
  'variants.integral.desc': {
    ca: 'Canvi de vida complet. Mapeig + 5 sessions + suport continu.',
    en: 'Complete life shift. Mapping + 5 sessions + ongoing support.',
    es: 'Cambio de vida completo. Mapeo + 5 sesiones + apoyo continuo.',
    ru: 'Полное изменение жизни. Картирование + 5 сессий + постоянная поддержка.'
  },
  'variants.book': {
    ca: 'Reservar Ara',
    en: 'Book Now',
