...
const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    // Hero Section
    'hero.title': 'Restaura la teva Vitalitat Sistèmica',
    'hero.title.part1': 'Restaura la teva',
    'hero.title.part2': 'Vitalitat Sistèmica',
    'hero.subtitle': 'Centre de referència en teràpies somàtiques i regulació del sistema nerviós a Barcelona. Integració clínica i benestar profund.',
  ...
  en: {
    ...
    'hero.title': 'Restore Your Systemic Vitality',
    'hero.subtitle': 'Advanced neuro-regulation and structural integration protocols. We address the root cause of dysfunction to restore your body\'s innate capacity for self-regulation.',
  ...
  es: {
    ...
    // Hero Section
    'hero.title': 'Restaura tu Vitalidad Sistémica',
    'hero.title.part1': 'Restaura tu',
    'hero.title.part2': 'Vitalidad Sistémica',
    'hero.subtitle': 'Centro de referencia en terapias somáticas y regulación del sistema nervioso en Barcelona. Integración clínica y bienestar profundo.',
  ...
  ru: {
    ...
    // Hero section
    'hero.badge': 'Клиническое Совершенство в Интегративной Медицине',
    'hero.title': 'Восстановите Системную Витальность',
    'hero.subtitle': 'Ведущий центр соматической терапии и нейрорегуляции в Барселоне. Клиническая интеграция для глубокого восстановления здоровья.',
