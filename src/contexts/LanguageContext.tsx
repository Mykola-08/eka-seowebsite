...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'personalized.students.hero.description': 'When you study, tension concentrates in the mind and neck. Do you find it hard to focus, lack energy, or feel overwhelmed? At EKA Balance we help you reconnect with your body, improve posture, and recover mental calm.',
    ...
    'personalized.parents.hero.title': 'For those who take care of everyone but themselves',
    'personalized.parents.hero.description': 'We help you recover energy, peace, and clarity so you can give without emptying yourself.',
    'personalized.parents.understanding.title': 'We know you need time for yourself',
    'personalized.parents.understanding.description1': 'We help you recover energy, peace, and clarity so you can give without emptying yourself.',
    ...
    'personalized.parents.understanding.callToAction': 'You deserve to take time to recharge and be better for your loved ones.',
    'personalized.parents.services.title': 'Sessions designed for mothers and fathers',
    ...
    'personalized.parents.services.emotionalKinesiology.description': 'Specific therapy to manage family stress and restore emotional balance.',
    ...
    'personalized.parents.testimonial.title': 'A mother\'s experience',
  ...
  es: {
    ...
    'personalized.ortists.hero.title': 'Artistas visuales',
    ...
    'personalized.afficeWorkers.testimonial.title': 'Testimonio',
    ...
    'personalized.parents.hero.title': 'Para quien cuida de todos menos de sí mismo',
    'personalized.parents.hero.description': 'Te ayudamos a recuperar energía, paz y claridad para poder dar sin vaciarte.',
    'personalized.parents.understanding.title': 'Sabemos que necesitas tiempo para ti',
    'personalized.parents.understanding.description1': 'Te ayudamos a recuperar energía, paz y claridad para poder dar sin vaciarte.',
    'personalized.parents.understanding.description2': 'Ser padre o madre es una tarea intensa que a menudo deja poco tiempo para el autocuidado.',
    'personalized.parents.understanding.callToAction': 'Mereces tomarte un tiempo para recargar energías y estar mejor para los tuyos.',
    'personalized.parents.services.title': 'Sesiones pensadas para padres y madres',
    'personalized.parents.services.subtitle': 'Tratamientos para recuperar energía y equilibrio emocional',
    'personalized.parents.services.emotionalKinesiology.title': 'Kinesiología emocional',
    'personalized.parents.services.emotionalKinesiology.description': 'Terapia específica para gestionar el estrés familiar y recuperar el equilibrio emocional.',
    'personalized.parents.services.relaxingMassage.title': 'Masaje relajante y conciencia corporal',
    'personalized.parents.services.relaxingMassage.description': 'Sesión de desconexión profunda para liberar tensiones acumuladas y recuperar energía.',
    'personalized.parents.testimonial.title': 'Experiencia de una madre',
    'personalized.parents.testimonial.quote': 'Después de las sesiones, me siento más paciente con los niños y tengo más energía para disfrutar realmente del tiempo en familia.',
    'personalized.parents.testimonial.author': 'Laura, madre de dos hijos',
  ...
  ru: {
    ...
    'elena.approach.desc': 'В основе моей работы лежит глубокое понимание того, что тело, мозг и эмоции — это единая система. Я работаю не с симптомами, а ищу их первопричину, помогая организму восстановить естественную способность к саморегуляции. Мой метод объединяет передовые техники работы с телом и нервной системой: Movement Lesson™, JKA (Jeremy Krauss Approach (JKA)), child’space, Feldenkrais и биодинамику. Это мягкое, но мощное воздействие, которое переобучает нервную систему, снимает глубинные напряжения и возвращает легкость движения и ясность ума.',
    ...
    'personalized.ortists.hero.title': 'Артисты',
    ...
    'personalized.afficeWorkers.testimonial.title': 'Отзыв',
    ...
    'personalized.parents.hero.title': 'Для тех, кто заботится обо всех, кроме себя',
    'personalized.parents.hero.description': 'Мы помогаем вам восстановить энергию, спокойствие и ясность, чтобы вы могли отдавать, не опустошая себя.',
    'personalized.parents.understanding.title': 'Мы знаем, что вам нужно время для себя',
    'personalized.parents.understanding.description1': 'Мы помогаем вам восстановить энергию, спокойствие и ясность, чтобы вы могли отдавать, не опустошая себя.',
    'personalized.parents.understanding.description2': 'Быть родителем — это интенсивная задача, которая часто оставляет мало времени для заботы о себе.',
    'personalized.parents.understanding.callToAction': 'Вы заслуживаете того, чтобы найти время для перезарядки и быть лучше для своих близких.',
    'personalized.parents.services.title': 'Сессии, разработанные для родителей',
    'personalized.parents.services.subtitle': 'Процедуры для восстановления энергии и эмоционального равновесия',
    'personalized.parents.services.emotionalKinesiology.title': 'Эмоциональная кинезиология',
    'personalized.parents.services.emotionalKinesiology.description': 'Специальная терапия для управления семейным стрессом и восстановления эмоционального равновесия.',
    'personalized.parents.services.relaxingMassage.title': 'Расслабляющий массаж и осознание тела',
    'personalized.parents.services.relaxingMassage.description': 'Сессия глубокого отключения для освобождения от накопившегося напряжения и восстановления энергии.',
    'personalized.parents.testimonial.title': 'Опыт мамы',
    'personalized.parents.testimonial.quote': 'После сеансов я чувствую себя более терпеливой с детьми, и у меня больше энергии, чтобы действительно наслаждаться семейным временем.',
    'personalized.parents.testimonial.author': 'Лаура, мама двоих детей',
