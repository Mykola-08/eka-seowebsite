...
const rawTranslations: Translations = {
  ...
  'revision360.hero.badge': {
    ...
    en: 'Integral Method',
    es: 'Método Integral',
    ru: 'Интегральный метод'
  },
  'revision360.hero.byEka': {
    ca: 'Per EKA Balance',
    en: 'By EKA Balance',
    es: 'Por EKA Balance',
    ru: 'От EKA Balance'
  ...
  'revision360.why360.modal.title': {
    ca: 'La filosofia 360°',
    en: 'The 360° philosophy',
    es: 'La filosofía 360°',
    ru: 'Философия 360°'
  },
  'revision360.why360.modal.intro': {
  ...
  'revision360.why360.modal.integration.title': {
  ...
  'revision360.why360.modal.dimensions.title': {
    ca: 'Les quatre dimensions',
    en: 'The four dimensions',
    es: 'Las cuatro dimensiones',
    ru: 'Четыре измерения'
  },
  'revision360.why360.modal.importance.title': {
  ...
  'revision360.why360.layers.structural': {
    ca: 'Estructural',
    en: 'Structural',
    es: 'Estructural',
    ru: 'Структурный'
  ...
  'revision360.why360.structural.desc': {
  ...
  'revision360.why360.complete': {
    ca: 'Complet',
    en: 'Complete',
    es: 'Completo',
    ru: 'Полный'
  },
  'revision360.why360.philosophy': {
  ...
  'revision360.whatsapp.consultation': {
  ...
  // Service Section
  'revision360.service.badge': {
    ca: 'El Procés',
    en: 'The Process',
    es: 'El Proceso',
    ru: 'Процесс'
  },
  'revision360.service.step': {
    ca: 'Pas',
    en: 'Step',
    es: 'Paso',
    ru: 'Шаг'
  ...
  'revision360.service.total.title': {
    ca: 'Sessió 360° completa',
    en: 'Complete 360° session',
    es: 'Sesión 360° completa',
    ru: 'Полная сессия 360°'
  },
  'revision360.service.total.duration': {
    ca: '4.5 hores total',
    en: '4.5 hours total',
    es: '4.5 horas total',
    ru: '4.5 часа всего'
  },
  'revision360.service.total.note': {
  ...
  // Emotional Section
  'revision360.emotional.title': {
    ca: 'Per què el teu cos mereix ser comprès, no arreglat.',
  ...
  'revision360.emotional.subtitle': {
  ...
  'revision360.benefits.science_label': {
    ca: 'Ciència',
    en: 'Science',
    es: 'Ciencia',
    ru: 'Наука'
  ...
  'revision360.final.scheduleDiscovery': {
  ...
  // WhatsApp Messages (Discovery)
  'revision360.whatsapp.discoveryCall': {
  ...
  'revision360.variants.idealFor': {
    ca: 'Ideal per a',
    en: 'Ideal for',
    es: 'Ideal para',
    ru: 'Идеально для'
  },
  'revision360.variants.includes': {
    ca: 'Què inclou',
    en: 'What includes',
    es: 'Qué incluye',
    ru: 'Что включает'
  },
  'revision360.variants.sessionDuration': {
    ca: 'Durada de la sessió',
    en: 'Session duration',
    es: 'Duración de la sesión',
    ru: 'Продолжительность сессии'
  },
  'revision360.variants.investment': {
    ca: 'Inversió',
    en: 'Investment',
    es: 'Inversión',
    ru: 'Инвестиция'
  },
  'revision360.variants.bookSession': {
    ca: 'Reservar aquesta sessió',
    en: 'Book this session',
    es: 'Reservar esta sesión',
    ru: 'Забронировать эту сессию'
  },
  'revision360.variants.clickForDetails': {
  ...
  // Variant Reset
  'revision360.variants.reset.title': {
    ca: 'Reinici 360°',
    en: 'Reset 360°',
    es: 'Reinicio 360°',
    ru: 'Перезагрузка 360°'
  },
  'revision360.variants.reset.subtitle': {
  ...
  'revision360.variants.reset.idealFor.1': {
  ...
  'revision360.variants.reset.idealFor.2': {
  ...
  'revision360.variants.reset.idealFor.3': {
  ...
  'revision360.variants.reset.idealFor.4': {
    ca: 'Recuperació post-trauma',
    en: 'Post-trauma recovery',
    es: 'Recuperación post-trauma',
    ru: 'Восстановление после травмы'
  },
  'revision360.variants.reset.duration': {
    ca: '3 hores',
    en: '3 hours',
    es: '3 horas',
    ru: '3 часа'
  },
  'revision360.variants.reset.includes.1': {
  ...
  'revision360.variants.reset.includes.2': {
  ...
  'revision360.variants.reset.includes.3': {
  ...
  'revision360.variants.reset.includes.4': {
  ...
  // Variant Mapping
  'revision360.variants.mapping.title': {
    ca: 'Mapeig 360°',
    en: 'Mapping 360°',
    es: 'Mapeo 360°',
    ru: 'Картирование 360°'
  },
  'revision360.variants.mapping.subtitle': {
  ...
  'revision360.variants.mapping.idealFor.1': {
  ...
  'revision360.variants.mapping.idealFor.2': {
  ...
  'revision360.variants.mapping.idealFor.3': {
  ...
  'revision360.variants.mapping.idealFor.4': {
  ...
  'revision360.variants.mapping.duration': {
    ca: '2.5 hores',
    en: '2.5 hours',
    es: '2.5 horas',
    ru: '2.5 часа'
  },
  'revision360.variants.mapping.includes.1': {
    ca: 'Escaneig corporal integral',
    en: 'Comprehensive body scan',
    es: 'Escaneo corporal integral',
    ru: 'Комплексное сканирование тела'
  },
  'revision360.variants.mapping.includes.2': {
  ...
  // Variant Alignment
  'revision360.variants.alignment.title': {
    ca: 'Alineació 360°',
    en: 'Alignment 360°',
    es: 'Alineación 360°',
    ru: 'Выравнивание 360°'
  ...
  'revision360.variants.alignment.idealFor.4': {
  ...
  'revision360.variants.alignment.duration': {
    ca: '2 hores',
    en: '2 hours',
    es: '2 horas',
    ru: '2 часа'
  },
  'revision360.variants.alignment.includes.1': {
  ...
  // Variant Integral
  'revision360.variants.integral.title': {
    ca: 'Integral 360°',
    en: 'Integral 360°',
    es: 'Integral 360°',
    ru: 'Интегральный 360°'
  },
  'revision360.variants.integral.subtitle': {
  ...
  'revision360.variants.integral.idealFor.3': {
  ...
  'revision360.variants.integral.idealFor.4': {
  ...
  'revision360.variants.integral.includes.3': {
  ...
  'revision360.variants.integral.includes.4': {
  ...
  'revision360.prompt.whatWework': {
    ca: 'Què treballem',
    en: 'What we work on',
    es: 'En qué trabajamos',
    ru: 'Над чем мы работаем'
  },
  'revision360.prompt.body': {
    ca: 'Cos (físic)',
    en: 'Body (physical)',
    es: 'Cuerpo (físico)',
    ru: 'Тело (физическое)'
  },
  'revision360.prompt.bodyDesc': {
  ...
  'revision360.prompt.emotions': {
    ca: 'Emocions',
    en: 'Emotions',
    es: 'Emociones',
    ru: 'Эмоции'
  },
  'revision360.prompt.emotionsDesc': {
  ...
  'revision360.prompt.mind': {
    ca: 'Ment',
    en: 'Mind',
    es: 'Mente',
    ru: 'Разум'
  },
  'revision360.prompt.mindDesc': {
  ...
  'revision360.prompt.energy': {
    ca: 'Energia',
    en: 'Energy',
    es: 'Energía',
    ru: 'Энергия'
  },
  'revision360.prompt.energyDesc': {
  ...
  'revision360.prompt.expectedResult': {
    ca: 'Resultat esperat',
    en: 'Expected result',
    es: 'Resultado esperado',
    ru: 'Ожидаемый результат'
  },
  'revision360.prompt.expectedResultDesc': {
  ...
  'revision360.prompt.selfDirection': {
    ca: 'Autodirecció',
    en: 'Self-direction',
    es: 'Autodirección',
    ru: 'Самонаправленности'
  },
  'revision360.prompt.systemChoice': {
  ...
  'revision360.prompt.session': {
    ca: 'Sessió',
    en: 'Session',
    es: 'Sesión',
    ru: 'Сессия'
  },
  'revision360.prompt.firstVisit': {
  ...
  'revision360.prompt.personalPlan': {
    ca: 'Pla personal',
    en: 'Personal plan',
    es: 'Plan personal',
    ru: 'Персональный план'
  },
  'revision360.prompt.sessionsRange': {
  ...
  'revision360.prompt.forWho': {
    ca: 'Per a qui és',
    en: 'Who it\'s for',
    es: 'Para quién es',
    ru: 'Для кого это'
  },
  'revision360.prompt.forWhoDesc': {
  ...
  'revision360.prompt.booking': {
    ca: 'Reserva',
    en: 'Book',
    es: 'Reserva',
    ru: 'Забронировать'
  },
  'revision360.prompt.consultation': {
    ca: 'Consulta',
    en: 'Consultation',
    es: 'Consulta',
    ru: 'Консультация'
  },
  'revision360.prompt.promptLabel': {
    ca: 'Prompt',
    en: 'Prompt',
    es: 'Prompt',
    ru: 'Промпт'
  },
  'revision360.prompt.signature': {
    ca: '— Elena Kucherova',
    en: '— Elena Kucherova',
    es: '— Elena Kucherova',
    ru: '— елена кучерова'
  },
  'revision360.common.ekaBalance': {
    ca: 'EKA Balance',
    en: 'EKA Balance',
    es: 'EKA Balance',
    ru: 'EKA Balance'
  },
  'revision360.common.copyright': {
    ca: '© 2024',
    en: '© 2024',
    es: '© 2024',
    ru: '© 2024'
  ...
  'revision360.benefits.benefit1.title': {
    ca: 'Claredat mental',
    en: 'Mental clarity',
    es: 'Claridad mental',
  ...
  'revision360.benefits.benefit1.science': {
  ...
  'revision360.benefits.benefit2.title': {
  ...
  'revision360.benefits.benefit2.science': {
  ...
  'revision360.benefits.benefit3.title': {
  ...
  'revision360.benefits.benefit3.science': {
  ...
  'revision360.benefits.benefit4.title': {
  ...
  'revision360.benefits.benefit4.science': {
  ...
  'revision360.benefits.benefit5.title': {
    ca: 'Millor son',
    en: 'Better sleep',
    es: 'Mejor sueño',
    ru: 'Лучший сон'
  ...
  'revision360.benefits.benefit5.science': {
  ...
  'revision360.benefits.benefit6.title': {
  ...
  'revision360.benefits.benefit6.science': {
  ...
  'revision360.benefits.benefit7.title': {
  ...
  'revision360.benefits.benefit7.science': {
  ...
  'revision360.benefits.benefit8.title': {
  ...
  'revision360.benefits.benefit8.science': {
  ...
  'revision360.benefits.benefit9.title': {
    ca: 'Vitalitat',
    en: 'Vitality',
    es: 'Vitalidad',
    ru: 'Жизненность'
  ...
  'revision360.benefits.benefit9.science': {
  ...
  'revision360.benefits.science': {
    ca: 'La ciència',
    en: 'The science',
    es: 'La ciencia',
    ru: 'Наука'
  },
  'revision360.benefits.philosophy': {
  ...
  'revision360.service.step1.details.1': {
  ...
  'revision360.service.step1.details.2': {
    ca: 'Anàlisi de patrons de moviment',
    en: 'Movement pattern analysis',
    es: 'Análisis de patrones de movimiento',
    ru: 'Анализ двигательных паттернов'
  },
  'revision360.service.step1.details.3': {
  ...
  'revision360.service.step1.details.4': {
  ...
  'revision360.service.step2.details.1': {
  ...
  'revision360.service.step2.details.2': {
  ...
  'revision360.service.step2.details.3': {
  ...
  'revision360.service.step2.details.4': {
  ...
  'revision360.service.step3.details.1': {
  ...
  'revision360.service.step3.details.2': {
  ...
  'revision360.service.step3.details.3': {
    ca: 'Reeducació del moviment',
    en: 'Movement re-education',
    es: 'Reeducación del movimiento',
    ru: 'Переобучение движению'
  },
  'revision360.service.step3.details.4': {
  ...
  'revision360.service.step4.details.1': {
  ...
  'revision360.service.step4.details.2': {
  ...
  'revision360.service.step4.details.3': {
  ...
  'revision360.service.step4.details.4': {
  ...
  // Testimonials
  'revision360.testimonials.maria.name': {
    ca: 'Maria',
    en: 'Maria',
    es: 'María',
    ru: 'Мария'
  },
  'revision360.testimonials.maria.issue': {
  ...
  'revision360.testimonials.maria.quote': {
  ...
  'revision360.testimonials.maria.result': {
  ...
  'revision360.testimonials.maria.timeframe': {
    ca: '3 mesos',
    en: '3 months',
    es: '3 meses',
    ru: '3 месяца'
  },
  'revision360.testimonials.maria.before': {
  ...
  'revision360.testimonials.maria.after': {
  ...
  'revision360.testimonials.david.name': {
    ca: 'David',
    en: 'David',
    es: 'David',
    ru: 'Давид'
  },
  'revision360.testimonials.david.issue': {
  ...
  'revision360.testimonials.david.quote': {
  ...
  'revision360.testimonials.david.result': {
  ...
  'revision360.testimonials.david.timeframe': {
    ca: '6 setmanes',
    en: '6 weeks',
    es: '6 semanas',
    ru: '6 недель'
  },
  'revision360.testimonials.david.before': {
  ...
  'revision360.testimonials.david.after': {
  ...
  'revision360.testimonials.jennifer.name': {
    ca: 'Jennifer',
    en: 'Jennifer',
    es: 'Jennifer',
    ru: 'Дженнифер'
  },
  'revision360.testimonials.jennifer.issue': {
  ...
  'revision360.testimonials.jennifer.quote': {
  ...
  'revision360.testimonials.jennifer.result': {
  ...
  'revision360.testimonials.jennifer.timeframe': {
    ca: '4 mesos',
    en: '4 months',
    es: '4 meses',
    ru: '4 месяца'
  },
  'revision360.testimonials.jennifer.before': {
  ...
  'revision360.testimonials.jennifer.after': {
  ...
  'revision360.testimonials.alex.name': {
    ca: 'Alex',
    en: 'Alex',
    es: 'Alex',
    ru: 'Алекс'
  },
  'revision360.testimonials.alex.issue': {
  ...
  'revision360.testimonials.alex.quote': {
  ...
  'revision360.testimonials.alex.result': {
  ...
  'revision360.testimonials.alex.timeframe': {
    ca: '8 setmanes',
    en: '8 weeks',
    es: '8 semanas',
    ru: '8 недель'
  },
  'revision360.testimonials.alex.before': {
  ...
  'revision360.testimonials.alex.after': {
  ...
  'revision360.testimonials.resultsAchieved': {
    ca: 'Resultats assolits:',
    en: 'Results achieved:',
    es: 'Resultados logrados:',
    ru: 'Достигнутые результаты:'
  },
  'revision360.testimonials.timeframe': {
    ca: 'Temps:',
    en: 'Time:',
    es: 'Tiempo:',
    ru: 'Время:'
  },
  'revision360.testimonials.watchVideo': {
    ca: 'Veure història en vídeo',
    en: 'Watch video story',
    es: 'Ver historia en vídeo',
    ru: 'Посмотреть видео-историю'
  },
  'revision360.testimonials.showBeforeAfter': {
    ca: 'Mostrar abans i després',
    en: 'Show before & after',
    es: 'Mostrar antes y después',
    ru: 'Показать до и после'
  },
  'revision360.testimonials.hideBeforeAfter': {
    ca: 'Amagar',
    en: 'Hide',
    es: 'Ocultar',
    ru: 'Скрыть'
  },
  'revision360.testimonials.before': {
    ca: 'Abans:',
    en: 'Before:',
    es: 'Antes:',
    ru: 'До:'
  },
  'revision360.testimonials.after': {
    ca: 'Després:',
    en: 'After:',
    es: 'Después:',
    ru: 'После:'
  },
  'revision360.testimonials.videoStory': {
    ca: 'Història de',
    en: 'Story of',
    es: 'Historia de',
    ru: 'История'
  },
  'revision360.testimonials.keyInsights': {
    ca: 'Perspectives clau de',
    en: 'Key insights from',
    es: 'Perspectivas clave de',
    ru: 'Ключевые выводы от'
  },
  'revision360.testimonials.keyInsight1': {
  ...
  'revision360.testimonials.keyInsight2': {
  ...
  'revision360.testimonials.keyInsight3': {
  ...
  'revision360.testimonials.keyInsight4': {
  ...
  'revision360.testimonials.videoPlaceholder': {
  ...
  'revision360.testimonials.videoImplementation': {
  ...
  'revision360.services.completeReview': {
    ca: 'Revisió corporal 360° completa',
    en: 'Complete 360° body review',
    es: 'Revisión corporal 360° completa',
    ru: 'Полный телесный обзор 360°'
  },
  'revision360.services.reset360': {
    ca: 'Reinici 360°',
    en: 'Reset 360°',
    es: 'Reinicio 360°',
    ru: 'Перезагрузка 360°'
  },
  'revision360.services.mapping360': {
    ca: 'Mapeig corporal 360°',
    en: '360° body mapping',
    es: 'Mapeo corporal 360°',
    ru: 'Телесное картирование 360°'
  },
  'revision360.services.alignment360': {
    ca: 'Alineació 360°',
    en: 'Alignment 360°',
    es: 'Alineación 360°',
    ru: 'Выравнивание 360°'
  },
  'revision360.services.followUpConsultations': {
  ...
  'revision360.cta.scheduleDiscoveryCall': {
    ca: 'Programar una trucada de descobriment',
    en: 'Schedule a discovery call',
    es: 'Programar una llamada de descubrimiento',
    ru: 'Запланировать ознакомительный звонок'
  },
  'revision360.cta.downloadGuide': {
    ca: 'Descarregar la nostra guia',
    en: 'Download our guide',
    es: 'Descargar nuestra guía',
    ru: 'Скачать наше руководство'
  ...
  // Additional labels
  'revision360.labels.noInsuranceNeeded': {
    ca: 'No cal assegurança',
    en: 'No insurance needed',
    es: 'No necesita seguro',
    ru: 'Страховка не нужна'
  },
  'revision360.labels.flexibleSchedules': {
    ca: 'Horaris flexibles',
    en: 'Flexible schedules',
    es: 'Horarios flexibles',
    ru: 'Гибкое расписание'
  },
  'revision360.labels.personalizedApproach': {
    ca: 'Enfocament personalitzat',
    en: 'Personalized approach',
    es: 'Enfoque personalizado',
    ru: 'Персонализированный подход'
  },
  'revision360.labels.presentialConsultations': {
    ca: 'Consultes presencials',
    en: 'In-person consultations',
    es: 'Consultas presenciales',
    ru: 'Очные консультации'
  },
  'revision360.labels.onlineSessionsAvailable': {
  ...
  'revision360.footer.healingWithIntention': {
    ca: 'Sanant amb intenció',
    en: 'Healing with intention',
    es: 'Sanando con intención',
    ru: 'Исцеление с намерением'
  },
  'revision360.footer.contact': {
    ca: 'Contacte',
    en: 'Contact',
    es: 'Contacto',
    ru: 'Контакт'
  },
  'revision360.footer.services': {
    ca: 'Serveis',
    en: 'Services',
    es: 'Servicios',
    ru: 'Услуги'
  },
  'revision360.footer.copyright': {
  ...
  'revision360.footer.madeWith': {
    ca: 'Fet amb',
    en: 'Made with',
    es: 'Hecho con',
    ru: 'Сделано с'
  },
  'revision360.footer.forHealing': {
    ca: 'Per a la sanació',
    en: 'For healing',
    es: 'Para la sanación',
    ru: 'Для исцеления'
