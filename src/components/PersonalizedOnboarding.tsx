        ...
        <section className="py-24 bg-card relative overflow-hidden" id="plans">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 relative">
              ...
              {/* Plan 1 - Teams */}
              <div className="bg-card rounded-apple p-8 sm:p-10 border border-border relative transition-all duration-300 flex flex-col h-full">
                ...
                <Button asChild className="w-full rounded-apple py-6 relative z-10">
                  <Link href="/booking?subject=teams">{t('common.getStarted')}</Link>
                </Button>
              </div>

              {/* Plan 2 - Office */}
              <div className="bg-foreground rounded-apple p-8 sm:p-10 relative transition-transform duration-300 flex flex-col h-full overflow-hidden">
                ...
                <div className="mb-8 relative z-10">
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-xl text-primary-foreground/80 font-medium">{t('common.mo')}</span>
                  </div>
