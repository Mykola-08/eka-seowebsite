    ...
    <div className="min-h-screen bg-card">
      ...
      <div className="relative pt-32 pb-20 overflow-hidden bg-muted/30 border-b border-border/50">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className={`w-20 h-20 mx-auto rounded-2xl ${colorClass.bg} flex items-center justify-center mb-6 `}>
          ...
          <div className="relative">
            ...
            <ul className="space-y-4">
              {symptoms.map((item, idx) => (
                <li key={idx} className="flex items-start bg-muted/40 p-4 rounded-2xl">
