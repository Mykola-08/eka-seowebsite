...
const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    // VIP Page
    'vip.hero.badge': 'INNER CIRCLE ELITE',
    'vip.hero.title.beyond': 'MÉS ENLLÀ',
    'vip.hero.title.wellness': 'del benestar',
    'vip.hero.subtitle': 'Entra al cercle més exclusiu de salut i benestar a Barcelona. Només per a aquells que busquen la perfecció.',
    'vip.hero.cta.join': 'UNIR-ME A L\'INNER CIRCLE',
    'vip.stats.clients': 'Clients Elite',
    'vip.stats.concierge': 'Concierge',
    'vip.stats.exclusivity': 'Exclusivitat',
    'vip.stats.possibilities': 'Possibilitats',
    'vip.dashboard.member': 'MEMBRE REGISTRAT',
    ...
    'vip.features.badge': 'EXPERIÈNCIA INIGUALABLE',
    'vip.features.title': 'Benvingut a l\'elit',
  ...
  en: {
    ...
    'vip.hero.subtitle': 'Enter the most exclusive health and wellness circle in Barcelona. Only for those seeking perfection.',
    'vip.hero.cta.join': 'JOIN THE INNER CIRCLE',
    'vip.stats.clients': 'Elite Clients',
    'vip.stats.concierge': 'Concierge',
    'vip.stats.exclusivity': 'Exclusivity',
    'vip.stats.possibilities': 'Possibilities',
    'vip.dashboard.member': 'REGISTERED MEMBER',
    ...
    'vip.features.badge': 'UNMATCHED EXPERIENCE',
    'vip.features.title': 'Welcome to the elite',
    'vip.features.subtitle': 'Discover what it means to be part of the most exclusive circle.',
    'vip.plans.badge': 'ELITE MEMBERSHIPS',
    'vip.plans.title': 'Choose your elite experience',
    'vip.plans.subtitle': 'Each plan is meticulously designed to offer an unforgettable experience.',
    'vip.plans.popular': 'MOST EXCLUSIVE',
    'vip.plans.perMonth': '€/month',
    'vip.plans.sessions': 'exclusive monthly sessions',
    'vip.plans.contact': 'Contact for',
    'vip.exclusivePrivileges': 'Exclusive Privileges',
    'vip.testimonials.title': 'Voices of Excellence',
    'vip.testimonials.subtitle': 'Real experiences from our Inner Circle members.',
    'vip.cta.badge': 'THE INNER CIRCLE AWAITS',
    'vip.cta.title': 'Ready to transcend',
    'vip.cta.subtitle': 'Only those seeking excellence can be part of this unique experience. Your transformation starts here.',
  ...
  es: {
    ...
    'vip.hero.subtitle': 'Entra en el círculo más exclusivo de salud y bienestar en Barcelona. Solo para aquellos que buscan la perfección.',
    'vip.hero.cta.join': 'UNIRME AL INNER CIRCLE',
    'vip.stats.clients': 'Clientes Elite',
    'vip.stats.concierge': 'Concierge',
    'vip.stats.exclusivity': 'Exclusividad',
    'vip.stats.possibilities': 'Posibilidades',
    'vip.dashboard.member': 'MIEMBRO REGISTRADO',
    'vip.dashboard.hello': 'Hola,',
    ...
    'vip.features.badge': 'EXPERIENCIA INIGUALABLE',
    'vip.features.title': 'Bienvenido a la élite',
    'vip.features.subtitle': 'Descubre qué significa formar parte del círculo más exclusivo.',
    'vip.plans.badge': 'MEMBRESÍAS DE ÉLITE',
    'vip.plans.title': 'Elige tu experiencia elite',
    'vip.plans.subtitle': 'Cada plan está meticulosamente diseñado para ofrecer una experiencia inolvidable.',
    'vip.plans.popular': 'MÁS EXCLUSIVO',
    'vip.plans.perMonth': '€/mes',
    'vip.plans.sessions': 'sesiones exclusivas mensuales',
    'vip.plans.contact': 'Contactar para',
    'vip.exclusivePrivileges': 'Privilegios Exclusivos',
    'vip.testimonials.title': 'Voces de excelencia',
    'vip.testimonials.subtitle': 'Experiencias reales de nuestros miembros del Inner Circle.',
    'vip.cta.badge': 'EL INNER CIRCLE TE ESPERA',
    'vip.cta.title': 'Preparado para trascender',
    'vip.cta.subtitle': 'Solo quienes buscan la excelencia pueden formar parte de esta experiencia única. Tu transformación empieza aquí.',
  ...
  ru: {
    ...
    'vip.hero.subtitle': 'Войдите в самый эксклюзивный круг здоровья и благополучия в Барселоне. Только для тех, кто ищет совершенства.',
    'vip.hero.cta.join': 'ПРИСОЕДИНИТЬСЯ К INNER CIRCLE',
    'vip.stats.clients': 'Элитные клиенты',
    'vip.stats.concierge': 'Консьерж',
    'vip.stats.exclusivity': 'Эксклюзивность',
    'vip.stats.possibilities': 'Возможности',
    'vip.dashboard.member': 'ЗАРЕГИСТРИРОВАННЫЙ УЧАСТНИК',
    ...
    'vip.features.badge': 'НЕПРЕВЗОЙДЕННЫЙ ОПЫТ',
    'vip.features.title': 'Добро пожаловать в элиту',
    'vip.features.subtitle': 'Узнайте, что значит быть частью самого эксклюзивного круга.',
    'vip.plans.badge': 'ЭЛИТНОЕ ЧЛЕНСТВО',
    'vip.plans.title': 'Выберите свой элитный опыт',
    'vip.plans.subtitle': 'Каждый план тщательно разработан, чтобы предложить незабываемый опыт.',
    'vip.plans.popular': 'САМЫЙ ЭКСКЛЮЗИВНЫЙ',
    'vip.plans.perMonth': '€/мес',
    'vip.plans.sessions': 'эксклюзивных сессий в месяц',
    'vip.plans.contact': 'Связаться для',
    'vip.exclusivePrivileges': 'Эксклюзивные привилегии',
    'vip.testimonials.title': 'Голоса совершенства',
    'vip.testimonials.subtitle': 'Реальный опыт наших участников Inner Circle.',
    'vip.cta.badge': 'INNER CIRCLE ЖДЕТ ВАС',
    'vip.cta.title': 'Готовы превзойти',
    'vip.cta.subtitle': 'Только те, кто ищет совершенства, могут стать частью этого уникального опыта. Ваша трансформация начинается здесь.',
    ...
    // Casos SEO
    'casos.seo.title': 'Истории успеха и лечение | EKA Balance',
    ...
    'casos.seo.keywords': 'истории успеха, отзывы массаж, лечение боли в спине, снятие стресса, результаты терапии',
    ...
    'discovery.recommendation.integrative.benefit1': 'Интегральное лечение',
    ...
    'athletes.seo.desc': 'Улучшите свои результаты и восстанавливайтесь быстрее с нашими спортивными массажами. Профилактика травм и лечение мышц.',
    ...
    'musicians.seo.desc': 'Профилактика и лечение травм у музыкантов. Улучшите свою технику и снизьте напряжение с помощью наших специализированных терапий.',
