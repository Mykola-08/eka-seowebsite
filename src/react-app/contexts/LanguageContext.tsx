...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'hero.firstTime': 'Is this your first time?',
    'hero.dontKnowWhatToChoose': 'Don\'t know what to choose?',
    'hero.discoverServices': 'Discover our services',
    'hero.stats.sessions': 'Sessions completed',
    'hero.stats.clients': 'Happy clients',
    'hero.stats.experience': 'Years experience',
    'hero.stats.countries': 'Places of education',
    ...
    'services.massage.subtitle': 'Release tension and truly rest',
    'services.massage.description': 'Decontracting and relaxing massage tailored to you to reduce pain, stress and stiffness.',
    'services.kinesiology.title': 'Holistic Kinesiology',
    'services.kinesiology.subtitle': 'Listen to the body, find the root',
    ...
    'services.nutrition.description': 'Personalized counseling for clear habits, digestion and energy.',
    'services.revision360.title': '360° Review',
    'services.revision360.subtitle': 'Complete view of body, movement and habits',
    'services.revision360.description': 'Comprehensive assessment with clear action plan and next steps.',
    'services.therapiesFor': 'Therapies for',
    'services.integralWellbeing': 'integral wellbeing',
    'services.personalizedTreatments': 'Discover personalized treatments that adapt to your specific needs',
    ...
    // About Elena
    'elena.greeting': 'Hello! My name is Elena',
    'elena.description1': 'I am a body therapist specialized in therapeutic, relaxing and decontracting massage, kinesiology and body-mind integration techniques.',
    'elena.description2': 'My goal is to help you release tension and recover physical and emotional well-being so you can feel lightness and energy in your body again.',
    'elena.knowMore': 'Get to know me better',
    ...
    'stats.countries': 'Countries studied',
    'stats.cases': 'Cases solved',
    'stats.response': 'WhatsApp response',
    
    // Why choose us
    'whyChoose.title': 'Why choose EKA Balance?',
    'whyChoose.subtitle': 'More than a therapy center, we are your companions on the path to comprehensive well-being',
    'whyChoose.personalized.title': 'Personalized treatment',
    'whyChoose.personalized.description': 'Each session adapts to your specific needs to achieve the best possible results.',
    'whyChoose.holistic.title': 'Holistic approach',
    'whyChoose.holistic.description': 'We care for your comprehensive well-being: body, mind and emotions work in perfect harmony.',
    'whyChoose.experienced.title': 'Experienced professionals',
    'whyChoose.experienced.description': 'Team with years of experience and continuous training in the best therapeutic techniques.',
    
    // Final CTA
    'finalCta.title': 'Ready to start your journey to wellness?',
    'finalCta.subtitle': 'Contact us to book your session or resolve any questions',

    // Casos page
    'casos.title': 'Problems we solve',
    'casos.subtitle': 'Every body has its story. Discover how we can help you recover the balance of your body, mind and energy.',
    'casos.description': 'Often we arrive with an apparent symptom —a pain, tension, fatigue— but behind it there\'s much more. At EKA Balance we have accompanied hundreds of people who, like you, were looking for a real and lasting solution. Here you\'ll find common cases, how we\'ve worked with them and what results we\'ve seen.',
