...
export const servicesTranslations: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'service.step4.desc': 'Вы не уходите с пустыми руками. Вы получаете персонализированный план с упражнениями, советами по образу жизни и рекомендациями по лечению.',
