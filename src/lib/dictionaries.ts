...
export const translations: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'personalized.musicians.benefit1': "Профилактика и лечение травм от повторяющихся нагрузок (RSI) и тендинита.",
    ...
    'personalized.musicians.faq.q2': "Повлияет ли лечение на мою технику?",
