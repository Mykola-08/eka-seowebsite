      ...
      <AnimatePresence>
        {showSuccess && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-24 right-4 z-50 bg-primary text-primary-foreground px-6 py-4 rounded-apple flex items-center space-x-3"
          >
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12 max-w-5xl mx-auto">
            {availableDiscounts.map((discount, index) => (
              <motion.div
                ...
                className="group relative bg-card rounded-apple p-8 transition duration-300 border border-border overflow-hidden"
              >
                {/* Background Gradient */}
                ...
                <div className="relative flex items-start justify-between mb-6">
                  <div className="w-14 h-14 bg-primary/10 rounded-apple flex items-center justify-center text-primary transition-colors duration-300">
                ...
                {discount.code && (
                    <div className="relative space-y-3">
                      <div className="flex items-center justify-between p-3 bg-muted/40 rounded-apple border-dashed group-hover:border-0 transition-colors">
                      ...
                      {selectedDiscount?.code === discount.code ? (
                        <div className="w-full py-3 bg-primary/5 text-primary font-medium rounded-apple text-center text-sm flex items-center justify-center gap-2">
                        ...
                        <Button
                          ...
                          variant="default"
                          className="w-full py-3 rounded-apple"
                        >
             ...
             <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                {[
                  ...
                  <div key={idx} className="text-center p-6">
                     <div className="w-12 h-12 bg-primary/5 text-primary rounded-apple flex items-center justify-center mx-auto mb-6">
