...
const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'elena.approach.title': 'El Mètode Elena Kuchera',
    ...
    'discovery.step.description.title': 'Explica\'ns el teu cas',
    'discovery.step.description.subtitle': 'Descriu breument què et passa o què busques (mínim 3 caràcters)',
    'discovery.step.description.placeholder': 'Ex: Tinc mal d\'esquena des de fa setmanes...',
    ...
    'elena.seo.desc': 'Coneix l\'Elena Kuchera, terapeuta especialitzada en massatge, kinesiologia i benestar integral. Més de 10 anys d\'experiència ajudant persones a Barcelona.',
    'elena.seo.keywords': 'Elena Kuchera, terapeuta integradora, kinesiologia Barcelona, sanació somàtica, desenvolupament personal',
    ...
    // Back Pain
    'casos.problems.backPain.symptom1': 'Dolor punxant o tensió constant a la zona lumbar o cervical',
    'casos.problems.backPain.symptom2': 'Dificultat per girar el coll o aixecar el braç',
    'casos.problems.backPain.symptom3': 'Fatiga després d\'estar assegut o dret molta estona',
    'casos.problems.backPain.symptom4': 'Sensació de pressió a les espatlles o cap',
    'casos.problems.backPain.cause1': 'Postures mantingudes i mala ergonomia',
    ...
    // Stress
    'casos.problems.stress.symptom1': 'Pensaments constants i bucle mental',
    'casos.problems.stress.symptom2': 'Dificultat per relaxar-se o dormir',
    'casos.problems.stress.symptom3': 'Dolor cervical, tensió mandibular, fatiga al matí',
    'casos.problems.stress.symptom4': 'Emocions intenses sense motiu aparent',
    'casos.problems.stress.cause1': 'Excés de responsabilitats i pressió',
    ...
    // Digestive
    'casos.problems.digestive.symptom1': 'Inflor abdominal, gasos, reflux o dolor després de menjar',
    'casos.problems.digestive.symptom2': 'Cansament o somnolència postprandial',
    'casos.problems.digestive.symptom3': 'Canvis d\'humor o irritabilitat sense motiu',
    'casos.problems.digestive.symptom4': 'Intoleràncies alimentàries o sensibilitats',
    'casos.problems.digestive.cause1': 'Intoleràncies alimentàries no detectades',
    ...
    // Migraines
    'casos.problems.migraines.symptom1': 'Dolor intens d\'un costat del cap o al clatell',
    'casos.problems.migraines.symptom2': 'Pressió ocular o sensació de casc',
    'casos.problems.migraines.symptom3': 'Marejos o nàusees',
    'casos.problems.migraines.symptom4': 'Sensibilitat a la llum i als sorolls',
    'casos.problems.migraines.cause1': 'Bloqueig cervical i tensió muscular',
    ...
    // Low Energy
    'casos.problems.lowEnergy.symptom1': 'Cansament constant malgrat dormir bé',
    'casos.problems.lowEnergy.symptom2': 'Baixa concentració i memòria',
    'casos.problems.lowEnergy.symptom3': 'Irritabilitat o apatia',
    'casos.problems.lowEnergy.symptom4': 'Sensació de "funcionar amb el pilot automàtic"',
    'casos.problems.lowEnergy.cause1': 'Estrès prolongat i burnout',
    ...
    // Sleep
    'casos.problems.sleep.symptom1': 'Dificultat per adormir-se o despertes nocturns',
    'casos.problems.sleep.symptom2': 'Fatiga matinal, tensió o somnis intensos',
    'casos.problems.sleep.symptom3': 'Pensaments recurrents abans de dormir',
    'casos.problems.sleep.symptom4': 'Son lleuguer o poc reparador',
    'casos.problems.sleep.cause1': 'Excés d\'estrès i hiperactivació mental',
    ...
    // Recovery
    'casos.problems.recovery.symptom1': 'Dolor residual o limitació articular',
    'casos.problems.recovery.symptom2': 'Sensació de debilitat o desequilibri',
    'casos.problems.recovery.symptom3': 'Bloquejos emocionals associats a la lesió',
    'casos.problems.recovery.symptom4': 'Por al moviment o reactivitat',
    'casos.problems.recovery.cause1': 'Cicatrius internes i adherències',
    ...
    'discovery.emotional.stressed.desc': 'Amb dificultat per relaxar-me',
    'discovery.emotional.sad.title': 'Em sento trist/apatètic',
    'discovery.emotional.sad.desc': 'I tinc ganes de canviar-ho',
    'discovery.emotional.balanced.title': 'Em sento equilibrat',
    'discovery.emotional.balanced.desc': 'No hi ha un problema emocional fort actual',
    'discovery.emotional.focus_physical.title': 'Prefereixo enfocar-me en l\'àmbit físic',
    'discovery.emotional.focus_physical.desc': 'No ho sé, però vull centrar-me en el cos',

    // Discovery Form - Time Commitments
    'discovery.time.short.title': 'Sessió curta (fins a 1h)',
    'discovery.time.short.desc': 'Ideal si tens poc temps',
    'discovery.time.standard.title': 'Sessió estàndard (1-1,5h)',
    'discovery.time.standard.desc': 'Temps habitual de massatge/teràpia',
    'discovery.time.long.title': 'Sessió llarga o intensiva (fins a 2h)',
    'discovery.time.long.desc': 'Si vols una atenció molt completa',
    ...
    'personalizedServices.special.list1': 'Mínim esforç, màxim resultat',
    'personalizedServices.special.list2': 'Sessions optimitzades per objectius',
    'personalizedServices.special.list3': 'Solució d\'arrel específica',
    'personalizedServices.special.list4': 'Transformació ràpida i duradora',
    ...
    'booking.form.location': 'Preferència de lloc',
    'booking.form.locationPlaceholder': 'Selecciona un lloc',
    'booking.form.timeSlot': 'Franja horària',
    'booking.form.timeSlotPlaceholder': 'Selecciona una franja',
    'booking.form.availability': 'Disponibilitat',
    'booking.form.availabilityPlaceholder': 'Quan pots venir?',
  ...
  en: {
    ...
    'casos.problems.backPain.symptom2': 'Difficulty turning the neck or lifting the arm',
    'casos.problems.backPain.symptom3': 'Fatigue after sitting or standing for a long time',
    'casos.problems.backPain.symptom4': 'Feeling of pressure on shoulders or head',
    'casos.problems.backPain.cause1': 'Maintained postures and poor ergonomics',
    ...
    'casos.problems.stress.symptom3': 'Neck pain, jaw tension, morning fatigue',
    'casos.problems.stress.symptom4': 'Intense emotions without apparent reason',
    'casos.problems.stress.cause1': 'Excess responsibilities and pressure',
    ...
    'casos.problems.digestive.symptom3': 'Mood swings or irritability without reason',
    'casos.problems.digestive.symptom4': 'Food intolerances or sensitivities',
    'casos.problems.digestive.cause1': 'Undetected food intolerances',
    ...
    'casos.problems.migraines.symptom3': 'Dizziness or nausea',
    'casos.problems.migraines.symptom4': 'Sensitivity to light and noise',
    'casos.problems.migraines.cause1': 'Cervical blockage and muscle tension',
    ...
    'casos.problems.lowEnergy.symptom3': 'Irritability or apathy',
    'casos.problems.lowEnergy.symptom4': 'Feeling of "running on autopilot"',
    'casos.problems.lowEnergy.cause1': 'Prolonged stress and burnout',
    ...
    'casos.problems.sleep.symptom3': 'Recurring thoughts before sleeping',
    'casos.problems.sleep.symptom4': 'Light or unrefreshing sleep',
    'casos.problems.sleep.cause1': 'Excess stress and mental hyperactivation',
    'casos.problems.sleep.cause2': 'Nervous system imbalance and circadian rhythms',
    'casos.problems.sleep.cause3': 'Lack of routine or sleep hygiene',
    'casos.problems.sleep.cause4': 'Digestive or hormonal problems',
    ...
    'casos.problems.sleep.results': 'Improvement of deep sleep and restful rest after a few sessions.',
    'casos.problems.recovery.symptom1': 'Residual pain or joint limitation',
    'casos.problems.recovery.symptom2': 'Feeling of weakness or imbalance',
    'casos.problems.recovery.symptom3': 'Emotional blockages associated with the injury',
    'casos.problems.recovery.symptom4': 'Fear of movement or reactivity',
    'casos.problems.recovery.cause1': 'Internal scars and adhesions',
    'casos.problems.recovery.cause2': 'Muscle and postural compensations',
    'casos.problems.recovery.cause3': 'Physical trauma with emotional component',
    'casos.problems.recovery.cause4': 'Body memory of the traumatic experience',
    ...
    'booking.form.location': 'Location Preference',
    'booking.form.locationPlaceholder': 'Select a location',
    'booking.form.timeSlot': 'Time Slot',
    'booking.form.timeSlotPlaceholder': 'Select a time slot',
    'booking.form.availability': 'Availability',
    'booking.form.availabilityPlaceholder': 'When can you come?',
    'booking.form.objective': 'Goal or type of pain',
    'booking.form.objectivePlaceholder': 'Briefly explain what you need...',
    'booking.form.submit': 'Send via WhatsApp',

    // Options
    'booking.options.service.massage': 'Massage',
    'booking.options.service.kinesiology': 'Kinesiology',
    'booking.options.service.osteobalance': 'Osteobalance',
    'booking.options.service.movementLesson': 'Movement Lesson',
    'booking.options.service.feldenkrais': 'Feldenkrais',
    ...
    // Elena SEO
    'elena.seo.title': 'About Elena - Holistic Therapist in Barcelona | EKA Balance',
    'elena.seo.desc': 'Meet Elena Kucherova, therapist specialized in massage, kinesiology and integral wellbeing. Over 10 years of experience helping people in Barcelona.',
    'elena.seo.keywords': 'Elena Kucherova, integrative therapist, kinesiology Barcelona, somatic healing, personal development',

    // Casos SEO
    'casos.seo.title': 'Problems We Solve | Real Holistic Therapy Cases | EKA Balance',
    'casos.seo.desc': 'Discover how we can help you with back pain, stress, digestive problems, migraines and many other cases. Real cases with proven results.',
    'casos.seo.keywords': 'back pain, stress anxiety, digestive problems, migraines, chronic fatigue, holistic therapy Barcelona',

    // SEO
    'seo.home.title': 'EKA Balance - Holistic Therapy Center in Barcelona | Massage & Kinesiology',
    'seo.home.description': 'Discover integral wellbeing at EKA Balance. Specialists in therapeutic massage, kinesiology and osteobalance in Barcelona. Book via WhatsApp/Telegram 658867133.',
    'seo.home.keywords': 'therapeutic massage Barcelona, kinesiology Barcelona, osteobalance, holistic therapy center, integral wellbeing, relaxation Barcelona, Plaza Universitat',
    'seo.contact.title': 'Contact - EKA Balance | Holistic Therapy Center in Barcelona',
    'seo.contact.description': 'Contact EKA Balance for bookings and inquiries. Centers in Barcelona and Rubí. Phone 658 867 133, email contact@ekabalance.com',
    'seo.contact.keywords': 'contact EKA Balance, massage booking Barcelona, holistic therapies Rubí, wellness center Barcelona',
    'seo.services.title': 'Holistic Therapy Services in Barcelona | EKA Balance',
    'seo.services.description': 'Discover our services: therapeutic massage, kinesiology, conscious nutrition and 360° review. Integral wellness space in Barcelona.',
    'seo.services.keywords': 'therapeutic services Barcelona, massage, kinesiology, nutrition, integral review, holistic therapies',
    'seo.personalized.title': 'Personalized Services - EKA Balance Barcelona',
    'seo.personalized.description': 'Choose the service that best suits you: office workers, athletes, artists, musicians and students. Take care of your body with personalized therapies.',
    'seo.personalized.keywords': 'personalized services Barcelona, office massage, athletes, artists, musicians, students',
    'seo.vip.title': 'Inner Circle VIP - Exclusive Premium Experience | EKA Balance',
    'seo.vip.description': 'Join the EKA Balance Inner Circle VIP. Bronze, Silver and Gold Elite plans with exclusive benefits, 24/7 attention and personalized experiences.',
    'seo.vip.keywords': 'VIP Elite Barcelona, exclusive health plans, inner circle wellness, premium health control',
    'seo.massage.title': 'Therapeutic and Relaxing Massage in Barcelona | EKA Balance',
    'seo.massage.description': 'Professional therapeutic massage in Barcelona. Release tension, care for your body and relax your mind. 60, 90 and 120 minute sessions. Book now.',
    'seo.massage.keywords': 'therapeutic massage Barcelona, relaxing massage, contractures, muscle pain, stress, Plaza Universitat',
    'seo.kinesiology.title': 'Holistic Kinesiology in Barcelona | EKA Balance',
    'seo.kinesiology.description': 'Professional holistic kinesiology in Barcelona. Find balance between body, mind and emotions. 60 and 90 minute sessions. Book now.',
    'seo.kinesiology.keywords': 'kinesiology Barcelona, emotional balance, muscle testing, emotional blockages, posture, coordination',
    'seo.nutrition.title': 'Personalized Nutritional Counseling in Barcelona | EKA Balance',
    'seo.nutrition.description': 'Conscious and personalized nutrition in Barcelona. Eat well to live better. Initial session and personalized follow-up. Book now.',
    'seo.nutrition.keywords': 'nutrition Barcelona, nutritional counseling, eating habits, energy, weight management, food health',
    ...
    'discovery.emotional.stressed.desc': 'With difficulty relaxing',
    'discovery.emotional.sad.title': 'I feel sad/apathetic',
    'discovery.emotional.sad.desc': 'And I want to change it',
    'discovery.emotional.balanced.title': 'I feel balanced',
    'discovery.emotional.balanced.desc': 'There is no strong emotional problem currently',
    'discovery.emotional.focus_physical.title': 'I prefer to focus on the physical',
    'discovery.emotional.focus_physical.desc': 'I don\'t know, but I want to focus on the body',

    // Discovery Form - Time Commitments
    'discovery.time.short.title': 'Short session (up to 1h)',
    'discovery.time.short.desc': 'Ideal if you have little time',
    'discovery.time.standard.title': 'Standard session (1-1.5h)',
    'discovery.time.standard.desc': 'Usual massage/therapy time',
    'discovery.time.long.title': 'Long or intensive session (up to 2h)',
    'discovery.time.long.desc': 'If you want very complete attention',

    // Discovery Form - Budget
    'discovery.budget.basic.title': 'Up to 60€',
    'discovery.budget.basic.desc': 'Basic option',
    'discovery.budget.standard.title': '60-90€',
    'discovery.budget.standard.desc': 'Up to 2h, full modality',
    'discovery.budget.premium.title': 'More than 90€',
    'discovery.budget.premium.desc': 'Premium long session',

    // Discovery Form - Recommendations
    'discovery.recommendation.emotional.service': 'Emotional Rebalancing',
    'discovery.recommendation.emotional.desc': 'Holistic therapy to manage stress, anxiety or sadness. Focuses on overcoming emotional problems and recovering harmony and happiness.',
    'discovery.recommendation.emotional.benefit1': 'Stress reduction',
    'discovery.recommendation.emotional.benefit2': 'Emotional balance',
    'discovery.recommendation.emotional.benefit3': 'Mental clarity',
    'discovery.recommendation.emotional.benefit4': 'Inner peace',

    'discovery.recommendation.manual.service': 'Manual Therapeutic Session',
    'discovery.recommendation.manual.desc': 'Specialized therapeutic massage to relieve pain and muscle tensions. Experienced professionals will help you relax contractures.',
    'discovery.recommendation.manual.benefit1': 'Pain relief',
    'discovery.recommendation.manual.benefit2': 'Reduction of contractures',
    'discovery.recommendation.manual.benefit3': 'Mobility improvement',
    'discovery.recommendation.manual.benefit4': 'Muscle relaxation',

    'discovery.recommendation.integrative.service': 'Integrative Tension Relief (4 in 1)',
    'discovery.recommendation.integrative.desc': 'Combines massage, kinesiology, osteopathy and movements (Feldenkrais) for deep relief of chronic tensions.',
    'discovery.recommendation.integrative.benefit1': 'Integral treatment',
    'discovery.recommendation.integrative.benefit2': 'Deep relief',
    'discovery.recommendation.integrative.benefit3': 'Combination of techniques',
    'discovery.recommendation.integrative.benefit4': 'Lasting results',

    'discovery.recommendation.relax.service': 'Complete Relaxing Massage',
    'discovery.recommendation.relax.desc': 'Global relaxation experience (physical and mental), ideal if your goal is simply to rest and recharge energy.',
    'discovery.recommendation.relax.benefit1': 'Deep relaxation',
    'discovery.recommendation.relax.benefit2': 'Stress reduction',
    ...
    'discovery.analysis.intro': 'We identified that',
    ...
    'discovery.diagnosis.cause.structural': 'Structural/Mechanical Imbalance',
    'discovery.diagnosis.cause.general': 'Maintenance/Prevention Need',
    'discovery.diagnosis.strategy.structural': 'Structural Release & Mobility',
    ...
    'discovery.diagnosis.freq.high': 'Intensive (1 session/week for 3 weeks)',
    'discovery.diagnosis.freq.medium': 'Maintenance (1 session every 2-3 weeks)',
    'discovery.diagnosis.freq.low': 'Preventive (1 session per month)',
    'discovery.goal.athlete': 'your athletic recovery',
    'discovery.goal.office': 'your posture',
    'discovery.goal.stress': 'your peace of mind',
    'discovery.goal.pain': 'your physical comfort',
    'discovery.goal.general': 'your overall wellbeing',
    ...
    // VIP Section
    'vip.plan.bronze': 'Bronze Access',
    'vip.plan.bronze.description': 'Essential care for maintenance',
    'vip.plan.bronze.price': '150€',
    'vip.plan.silver': 'Silver Access',
    'vip.plan.silver.description': 'Complete monthly wellness',
    'vip.plan.silver.price': '280€',
    'vip.plan.gold': 'Gold Access',
    'vip.plan.gold.description': 'Total transformation & exclusivity',
    'vip.plan.gold.price': '500€',

    'vip.service.priority.title': 'Priority Booking',
    'vip.service.priority.description': 'Jump the queue with exclusive booking slots reserved just for you.',
    'vip.service.displacements.title': 'Home Visits',
    'vip.service.displacements.description': 'We come to you. Save time and enjoy treatments in your own space.',
    'vip.service.health.title': 'Health Monitoring',
    'vip.service.health.description': 'Regular check-ins and progress tracking for your physical health.',
    'vip.service.family.title': 'Family Benefits',
    'vip.service.family.description': 'Share your sessions and benefits with immediate family members.',

    'vip.benefits.transferable': 'Transferable Sessions',
    'vip.benefits.transferableDesc': 'Share with family',
    'vip.benefits.monthly': 'Monthly Wellness Check',
    'vip.benefits.monthlyDesc': 'Preventive care',
    'vip.benefits.barcelona': 'Barcelona Exclusive',
    'vip.benefits.barcelonaDesc': 'Available in city center',
    'vip.benefits.sessions': 'Extended sessions',

    'vip.stats.concierge': 'Concierge Service',
    'vip.stats.exclusivity': 'Exclusivity',
    'vip.stats.clients': 'Top 1% Clients',
    'vip.stats.possibilities': 'Possibilities',
    'vip.stats.control': 'Health Control',
    'vip.stats.family': 'Family Plan',

    'vip.mostExclusive': 'Most Exclusive',
    'vip.experienceDescription': 'Experience the pinnacle of wellness aimed at those who demand the best.',
    'vip.voicesOfExcellence': 'Voices of Excellence',
    'vip.testimonialsSubtitle': 'What our elite members say about their journey.',
    'vip.tier.standard': 'Standard Member',

    'vip.testimonials.comment1': 'The best investment I have made for my health. The priority service is a game changer.',
    'vip.testimonials.comment2': 'Professionalism at its finest. Elena understands exactly what my body needs.',
    'vip.testimonials.comment3': 'I feel renewed after every session. The attention to detail is unmatched.',

    'vip.hero.badge': 'Ultra Premium',
    'vip.hero.title.beyond': 'Beyond',
    'vip.hero.title.wellness': 'Wellness',
    'vip.hero.subtitle': 'Enter a world where your well-being is the absolute priority. Exclusive treatments, priority access, and personalized care.',
    'vip.hero.cta.join': 'Join Inner Circle',

    'vip.dashboard.member': 'Member Area',
    'vip.dashboard.hello': 'Hello,',
    'vip.dashboard.status': 'Current Status:',
    'vip.dashboard.priorityBooking': 'Priority Booking',
    'vip.dashboard.viewPlans': 'View VIP Plans',

    'vip.features.badge': 'Excellence',
    'vip.features.title': 'Designed for the Elite',
    'vip.features.subtitle': 'Every detail has been curated to provide an experience that goes beyond a simple therapy.',

    'vip.plans.badge': 'Membership',
    'vip.plans.title': 'Select Your Tier',
    'vip.plans.subtitle': 'Choose the level of exclusivity that suits your lifestyle.',
    'vip.plans.popular': 'Most Popular',
    'vip.plans.perMonth': '/ month',
    'vip.plans.sessions': 'sessions included',
    'vip.plans.contact': 'Contact for',

    'vip.exclusivePrivileges': 'Exclusive Privileges',
    'vip.testimonials.title': 'Elite Experiences',
    'vip.testimonials.subtitle': 'Hear from those who have chosen the path of excellence.',
    'vip.testimonials.role1': 'CEO, Tech Company',
    ...
    'vip.cta.location': 'EXCLUSIVE LOCATION',
    'vip.cta.concierge': 'CONCIERGE SERVICE',
    'vip.cta.guarantee': 'TOTAL GUARANTEE',
  },
  es: {
    // Navigation
    'nav.home': 'Inicio',
    ...
    'discovery.step.description.title': 'Cuéntanos tu caso',
    'discovery.step.description.subtitle': 'Describe brevemente qué te pasa o qué buscas (mínimo 3 caracteres)',
    'discovery.step.description.placeholder': 'Ej: Tengo dolor de espalda desde hace semanas...',
    ...
    'casos.problems.backPain.symptom1': 'Dolor punzante o tensión constante en la zona lumbar o cervical',
    'casos.problems.backPain.symptom2': 'Dificultad para girar el cuello o levantar el brazo',
    'casos.problems.backPain.symptom3': 'Fatiga después de estar sentado o de pie mucho tiempo',
    'casos.problems.backPain.symptom4': 'Sensación de presión en los hombros o cabeza',
    'casos.problems.backPain.cause1': 'Posturas mantenidas y mala ergonomía',
    ...
    'booking.form.location': 'Preferencia de lugar',
    'booking.form.locationPlaceholder': 'Selecciona un lugar',
    'booking.form.timeSlot': 'Franja horaria',
    'booking.form.timeSlotPlaceholder': 'Selecciona una franja',
    'booking.form.availability': 'Disponibilidad',
    'booking.form.availabilityPlaceholder': '¿Cuándo puedes venir?',
    'booking.form.objective': 'Objetivo o tipo de dolor',
    'booking.form.objectivePlaceholder': 'Explica brevemente qué necesitas...',
    'booking.form.submit': 'Enviar por WhatsApp',

    // Options
    'booking.options.service.massage': 'Masaje',
    'booking.options.service.kinesiology': 'Kinesiología',
    'booking.options.service.osteobalance': 'Osteobalance',
    'booking.options.service.movementLesson': 'Movement Lesson',
    'booking.options.service.feldenkrais': 'Feldenkrais',
    'booking.options.service.online': 'Consulta Online',
    ...
    'discovery.emotional.stressed.desc': 'Con dificultad para relajarme',
    'discovery.emotional.sad.title': 'Me siento triste/apático',
    'discovery.emotional.sad.desc': 'Y quiero cambiarlo',
    'discovery.emotional.balanced.title': 'Me siento equilibrado',
    'discovery.emotional.balanced.desc': 'No hay un problema emocional fuerte actualmente',
    'discovery.emotional.focus_physical.title': 'Prefiero centrarme en lo físico',
    'discovery.emotional.focus_physical.desc': 'No lo sé, pero quiero enfocarme en el cuerpo',

    // Discovery Form - Time Commitments
    'discovery.time.short.title': 'Sesión corta (hasta 1h)',
    'discovery.time.short.desc': 'Ideal si tienes poco tiempo',
    'discovery.time.standard.title': 'Sesión estándar (1-1.5h)',
    'discovery.time.standard.desc': 'Tiempo habitual de masaje/terapia',
    'discovery.time.long.title': 'Sesión larga o intensiva (hasta 2h)',
    'discovery.time.long.desc': 'Si quieres una atención muy completa',

    // Discovery Form - Budget
    'discovery.budget.basic.title': 'Hasta 60€',
    'discovery.budget.basic.desc': 'Opción básica',
    'discovery.budget.standard.title': '60-90€',
    'discovery.budget.standard.desc': 'Hasta 2h, modalidad completa',
    'discovery.budget.premium.title': 'Más de 90€',
    'discovery.budget.premium.desc': 'Sesión larga premium',

    // Discovery Form - Recommendations
    'discovery.recommendation.emotional.service': 'Reequilibrio Emocional',
    'discovery.recommendation.emotional.desc': 'Terapia holística para gestionar estrés, ansiedad o tristeza. Se enfoca en superar problemas emocionales y recuperar la armonía y la felicidad.',
    'discovery.recommendation.emotional.benefit1': 'Reducción de estrés',
    'discovery.recommendation.emotional.benefit2': 'Equilibrio emocional',
    'discovery.recommendation.emotional.benefit3': 'Claridad mental',
    'discovery.recommendation.emotional.benefit4': 'Paz interior',

    'discovery.recommendation.manual.service': 'Sesión Terapéutica Manual',
    'discovery.recommendation.manual.desc': 'Masaje terapéutico especializado para aliviar dolor y tensiones musculares. Profesionales con experiencia te ayudarán a relajar contracturas.',
    'discovery.recommendation.manual.benefit1': 'Alivio del dolor',
    'discovery.recommendation.manual.benefit2': 'Reducción de contracturas',
    'discovery.recommendation.manual.benefit3': 'Mejora de movilidad',
    'discovery.recommendation.manual.benefit4': 'Relajación muscular',

    'discovery.recommendation.integrative.service': 'Alivio de Tensión Integrativo (4 en 1)',
    'discovery.recommendation.integrative.desc': 'Combina masaje, kinesiología, osteopatía y movimientos (Feldenkrais) para un alivio profundo de tensiones crónicas.',
    'discovery.recommendation.integrative.benefit1': 'Tratamiento integral',
    'discovery.recommendation.integrative.benefit2': 'Alivio profundo',
    'discovery.recommendation.integrative.benefit3': 'Combinación de técnicas',
    'discovery.recommendation.integrative.benefit4': 'Resultados duraderos',

    'discovery.recommendation.relax.service': 'Masaje Relajante Completo',
    'discovery.recommendation.relax.desc': 'Experiencia de relajación global (física y mental), ideal si tu objetivo es simplemente descansar y recargar energía.',
    'discovery.recommendation.relax.benefit1': 'Relajación profunda',
    'discovery.recommendation.relax.benefit2': 'Reducción de estrés',
    ...
    'discovery.analysis.intro': 'Hemos identificado que',
    ...
    'discovery.diagnosis.cause.structural': 'Desequilibrio Estructural/Mecánico',
    'discovery.diagnosis.cause.general': 'Necesidad de Mantenimiento/Prevención',
    'discovery.diagnosis.strategy.structural': 'Liberación Estructural y Movilidad',
    'discovery.diagnosis.strategy.regulation': 'Regulación del Sistema Nervioso',
    'discovery.diagnosis.strategy.rebalance': 'Reequilibrio Cuerpo-Mente',
    'discovery.diagnosis.freq.high': 'Intensivo (1 sesión/semana durante 3 semanas)',
    'discovery.diagnosis.freq.medium': 'Mantenimiento (1 sesión cada 2-3 semanas)',
    'discovery.diagnosis.freq.low': 'Preventivo (1 sesión al mes)',
    'discovery.goal.athlete': 'tu recuperación deportiva',
    'discovery.goal.office': 'tu postura',
    'discovery.goal.stress': 'tu tranquilidad',
    'discovery.goal.pain': 'tu confort físico',
    'discovery.goal.general': 'tu bienestar general',
    'discovery.feeling.relaxed': 'relajado/a',
    'discovery.feeling.energized': 'con energía',
    'discovery.feeling.balanced': 'en equilibrio',
    ...
    'onboarding.questions.userType.title': '¿Cuál es tu perfil principal?',
    'onboarding.userTypes.student': 'Estudiante',
    'onboarding.userTypes.office': 'Trabajador de oficina',
    'onboarding.userTypes.artist': 'Artista',
    ...
    'onboarding.questions.goals.title': '¿Qué objetivos tienes?',
    'onboarding.goals.stress': 'Reducir estrés',
    'onboarding.goals.pain': 'Aliviar dolor',
    'onboarding.goals.posture': 'Mejorar postura',
    'onboarding.goals.sleep': 'Mejorar sueño',
    'onboarding.goals.energy': 'Aumentar energía',
    'onboarding.goals.focus': 'Mejorar concentración',
    ...
    'onboarding.feelings.calm': 'Calmado',
    'onboarding.feelings.light': 'Ligero',
    'onboarding.feelings.energized': 'Energizado',
    'onboarding.feelings.focused': 'Enfocado',
    'onboarding.feelings.confident': 'Seguro',

    'onboarding.questions.approach.title': '¿Qué enfoque prefieres?',
    'onboarding.approaches.massage': 'Masaje',
    'onboarding.approaches.kinesiology': 'Kinesiología',
    'onboarding.approaches.feldenkrais': 'Feldenkrais',
    'onboarding.approaches.energy': 'Energético',
    'onboarding.approaches.open': 'Abierto a sugerencias',

    'onboarding.questions.timePreference.title': 'Preferencia de tiempo',
    ...
    'recommendations.massage.description': 'Terapia manual para aliviar tensiones y mejorar la circulación.',
    'recommendations.kinesiology.description': 'Equilibrio integral mediante test muscular y correcciones suaves.',
    'recommendations.feldenkrais.description': 'Aprendizaje somático para mejorar el movimiento y la postura.',

    // Personalized Pages - Office Workers
    'office.seo.title': 'Masaje para Oficina en Barcelona | EKA Balance',
    'office.seo.desc': 'Alivia el dolor de espalda y cuello causado por el trabajo de oficina. Terapias especializadas para mejorar tu postura y reducir el estrés.',
    'office.seo.keywords': 'masaje oficina, dolor espalda, ergonomía, estrés laboral, barcelona',
    'office.problems.pain.title': 'Dolor postural',
    'office.problems.pain.desc': 'Dolor en cuello, hombros y espalda por posturas incorrectas frente al ordenador',
    ...
    'office.benefits.exercises.desc': 'Ejercicios y correcciones posturales para prevenir problemas futuros',
    ...
    'athletes.seo.title': 'Masaje Deportivo en Barcelona | EKA Balance',
    'athletes.seo.desc': 'Mejora tu rendimiento y recupérate más rápido con nuestros masajes deportivos. Prevención de lesiones y tratamiento muscular.',
    'athletes.seo.keywords': 'masaje deportivo, recuperación, lesiones, rendimiento, barcelona',

    // Personalized Pages - Artists
    'artists.seo.title': 'Bienestar para Artistas en Barcelona | EKA Balance',
    'artists.seo.desc': 'Cuida tus manos y tu cuerpo. Terapias para artistas visuales y creativos que necesitan mantener su herramienta de trabajo en forma.',
    'artists.seo.keywords': 'masaje artistas, dolor manos, creatividad, bienestar, barcelona',

    // Personalized Pages - Musicians
    'musicians.seo.title': 'Fisioterapia para Músicos en Barcelona | EKA Balance',
    'musicians.seo.desc': 'Prevención y tratamiento de lesiones en músicos. Mejora tu técnica y reduce la tensión con nuestras terapias especializadas.',
    'musicians.seo.keywords': 'masaje músicos, lesiones, postura, rendimiento musical, barcelona',

    // Personalized Pages - Students
    'students.seo.title': 'Relajación para Estudiantes en Barcelona | EKA Balance',
    'students.seo.desc': 'Combate el estrés de los exámenes y mejora tu concentración. Terapias diseñadas para estudiantes que necesitan rendir al máximo.',
    'students.seo.keywords': 'estrés estudiantes, concentración, exámenes, postura estudio, barcelona',

    // Personalized Pages - First Time
    'firstTime.seo.title': 'Tu Primera Visita | EKA Balance Barcelona',
    'firstTime.seo.desc': 'Descubre qué esperar en tu primera sesión. Te guiamos paso a paso para que te sientas cómodo y relajado.',
    'firstTime.seo.keywords': 'primera visita, masaje barcelona, qué esperar, bienestar, relajación',

    // Personalized Pages - Detailed Content
    'personalized.students.hero.title': 'Estudiantes',
    'personalized.students.hero.description': 'Gestión del estrés y mejora del rendimiento académico.',
    'personalized.students.understanding.title': 'Entendemos tus desafíos',
    'personalized.students.understanding.description1': 'La presión de los exámenes y las largas horas de estudio pueden afectar tu salud física y mental.',
    'personalized.students.understanding.description2': 'Te ayudamos a encontrar el equilibrio para que puedas rendir al máximo sin sacrificar tu bienestar.',
    'personalized.students.understanding.callToAction': 'Reserva tu sesión',
    'personalized.students.services.title': 'Servicios recomendados',
    'personalized.students.services.subtitle': 'Terapias diseñadas para estudiantes',
    'personalized.students.services.kinesiologyStress.title': 'Kinesiología para el estrés',
    'personalized.students.services.kinesiologyStress.description': 'Equilibra tu sistema nervioso y reduce la ansiedad ante los exámenes.',
    ...
    'personalized.officeWorkers.hero.title': 'Trabajadores de Oficina',
    'personalized.officeWorkers.hero.description': 'Alivio del dolor y corrección postural.',
    'personalized.officeWorkers.understanding.title': 'El impacto del trabajo sedentario',
    'personalized.officeWorkers.understanding.description1': 'Pasar muchas horas sentado frente al ordenador puede causar dolores crónicos y fatiga.',
    'personalized.officeWorkers.understanding.description2': 'Nuestras terapias están enfocadas en contrarrestar estos efectos y mejorar tu calidad de vida laboral.',
    'personalized.officeWorkers.understanding.callToAction': 'Mejora tu bienestar',
    ...
    'personalized.musicians.hero.title': 'Músicos',
    'personalized.musicians.hero.description': 'Cuidado del cuerpo para una mejor interpretación.',
    'personalized.musicians.understanding.title': 'Tu cuerpo es tu instrumento',
    'personalized.musicians.understanding.description1': 'La práctica musical intensa requiere un cuidado físico específico para prevenir lesiones.',
    'personalized.musicians.understanding.description2': 'Te ayudamos a mantener tu cuerpo afinado para que puedas tocar con libertad.',
    'personalized.musicians.understanding.callToAction': 'Cuida tu instrumento',
    'personalized.musicians.services.title': 'Servicios especializados',
    'personalized.musicians.services.subtitle': 'Para músicos de todos los niveles',
    'personalized.musicians.services.feldenkraisExpression.title': 'Feldenkrais para la expresión',
    'personalized.musicians.services.feldenkraisExpression.description': 'Mejora tu conciencia corporal y tu conexión con el instrumento.',
    'personalized.musicians.services.kinesiologyPerformance.title': 'Kinesiología para el rendimiento',
    'personalized.musicians.services.kinesiologyPerformance.description': 'Optimiza tu coordinación y reduce la tensión escénica.',
    ...
    'personalized.athletes.hero.title': 'Deportistas',
    'personalized.athletes.hero.description': 'Optimización del rendimiento y recuperación.',
    'personalized.athletes.understanding.title': 'Lleva tu cuerpo al siguiente nivel',
    'personalized.athletes.understanding.description1': 'El entrenamiento intenso exige una recuperación adecuada para evitar el sobreentrenamiento.',
    'personalized.athletes.understanding.description2': 'Nuestras terapias aceleran tu recuperación y te ayudan a prevenir lesiones.',
    'personalized.athletes.understanding.callToAction': 'Potencia tu rendimiento',
    'personalized.athletes.services.title': 'Servicios deportivos',
    'personalized.athletes.services.subtitle': 'Para atletas y aficionados',
    'personalized.athletes.services.sportsMassage.title': 'Masaje deportivo',
    'personalized.athletes.services.sportsMassage.description': 'Prepara tu musculatura y recupérate después del esfuerzo.',
    'personalized.athletes.services.osteobalance.title': 'Osteobalance',
    'personalized.athletes.services.osteobalance.description': 'Alineación estructural suave para mejorar la biomecánica.',
    ...
    'personalized.parents.hero.title': 'Padres y Madres',
    'personalized.parents.hero.description': 'Recupera tu energía y bienestar.',
    'personalized.parents.understanding.title': 'Cuidar de ti para cuidar de ellos',
    'personalized.parents.understanding.description1': 'La crianza es exigente y a menudo nos olvidamos de nuestras propias necesidades.',
    'personalized.parents.understanding.description2': 'Te ofrecemos un espacio para recargar pilas y encontrar tu equilibrio.',
    'personalized.parents.understanding.callToAction': 'Dedícate un momento',
    'personalized.parents.services.title': 'Servicios para padres',
    'personalized.parents.services.subtitle': 'Bienestar familiar',
    'personalized.parents.services.emotionalKinesiology.title': 'Kinesiología emocional',
    'personalized.parents.services.emotionalKinesiology.description': 'Gestiona el estrés y las emociones de la crianza.',
    'personalized.parents.services.relaxingMassage.title': 'Masaje relajante',
    'personalized.parents.services.relaxingMassage.description': 'Un momento de paz y desconexión total.',
    ...
    // VIP Section
    'vip.plan.bronze': 'Acceso Bronce',
    'vip.plan.bronze.description': 'Cuidado esencial para el mantenimiento',
    'vip.plan.bronze.price': '150€',
    'vip.plan.silver': 'Acceso Plata',
    'vip.plan.silver.description': 'Bienestar mensual completo',
    'vip.plan.silver.price': '280€',
    'vip.plan.gold': 'Acceso Oro',
    'vip.plan.gold.description': 'Transformación total y exclusividad',
    'vip.plan.gold.price': '500€',

    'vip.service.priority.title': 'Reserva Prioritaria',
    'vip.service.priority.description': 'Salta la cola con franjas exclusivas reservadas solo para ti.',
    'vip.service.displacements.title': 'Visitas a Domicilio',
    'vip.service.displacements.description': 'Vamos donde estés. Ahorra tiempo y disfruta de tratamientos en tu propio espacio.',
    'vip.service.health.title': 'Seguimiento de Salud',
    'vip.service.health.description': 'Revisiones regulares y seguimiento del progreso de tu salud física.',
    'vip.service.family.title': 'Beneficios Familiares',
    'vip.service.family.description': 'Comparte tus sesiones y beneficios con familiares directos.',

    'vip.benefits.transferable': 'Sesiones Transferibles',
    'vip.benefits.transferableDesc': 'Comparte con la familia',
    'vip.benefits.monthly': 'Revisión Mensual',
    'vip.benefits.monthlyDesc': 'Cuidado preventivo',
    'vip.benefits.barcelona': 'Exclusivo Barcelona',
    'vip.benefits.barcelonaDesc': 'Disponible en el centro',
    'vip.benefits.sessions': 'Sesiones extendidas',

    'vip.stats.concierge': 'Servicio Concierge',
    'vip.stats.exclusivity': 'Exclusividad',
    'vip.stats.clients': 'Top 1% Clientes',
    'vip.stats.possibilities': 'Posibilidades',
    'vip.stats.control': 'Control de Salud',
    'vip.stats.family': 'Plan Familiar',

    'vip.mostExclusive': 'Más Exclusivo',
    'vip.experienceDescription': 'Vive la cima del bienestar dirigido a aquellos que exigen lo mejor.',
    'vip.voicesOfExcellence': 'Voces de Excelencia',
    'vip.testimonialsSubtitle': 'Lo que dicen nuestros miembros de élite sobre su experiencia.',
    'vip.tier.standard': 'Miembro Estándar',

    'vip.testimonials.comment1': 'La mejor inversión que he hecho para mi salud. El servicio prioritario cambia las reglas del juego.',
    'vip.testimonials.comment2': 'Profesionalidad en estado puro. Elena entiende exactamente lo que mi cuerpo necesita.',
    'vip.testimonials.comment3': 'Me siento renovada después de cada sesión. La atención al detalle es inigualable.',

    'vip.hero.badge': 'Ultra Premium',
    'vip.hero.title.beyond': 'Más allá',
    'vip.hero.title.wellness': 'del Bienestar',
    'vip.hero.subtitle': 'Entra en un mundo donde tu bienestar es la prioridad absoluta. Tratamientos exclusivos, acceso prioritario y atención personalizada.',
    'vip.hero.cta.join': 'Únete al Círculo Interior',

    'vip.dashboard.member': 'Área de Miembros',
    'vip.dashboard.hello': 'Hola,',
    'vip.dashboard.status': 'Estado Actual:',
    'vip.dashboard.priorityBooking': 'Reserva Prioritaria',
    'vip.dashboard.viewPlans': 'Ver Planes VIP',

    'vip.features.badge': 'Excelencia',
    'vip.features.title': 'Diseñado para la Élite',
    'vip.features.subtitle': 'Cada detalle ha sido curado para ofrecer una experiencia que va más allá de una simple terapia.',

    'vip.plans.badge': 'Membresía',
    'vip.plans.title': 'Selecciona Tu Nivel',
    'vip.plans.subtitle': 'Elige el nivel de exclusividad que se adapte a tu estilo de vida.',
    'vip.plans.popular': 'Más Popular',
    'vip.plans.perMonth': '/ mes',
    'vip.plans.sessions': 'sesiones incluidas',
    'vip.plans.contact': 'Contactar para',

    'vip.exclusivePrivileges': 'Privilegios Exclusivos',
    'vip.testimonials.title': 'Experiencias de Élite',
    'vip.testimonials.subtitle': 'Escucha a quienes han elegido el camino de la excelencia.',
    'vip.testimonials.role1': 'CEO, Empresa Tecnológica',
    ...
    'vip.cta.location': 'UBICACIÓN EXCLUSIVA',
    'vip.cta.concierge': 'SERVICIO CONCIERGE',
    'vip.cta.guarantee': 'GARANTÍA TOTAL',
  },
  ...
  ru: {
    ...
    'hero.stats.sessions': '1500+ проведенных сессий',
    'hero.stats.clients': '96% история успеха',
    'hero.stats.experience': '10+ лет опыта',
    ...
    'casos.problems.backPain.symptom1': 'Колющая боль или постоянное напряжение в пояснице или шее',
    'casos.problems.backPain.symptom2': 'Трудно повернуть шею или поднять руку',
    'casos.problems.backPain.symptom3': 'Усталость после долгого сидения или стояния',
    'casos.problems.backPain.symptom4': 'Ощущение давления на плечи или голову',
    'casos.problems.backPain.cause1': 'Длительные позы и плохая эргономика',
    'casos.problems.backPain.cause2': 'Накопленный эмоциональный стресс',
    'casos.problems.backPain.cause3': 'Недостаток движения и сидячий образ жизни',
    'casos.problems.backPain.cause4': 'Заблокированное или поверхностное дыхание',
    'casos.problems.backPain.treatment': 'С помощью лечебного массажа, миофасциального релиза, кинезиологии для поиска глубинной причины (стресс, суставной или висцеральный блок) и техник постурального переобучения (Фельденкрайз).',
    'casos.problems.backPain.results': 'Многие люди замечают немедленное облегчение и большую подвижность уже после первого сеанса. Со временем тело заново учится поддерживать себя с меньшими усилиями и большей плавностью.',
    'casos.problems.stress.symptom1': 'Постоянные мысли и ментальная петля',
    'casos.problems.stress.symptom2': 'Трудности с расслаблением или сном',
    'casos.problems.stress.symptom3': 'Боль в шее, напряжение челюсти, утренняя усталость',
    'casos.problems.stress.symptom4': 'Интенсивные эмоции без видимой причины',
    'casos.problems.stress.cause1': 'Избыток ответственности и давления',
    'casos.problems.stress.cause2': 'Хронический стресс и нехватка времени на себя',
    'casos.problems.stress.cause3': 'Нерешенные травмы или тяжелый опыт',
    'casos.problems.stress.cause4': 'Дисбаланс вегетативной нервной системы',
    'casos.problems.stress.treatment': 'С помощью эмоциональной кинезиологии и техник вагальной системы для успокоения нервной системы. Мы добавляем мягкую работу с телом (Фельденкрайз, осознанное дыхание), чтобы научить тело "выходить из борьбы".',
    'casos.problems.stress.results': 'Человек снова лучше спит, внутреннее напряжение уменьшается, возвращается чувство контроля и спокойствия.',
    'casos.problems.digestive.symptom1': 'Вздутие живота, газы, рефлюкс или боль после еды',
    'casos.problems.digestive.symptom2': 'Усталость или сонливость после еды',
    'casos.problems.digestive.symptom3': 'Перепады настроения или раздражительность без причины',
    'casos.problems.digestive.symptom4': 'Пищевая непереносимость или чувствительность',
    'casos.problems.digestive.cause1': 'Невыявленная пищевая непереносимость',
    'casos.problems.digestive.cause2': 'Нерегулярное питание или стресс во время еды',
    'casos.problems.digestive.cause3': 'Эмоциональный стресс, влияющий на пищеварение',
    'casos.problems.digestive.cause4': 'Висцеральные блоки, влияющие на подвижность органов',
    'casos.problems.digestive.treatment': 'С помощью нутрициологической кинезиологии для выявления непереносимости или дефицита, мягких техник висцерального массажа и индивидуальных рекомендаций по питанию.',
    'casos.problems.digestive.results': 'Улучшается пищеварение, исчезает вздутие и повышается ежедневная энергия. Клиент учится слушать свое тело и адаптировать питание.',
    'casos.problems.migraines.symptom1': 'Интенсивная боль с одной стороны головы или в затылке',
    'casos.problems.migraines.symptom2': 'Давление в глазах или ощущение шлема',
    'casos.problems.migraines.symptom3': 'Головокружение или тошнота',
    'casos.problems.migraines.symptom4': 'Чувствительность к свету и шуму',
    'casos.problems.migraines.cause1': 'Шейный блок и мышечное напряжение',
    'casos.problems.migraines.cause2': 'Напряжение челюсти (бруксизм)',
    'casos.problems.migraines.cause3': 'Недостаток отдыха или избыток умственной стимуляции',
    'casos.problems.migraines.cause4': 'Гормональный или пищевой дисбаланс',
    'casos.problems.migraines.treatment': 'С помощью краниального Остеобаланса, мышечной разгрузки и вагальных техник для балансировки нервной системы. Также мы проверяем дыхание и осанку.',
    'casos.problems.migraines.results': 'Снижение частоты и интенсивности мигреней. Во многих случаях они полностью исчезают после регулировки шеи и черепа.',
    'casos.problems.lowEnergy.symptom1': 'Постоянная усталость, несмотря на хороший сон',
    'casos.problems.lowEnergy.symptom2': 'Низкая концентрация и память',
    'casos.problems.lowEnergy.symptom3': 'Раздражительность или апатия',
    'casos.problems.lowEnergy.symptom4': 'Ощущение "работы на автопилоте"',
    'casos.problems.lowEnergy.cause1': 'Длительный стресс и выгорание',
    'casos.problems.lowEnergy.cause2': 'Дефицит питательных веществ или метаболический дисбаланс',
    'casos.problems.lowEnergy.cause3': 'Гормональные проблемы (щитовидная железа, надпочечники)',
    'casos.problems.lowEnergy.cause4': 'Эмоциональное истощение и отсутствие цели',
    ...
    'casos.problems.lowEnergy.results': 'Заметное улучшение энергии, ясность ума и более стабильное настроение.',
    'casos.problems.sleep.symptom1': 'Трудности с засыпанием или ночные пробуждения',
    'casos.problems.sleep.symptom2': 'Утренняя усталость, напряжение или яркие сны',
    'casos.problems.sleep.symptom3': 'Навязчивые мысли перед сном',
    'casos.problems.sleep.symptom4': 'Поверхностный или невосстанавливающий сон',
    'casos.problems.sleep.cause1': 'Избыток стресса и умственная гиперактивация',
    'casos.problems.sleep.cause2': 'Дисбаланс нервной системы и циркадных ритмов',
    'casos.problems.sleep.cause3': 'Отсутствие режима или гигиены сна',
    'casos.problems.sleep.cause4': 'Проблемы с пищеварением или гормонами',
    'casos.problems.sleep.treatment': 'С помощью Фельденкрайза, управляемого дыхания, вагальных техник и кинезиологии для балансировки гормональной системы.',
    'casos.problems.sleep.results': 'Улучшение глубокого сна и полноценный отдых уже после нескольких сеансов.',
    'casos.problems.recovery.symptom1': 'Остаточная боль или ограничение суставов',
    'casos.problems.recovery.symptom2': 'Ощущение слабости или дисбаланса',
    'casos.problems.recovery.symptom3': 'Эмоциональные блоки, связанные с травмой',
    'casos.problems.recovery.symptom4': 'Страх движения или реактивность',
    'casos.problems.recovery.cause1': 'Внутренние рубцы и спайки',
    'casos.problems.recovery.cause2': 'Мышечные и постуральные компенсации',
    'casos.problems.recovery.cause3': 'Физическая травма с эмоциональным компонентом',
    'casos.problems.recovery.cause4': 'Телесная память о травматическом опыте',
    'casos.problems.recovery.treatment': 'С помощью Остеобаланса, постурального переобучения и работы с фасциальной системой. Мы также сопровождаем уверенность в теле и память тела.',
    'casos.problems.recovery.results': 'Восстановление подвижности, облегчение боли и чувство безопасности в движении.',
    ...
    'booking.form.location': 'Предпочтение по месту',
    'booking.form.locationPlaceholder': 'Выберите место',
    'booking.form.timeSlot': 'Временной интервал',
    'booking.form.timeSlotPlaceholder': 'Выберите интервал',
    'booking.form.availability': 'Доступность',
    'booking.form.availabilityPlaceholder': 'Когда вы можете прийти?',
    'booking.form.objective': 'Цель или тип боли',
    'booking.form.objectivePlaceholder': 'Кратко опишите, что вам нужно...',
    'booking.form.submit': 'Отправить в WhatsApp',
    ...
    'discovery.emotional.stressed.desc': 'С трудом расслабляюсь',
    'discovery.emotional.sad.title': 'Я чувствую грусть/апатию',
    'discovery.emotional.sad.desc': 'И я хочу это изменить',
    'discovery.emotional.balanced.title': 'Я чувствую себя сбалансированным',
    'discovery.emotional.balanced.desc': 'В настоящее время нет сильной эмоциональной проблемы',
    'discovery.emotional.focus_physical.title': 'Я предпочитаю сосредоточиться на физическом',
    'discovery.emotional.focus_physical.desc': 'Я не знаю, но я хочу сосредоточиться на теле',

    // Discovery Form - Time Commitments
    'discovery.time.short.title': 'Короткая сессия (до 1ч)',
    'discovery.time.short.desc': 'Идеально, если у вас мало времени',
    'discovery.time.standard.title': 'Стандартная сессия (1-1,5ч)',
    'discovery.time.standard.desc': 'Обычное время массажа/терапии',
    'discovery.time.long.title': 'Длинная или интенсивная сессия (до 2ч)',
    'discovery.time.long.desc': 'Если вы хотите очень полное внимание',
    ...
    'onboarding.questions.goals.title': 'Какие у вас цели?',
    'onboarding.goals.stress': 'Снизить стресс',
    'onboarding.goals.pain': 'Облегчить боль',
    'onboarding.goals.posture': 'Улучшить осанку',
    'onboarding.goals.sleep': 'Улучшить сон',
    'onboarding.goals.energy': 'Увеличить энергию',
    'onboarding.goals.focus': 'Улучшить концентрацию',
    'onboarding.goals.bodyAwareness': 'Осознание тела',
    'onboarding.goals.feelGood': 'Чувствовать себя хорошо',

    'onboarding.questions.preferredFeeling.title': 'Как вы хотите себя чувствовать?',
    'onboarding.feelings.calm': 'Спокойным',
    'onboarding.feelings.light': 'Легким',
    'onboarding.feelings.energized': 'Энергичным',
    'onboarding.feelings.focused': 'Сосредоточенным',
    'onboarding.feelings.confident': 'Уверенным',

    'onboarding.questions.approach.title': 'Какой подход вы предпочитаете?',
    'onboarding.approaches.massage': 'Массаж',
    'onboarding.approaches.kinesiology': 'Кинезиология',
    'onboarding.approaches.feldenkrais': 'Фельденкрайз',
    'onboarding.approaches.energy': 'Энергетический',
    'onboarding.approaches.open': 'Открыт для предложений',

    'onboarding.questions.timePreference.title': 'Предпочтение по времени',
    'onboarding.time.60min': '60 минут',
    'onboarding.time.90min': '90 минут',
    'onboarding.time.120min': '120 минут',

    // Recommendations Descriptions
    'recommendations.massage.description': 'Мануальная терапия для снятия напряжения и улучшения кровообращения.',
    'recommendations.kinesiology.description': 'Комплексный баланс с помощью мышечного теста и мягких коррекций.',
    'recommendations.feldenkrais.description': 'Соматическое обучение для улучшения движения и осанки.',
    ...
    // VIP Section
    'vip.plan.bronze': 'Доступ Бронза',
    'vip.plan.bronze.description': 'Основной уход для поддержания здоровья',
    'vip.plan.bronze.price': '150€',
    'vip.plan.silver': 'Доступ Серебро',
    'vip.plan.silver.description': 'Полное ежемесячное благополучие',
    'vip.plan.silver.price': '280€',
    'vip.plan.gold': 'Доступ Золото',
    'vip.plan.gold.description': 'Полная трансформации и эксклюзивность',
    'vip.plan.gold.price': '500€',

    'vip.service.priority.title': 'Приоритетное Бронирование',
    'vip.service.priority.description': 'Без очереди с эксклюзивными слотами, зарезервированными только для вас.',
