...
export const servicesTranslations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'prompt.assessment': 'Diagnosi suau i precisa',
    ...
    // Missing Casos Keys
    'casos.problems.backPain.concerns.0': 'Dolor lumbar',
    'casos.problems.backPain.concerns.1': 'Ciatàlgia',
    'casos.problems.backPain.concerns.2': 'Rigidesa',
    'casos.problems.backPain.concerns.3': 'Hèrnia',
    ...
    'casos.problems.backPain.approach': 'Descompressió i reeducació',
    ...
    'casos.problems.stress.concerns.0': 'Ansietat',
    'casos.problems.stress.concerns.1': 'Insomni',
    'casos.problems.stress.concerns.2': 'Taquicàrdia',
    'casos.problems.stress.concerns.3': 'Irritabilitat',
    ...
    'casos.problems.stress.approach': 'Regulació vagal',
    'casos.problems.stress.results': 'Calma i claredat',
    'casos.problems.stress.successStory': 'Ara dormo com un nadó.',

    'casos.problems.digestive.concerns.0': 'Inflor',
    'casos.problems.digestive.concerns.1': 'Gasos',
    'casos.problems.digestive.concerns.2': 'Acidesa',
    'casos.problems.digestive.concerns.3': 'Restrenyiment',
    ...
    'casos.problems.digestive.approach': 'Massatge visceral',
    'casos.problems.digestive.results': 'Digestions lleugeres',
    'casos.problems.digestive.successStory': 'Adéu a la inflor.',

    'casos.problems.migraines.concerns.0': 'Mal de cap',
    'casos.problems.migraines.concerns.1': 'Sensibilitat',
    'casos.problems.migraines.concerns.2': 'Nàusees',
    'casos.problems.migraines.concerns.3': 'Aura',
    ...
    'casos.problems.migraines.approach': 'Craniosacral',
    'casos.problems.migraines.results': 'Cap lliure',
    'casos.problems.migraines.successStory': 'Visc sense dolor.',

    'casos.problems.lowEnergy.concerns.0': 'Fatiga',
    'casos.problems.lowEnergy.concerns.1': 'Debilitat',
    'casos.problems.lowEnergy.concerns.2': 'Boira mental',
    'casos.problems.lowEnergy.concerns.3': 'Apatia',
    ...
    'casos.problems.lowEnergy.approach': 'Reactivació',
    ...
    'casos.problems.hormonal.concerns.0': 'Dolor menstrual',
    'casos.problems.hormonal.concerns.1': 'Irregularitat',
    'casos.problems.hormonal.concerns.2': 'Spm',
    'casos.problems.hormonal.concerns.3': 'Menopausa',
    ...
    'casos.problems.hormonal.approach': 'Kinesiologia',
    'casos.problems.hormonal.results': 'Cicles regulars',
    'casos.problems.hormonal.successStory': 'Els meus cicles són regulars.',

    'casos.problems.sleep.concerns.0': 'Insomni',
    'casos.problems.sleep.concerns.1': 'Despertars',
    'casos.problems.sleep.concerns.2': 'Malsons',
    'casos.problems.sleep.concerns.3': 'Cansament matinal',
    ...
    'casos.problems.sleep.approach': 'Relaxació profunda',
    ...
    'casos.problems.recovery.concerns.0': 'Dolor',
    'casos.problems.recovery.concerns.1': 'Limitació',
    'casos.problems.recovery.concerns.2': 'Inflamació',
    'casos.problems.recovery.concerns.3': 'Feblesa',
    ...
    'casos.problems.recovery.approach': 'Teràpia manual',
  ...
  en: {
    ...
    'service.systemic.title': 'Systemic wellness practices',
    ...
    // Services page
    'services.integralWellbeingFor': 'wellness practices for integral wellbeing',
    ...
    'elena.about.p2': 'Her work is not just about relieving concerns, but discovering and working on the deep causes that prevent living fully. Her view is holistic: she sees the human being as a living unit where body, mind, emotions and life experience are deeply interconnected.',
    ...
    'elena.work.exploreDesc': 'Discover all available wellness practices',
    ...
    'casos.problems.backPain.concerns.0': 'Stabbing pain or constant tension in the lower back or cervical area',
    'casos.problems.backPain.concerns.1': 'Difficulty turning the neck or lifting the arm',
    'casos.problems.backPain.concerns.2': 'Fatigue after sitting or standing for a long time',
    'casos.problems.backPain.concerns.3': 'Sensation of pressure on the shoulders or head',
    ...
    'casos.problems.backPain.approach': 'With therapeutic massage, myofascial release, kinesiology to find the deep cause (stress, joint or visceral blockage), and postural re-education techniques (Feldenkrais).',
    ...
    'casos.problems.stress.concerns.0': 'Constant thoughts and mental loop',
    'casos.problems.stress.concerns.1': 'Difficulty relaxing or sleeping',
    'casos.problems.stress.concerns.2': 'Cervical pain, jaw tension, morning fatigue',
    'casos.problems.stress.concerns.3': 'Intense emotions without apparent reason',
    ...
    'casos.problems.stress.approach': 'With emotional kinesiology and vagal system techniques to calm the nervous system. We add gentle body work (Feldenkrais, conscious breathing) to teach the body to "get out of the fight".',
    ...
    'casos.problems.digestive.concerns.0': 'Abdominal bloating, gas, reflux or pain after eating',
    'casos.problems.digestive.concerns.1': 'Tiredness or postprandial drowsiness',
    'casos.problems.digestive.concerns.2': 'Mood swings or irritability without reason',
    'casos.problems.digestive.concerns.3': 'Food intolerances or sensitivities',
    ...
    'casos.problems.digestive.approach': 'With nutritional kinesiology to detect intolerances or deficits, gentle visceral massage techniques and personalized dietary recommendations.',
    ...
    'casos.problems.migraines.concerns.0': 'Intense pain on one side of the head or neck',
    'casos.problems.migraines.concerns.1': 'Eye pressure or helmet sensation',
    'casos.problems.migraines.concerns.2': 'Dizziness or nausea',
    'casos.problems.migraines.concerns.3': 'Sensitivity to light and noises',
    ...
    'casos.problems.migraines.approach': 'With cranial Osteobalance, muscle discharge and vagal techniques to Balance the nervous system. We also review breathing and posture.',
    ...
    'casos.problems.migraines.successStory': 'Carla, 39 years old, designer: "I had migraines 3-4 times a week. After the cranial approach, i haven\'t had any for 6 months. It has been a total life change."',
    ...
    'casos.problems.lowEnergy.concerns.0': 'Constant tiredness despite sleeping well',
    'casos.problems.lowEnergy.concerns.1': 'Low concentration and memory',
    'casos.problems.lowEnergy.concerns.2': 'Irritability or apathy',
    'casos.problems.lowEnergy.concerns.3': 'Feeling of "running on autopilot"',
    ...
    'casos.problems.lowEnergy.approach': 'With kinesiology to identify chemical or emotional imbalances, natural supplementation and conscious movement techniques.',
    ...
    'casos.problems.hormonal.concerns.0': 'Menstrual pain, mood swings or irregular periods',
    'casos.problems.hormonal.concerns.1': 'Premenstrual fatigue or insomnia',
    'casos.problems.hormonal.concerns.2': 'Difficulty getting pregnant',
    'casos.problems.hormonal.concerns.3': 'Menopause or perimenopause concerns',
    ...
    'casos.problems.hormonal.approach': 'With hormonal kinesiology, pelvic Osteobalance and personalized nutritional support. We also work on the relationship with one\'s own body and femininity.',
    'casos.problems.hormonal.results': 'The cycle improves, pain disappears and a natural and healthy rhythm is restored.',
    'casos.problems.hormonal.successStory': 'Sofia, 32 years old, teacher: "my cycles were chaos and menstrual pain paralyzed me. After hormonal approach, my cycle is regular and painless. I feel reconnected with my body."',
    ...
    'casos.problems.sleep.concerns.0': 'Difficulty falling asleep or night awakenings',
    'casos.problems.sleep.concerns.1': 'Morning fatigue, tension or intense dreams',
    'casos.problems.sleep.concerns.2': 'Recurrent thoughts before sleeping',
    'casos.problems.sleep.concerns.3': 'Light or unrefreshing sleep',
    ...
    'casos.problems.sleep.approach': 'With Feldenkrais, guided breathing, vagal techniques and kinesiology to Balance the hormonal system.',
    ...
    'casos.problems.recovery.concerns.0': 'Residual pain or joint limitation',
    'casos.problems.recovery.concerns.1': 'Feeling of weakness or imbalance',
    'casos.problems.recovery.concerns.2': 'Emotional blockages associated with the injury',
    'casos.problems.recovery.concerns.3': 'Fear of movement or reactivity',
    ...
    'casos.problems.recovery.approach': 'With Osteobalance, postural re-education and fascial system work. We also accompany body confidence and body memory.',
    ...
    'massage.page.duration90': 'Complete approach',
    ...
    'kinesiology.page.duration90': 'Complete and in-depth approach',
    ...
    'massage.techniques.deepTissue': 'Deep tissue wellness practices',
    ...
    'hero.description': 'A 90-minute journey to map your physical, emotional, and energetic landscape. It\'s not just a assessment — it\'s the first step to coming home to your body.',
    ...
    'service.step4.desc': 'You don\'t leave empty-handed. You receive a personalized plan with exercises, lifestyle tips, and approach recommendations.',
    'variants.title': 'Choose your path',
    'variants.mapping.title': '360° mapping',
    'variants.mapping.price': '€90',
    'variants.mapping.duration': '90 min',
    'variants.mapping.desc': 'The foundational session. Full assessment + first approach.',
    ...
    'prompt.assessment': 'Gentle and precise assessment',
    ...
    'prompt.firstVisit': 'First visit with assessment and gentle work. From here, i outline-solid the',
    ...
    'benefits.benefit4.science': 'The 360° approach addresses root causes rather than concerns, creating lasting neuroplastic changes in pain perception.',
    ...
    'benefits.philosophy': 'We measure success not just in the absence of concerns, but in the presence of vitality, joy, and the deep knowing that your body is your ally in life.',
    ...
    'service.step3.details.1': 'Manual wellness practices and bodywork',
    ...
    'testimonials.keyInsight1': 'How the 360° approach addressed root causes, not just concerns',
    ...
    'story.philosophy': 'Every body has a story. Every story deserves to be heard in its fullness — not just the concerns, but the whole human experience beneath them.',
  ...
  es: {
    ...
    // Services page
    'services.integralWellbeingFor': 'prácticas de bienestar para el bienestar integral',
    ...
    'elena.work.exploreDesc': 'Descubre todas las prácticas de bienestar disponibles',
    ...
    'casos.problems.backPain.concerns.0': 'Dolor punzante o tensión constante en la zona lumbar o cervical',
    'casos.problems.backPain.concerns.1': 'Dificultad para girar el cuello o levantar el brazo',
    'casos.problems.backPain.concerns.2': 'Fatiga después de estar sentado o de pie mucho tiempo',
    'casos.problems.backPain.concerns.3': 'Sensación de presión en los hombros o cabeza',
    ...
    'casos.problems.backPain.approach': 'Con masaje terapéutico, liberación miofascial, kinesiología para encontrar la causa profunda (estrés, bloqueo articular o visceral), y técnicas de reeducación postural (Feldenkrais).',
    ...
    'casos.problems.stress.concerns.0': 'Pensamientos constantes y bucle mental',
    'casos.problems.stress.concerns.1': 'Dificultad para relajarse o dormir',
    'casos.problems.stress.concerns.2': 'Dolor cervical, tensión mandibular, fatiga por la mañana',
    'casos.problems.stress.concerns.3': 'Emociones intensas sin motivo aparente',
    ...
    'casos.problems.stress.approach': 'Con kinesiología emocional y técnicas del sistema vagal para calmar el sistema nervioso. Añadimos trabajo corporal suave (Feldenkrais, respiración consciente) para enseñar al cuerpo a "salir de la lucha".',
    ...
    'casos.problems.digestive.concerns.0': 'Hinchazón abdominal, gases, reflujo o dolor después de comer',
    'casos.problems.digestive.concerns.1': 'Cansancio o somnolencia postprandial',
    'casos.problems.digestive.concerns.2': 'Cambios de humor o irritabilidad sin motivo',
    'casos.problems.digestive.concerns.3': 'Intolerancias alimentarias o sensibilidades',
    ...
    'casos.problems.digestive.approach': 'Con kinesiología nutricional para detectar intolerancias o déficits, técnicas de masaje visceral suave y recomendaciones alimentarias personalizadas.',
    ...
    'casos.problems.migraines.concerns.0': 'Dolor intenso de un lado de la cabeza o en la nuca',
    'casos.problems.migraines.concerns.1': 'Presión ocular o sensación de casco',
    'casos.problems.migraines.concerns.2': 'Mareos o náuseas',
    'casos.problems.migraines.concerns.3': 'Sensibilidad a la luz y a los ruidos',
    ...
    'casos.problems.migraines.approach': 'Con Osteobalance craneal, descarga muscular y técnicas vagales para equilibrar el sistema nervioso. También revisamos la respiración y la postura.',
    ...
    'casos.problems.migraines.successStory': 'Carla, 39 años, diseñadora: "tenía migrañas 3-4 veces por semana. Después del enfoque craneal, hace 6 meses que no tengo ninguna. Ha sido un cambio de vida total."',
    ...
    'casos.problems.lowEnergy.concerns.0': 'Cansancio constante a pesar de dormir bien',
    'casos.problems.lowEnergy.concerns.1': 'Baja concentración y memoria',
    'casos.problems.lowEnergy.concerns.2': 'Irritabilidad o apatía',
    'casos.problems.lowEnergy.concerns.3': 'Sensación de "funcionar con el piloto automático"',
    ...
    'casos.problems.lowEnergy.approach': 'Con kinesiología para identificar desequilibrios químicos o emocionales, suplementación natural y técnicas de movimiento consciente.',
    ...
    'casos.problems.hormonal.concerns.0': 'Dolor menstrual, cambios de humor o reglas irregulares',
    'casos.problems.hormonal.concerns.1': 'Fatiga premenstrual o insomnio',
    'casos.problems.hormonal.concerns.2': 'Dificultad para quedar embarazada',
    'casos.problems.hormonal.concerns.3': 'concerns de menopausia o premenopausia',
    ...
    'casos.problems.hormonal.approach': 'Con kinesiología hormonal, Osteobalance pélvico y apoyo nutricional personalizado. También trabajamos la relación con el propio cuerpo y la feminidad.',
    'casos.problems.hormonal.results': 'Mejora el ciclo, desaparece el dolor y se restablece un ritmo natural y saludable.',
    'casos.problems.hormonal.successStory': 'Sofia, 32 años, profesora: "mis ciclos eran un caos y el dolor menstrual me paralizaba. Después del enfoque hormonal, mi ciclo es regular y sin dolor. Me siento reconectada con mi cuerpo."',
    ...
    'casos.problems.sleep.concerns.0': 'Dificultad para dormirse o despertares nocturnos',
    'casos.problems.sleep.concerns.1': 'Fatiga matinal, tensión o sueños intensos',
    'casos.problems.sleep.concerns.2': 'Pensamientos recurrentes antes de dormir',
    'casos.problems.sleep.concerns.3': 'Sueño ligero o poco reparador',
    ...
    'casos.problems.sleep.approach': 'Con Feldenkrais, respiración guiada, técnicas vagales y kinesiología para equilibrar el sistema hormonal.',
    ...
    'casos.problems.recovery.concerns.0': 'Dolor residual o limitación articular',
    'casos.problems.recovery.concerns.1': 'Sensación de debilidad o desequilibrio',
    'casos.problems.recovery.concerns.2': 'Bloqueos emocionales asociados a la lesión',
    'casos.problems.recovery.concerns.3': 'Miedo al movimiento o reactividad',
    ...
    'casos.problems.recovery.approach': 'Con Osteobalance, reeducación postural y trabajo del sistema fascial. Acompañamos también la confianza corporal y la memoria del cuerpo.',
    ...
    'massage.page.duration90': 'enfoque completo',
    ...
    'kinesiology.page.duration90': 'enfoque completo y profundo',
    ...
    'massage.techniques.deepTissue': 'prácticas de bienestar de tejido profundo',
    ...
    'hero.description': 'Un viaje de 90 minutos para mapear tu paisaje físico, emocional y energético. No es solo un evaluación — es el primer paso para volver a casa, a tu cuerpo.',
    ...
    'service.step4.desc': 'No te vas con las manos vacías. Recibes un plan personalizado con ejercicios, consejos de estilo de vida y recomendaciones de enfoque.',
    'variants.title': 'Elige tu camino',
    'variants.mapping.title': 'Mapeo 360°',
    'variants.mapping.price': '90€',
    'variants.mapping.duration': '90 min',
    'variants.mapping.desc': 'La sesión fundamental. evaluación completo + primer enfoque.',
    ...
    'prompt.assessment': 'evaluación suave y preciso',
    ...
    'prompt.firstVisit': 'Primera visita con evaluación y trabajo suave. A partir de aquí, trazo el',
    ...
    'service.step3.details.1': 'prácticas de bienestar manual y trabajo corporal',
  ...
  ru: {
    ...
    'casos.problems.backPain.concerns.0': 'Колющая боль или постоянное напряжение в поясничной или шейной области',
    'casos.problems.backPain.concerns.1': 'Трудности с поворотом шеи или поднятием руки',
    'casos.problems.backPain.concerns.2': 'Усталость после долгого сидения или стояния',
    'casos.problems.backPain.concerns.3': 'Ощущение давления на плечи или голову',
    ...
    'casos.problems.backPain.approach': 'С помощью терапевтического массажа, миофасциального релиза, кинезиологии для поиска глубокой причины (стресс, суставная или висцеральная блокировка) и техник постурального переобучения (фельденкрайз).',
    ...
    'casos.problems.stress.concerns.0': 'Постоянные мысли и ментальная петля',
    'casos.problems.stress.concerns.1': 'Трудности с расслаблением или сном',
    'casos.problems.stress.concerns.2': 'Боль в шее, напряжение челюсти, утренняя усталость',
    'casos.problems.stress.concerns.3': 'Интенсивные эмоции без видимой причины',
    ...
    'casos.problems.stress.approach': 'С помощью эмоциональной кинезиологии и техник вагусной системы для успокоения нервной системы. мы добавляем мягкую работу с телом (фельденкрайз, осознанное дыхание), чтобы научить тело "выходить из борьбы".',
    ...
    'casos.problems.digestive.concerns.0': 'Вздутие живота, газы, рефлюкс или боль после еды',
    'casos.problems.digestive.concerns.1': 'Усталость или сонливость после еды',
    'casos.problems.digestive.concerns.2': 'Перепады настроения или раздражительность без причины',
    'casos.problems.digestive.concerns.3': 'Пищевая непереносимость или чувствительность',
    ...
    'casos.problems.digestive.approach': 'С помощью нутрициологической кинезиологии для выявления непереносимости или дефицита, мягких техник висцерального массажа и персонализированных рекомендаций по питанию.',
    ...
    'casos.problems.migraines.concerns.0': 'Интенсивная боль с одной стороны головы или в затылке',
    'casos.problems.migraines.concerns.1': 'Давление в глазах или ощущение шлема',
    'casos.problems.migraines.concerns.2': 'Головокружение или тошнота',
    'casos.problems.migraines.concerns.3': 'Чувствительность к свету и звукам',
    ...
    'casos.problems.migraines.approach': 'С помощью краниального остеобаланса, мышечной разгрузки и вагусных техник для балансировки нервной системы. мы также проверяем дыхание и осанку.',
    ...
    'casos.problems.lowEnergy.concerns.0': 'Постоянная усталость, несмотря на хороший сон',
    'casos.problems.lowEnergy.concerns.1': 'Низкая концентрация и память',
    'casos.problems.lowEnergy.concerns.2': 'Раздражительность или апатия',
    'casos.problems.lowEnergy.concerns.3': 'Ощущение "работы на автопилоте"',
    ...
    'casos.problems.lowEnergy.approach': 'С помощью кинезиологии для выявления химического или эмоционального дисбаланса, натуральных добавок и техник осознанного движения.',
    ...
    'casos.problems.hormonal.concerns.0': 'Менструальная боль, перепады настроения или нерегулярные месячные',
    'casos.problems.hormonal.concerns.1': 'Предменструальная усталость или бессонница',
    'casos.problems.hormonal.concerns.2': 'Трудности с зачатием',
    'casos.problems.hormonal.concerns.3': 'Симптомы менопаузы или перименопаузы',
    ...
    'casos.problems.hormonal.approach': 'С помощью гормональной кинезиологии, тазового остеобаланса и персонализированной нутрициологической поддержки. мы также работаем над отношениями с собственным телом и женственностью.',
    ...
    'casos.problems.sleep.concerns.0': 'Трудности с засыпанием или ночные пробуждения',
    'casos.problems.sleep.concerns.1': 'Утренняя усталость, напряжение или интенсивные сны',
    'casos.problems.sleep.concerns.2': 'Повторяющиеся мысли перед сном',
    'casos.problems.sleep.concerns.3': 'Легкий или неосвежающий сон',
    ...
    'casos.problems.sleep.approach': 'С помощью фельденкрайза, управляемого дыхания, вагусных техник и кинезиологии для балансировки гормональной системы.',
    ...
    'casos.problems.recovery.concerns.0': 'Остаточная боль или ограничение суставов',
    'casos.problems.recovery.concerns.1': 'Ощущение слабости или дисбаланса',
    'casos.problems.recovery.concerns.2': 'Эмоциональные блокировки, связанные с травмой',
    'casos.problems.recovery.concerns.3': 'Страх движения или реактивность',
    ...
    'casos.problems.recovery.approach': 'С помощью остеобаланса, постурального переобучения и работы с фасциальной системой. мы также сопровождаем уверенность в теле и телесную память.',
    ...
    'prompt.assessment': 'Мягкая и точная диагностика',
