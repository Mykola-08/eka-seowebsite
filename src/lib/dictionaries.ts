...
export const guaranteedTranslations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'personalized.business.plans.enterprise.title': 'Corporatiu / Enterprise',
    'personalized.business.plans.enterprise.desc': 'Molt adaptable. 100% personalitzable per a les teves necessitats úniques. Integració completa de benestar per a grans organitzacions.',
    'personalized.business.plans.enterprise.priceValue': 'Sota Consulta',
    'personalized.business.plans.enterprise.price': 'Preus i serveis a mida',
    'personalized.business.plans.enterprise.feature1': 'Pla de salut corporatiu exclusiu',
    'personalized.business.plans.enterprise.feature2': 'Sessions adaptades a horaris / espais',
    'personalized.business.plans.enterprise.feature3': 'Avaluació i seguiment d\'indicadors',
    'personalized.business.plans.enterprise.feature4': 'Activitats i auditories in-situ',

    'business.massage.title': 'Massatge Corporatiu',
    'business.massage.subtitle': 'Alleujament de tensions a l\'oficina',
    'business.massage.description': 'Eliminar l\'estrès físic i la rigidesa muscular a l\'oficina amb sessions de massatge terapèutic adaptades a professionals.',
    'business.massage.b1': 'Redueix la tensió física',
    'business.massage.b2': 'Millora postura i circulació',
    'business.massage.b3': 'Prevé lesions laborals',
    'business.kinesio.title': 'Kinesiologia per a Executius',
    'business.kinesio.subtitle': 'Alineació i concentració',
    'business.kinesio.description': 'Reequilibra el sistema nerviós, millora l\'ergonomia i augmenta la claredat mental mitjançant kinesiologia aplicada.',
    'business.kinesio.b1': 'Augmenta la concentració mental',
    'business.kinesio.b2': 'Corregeix desequilibris posturals',
    'business.kinesio.b3': 'Restaura el sistema nerviós',
    'business.nutrition.title': 'Nutrició Corporativa',
    'business.nutrition.subtitle': 'Energia sostinguda per a l\'equip',
    'business.nutrition.description': 'Orientació nutricional pràctica dissenyada per mantenir alts nivells d\'energia i millorar la vitalitat de l\'equip.',
    'business.nutrition.b1': 'Optimitza l\'energia diària',
    'business.nutrition.b2': 'Evita la baixada de la tarda',
    'business.nutrition.b3': 'Crea rutines saludables',
    'business.360.title': 'Benestar Executiu 360',
    'business.360.subtitle': 'Auditoria de salut completa',
    'business.360.description': 'Una avaluació física i emocional integral per a líders, assegurant el màxim rendiment i una gestió de salut sostenible.',
    'business.360.b1': 'Avaluació completa',
    'business.360.b2': 'Impulsa el màxim rendiment',
    'business.360.b3': 'Pla d\'acció a llarg termini',
    ...
    'hero.trust.experience': '15+ Anys d\'Experiència',
    ...
    'how.step2.title': '2. Treball Personalitzat',
    ...
    // Service page keys
    'services.howItWorks': 'Com funciona',
    'services.step1.title': 'Consulta inicial',
    'services.step1.description': 'Avaluem el teu estat, historial i objectius per dissenyar un pla personalitzat.',
    'services.step2.title': 'Pla individualitzat',
    'services.step2.description': 'Creem un pla de sessions dissenyat específicament per a les teves necessitats i el teu ritme de vida.',
    'services.step3.title': 'Progrés i suport',
    'services.step3.description': 'Fem un seguiment regular del teu progrés i ajustem el pla quan cal.',
    'services.stats.clients': 'Clients',
    'services.stats.years': 'Anys d\'experiència',
    'services.stats.satisfaction': 'Satisfacció',
    'services.stats.sessions': 'Sessions',
    'services.reviews.title': 'Opinions dels clients',
    'services.reviews.subtitle': 'Resultats reals de persones reals',
    'services.techniques.title': 'Les nostres tècniques',
    'services.techniques.subtitle': 'Enfocaments basats en evidència per obtenir resultats',
    'services.pricing.subtitle': 'Preus transparents sense comissions ocultes',
    'services.benefits.title': 'Beneficis',
    'services.benefits.subtitle': 'Per què funciona',
    'services.cta.title': 'Preparat per començar?',
    'services.cta.subtitle': 'Reserva la teva consulta inicial avui',
    'services.cta.button': 'Reservar cita',
    'massage.page.benefitsTitle': 'Beneficis del massatge',
    'massage.page.benefitsSubtitle': 'Beneficis provats científicament del massatge terapèutic',
    'massage.page.durationsTitle': 'Opcions de durada',
    'massage.page.durationsSubtitle': 'Tria el temps que s\'adapti a la teva agenda',
    'massage.page.duration60': '60 minuts',
    'massage.page.duration90': '90 minuts',
    'massage.page.duration120': '120 minuts',
    'massage.page.testimonialsTitle': 'Opinions sobre massatge',
    'massage.bento.title': 'Massatge terapèutic',
    'massage.bento.subtitle': 'Alleujar el dolor · Recuperació · Relaxació',
    'massage.techniques.deepTissue': 'Teixits profunds',
    'massage.techniques.deepTissue.desc': 'Treball en les capes musculars més profundes',
    'massage.techniques.deepTissue.details': 'Allibera la tensió crònica i restaura la mobilitat',
    'massage.techniques.recovery': 'Recuperació',
    'massage.techniques.recovery.desc': 'Accelera la recuperació post-esforç',
    'massage.techniques.recovery.details': 'Redueix el dolor muscular i accelera la cicatrització',
    'massage.techniques.relaxation': 'Relaxació',
    'massage.techniques.relaxation.desc': 'Alliberament profund de l\'estrès',
    'massage.techniques.relaxation.details': 'Redueix el nivell d\'estrès i millora el son',
    'massage.testimonial.1.text': 'Després de diverses sessions, el dolor d\'esquena ha disminuït notablement.',
    'massage.testimonial.2.text': 'El millor massatge terapèutic que he rebut mai.',
    'massage.testimonial.3.text': 'Vaig notar una gran diferència en la mobilitat des de la primera sessió.',
    'massage.testimonial.4.text': 'El recomano a tothom que pateixi tensió muscular crònica.',
    'kinesiology.page.benefitsTitle': 'Beneficis de la kinesiologia',
    'kinesiology.page.benefitsSubtitle': 'Un enfocament holístic per a la salut del moviment',
    'kinesiology.testimonial.1.text': 'La kinesiologia m\'ha ajudat a entendre com moure\'m correctament.',
    'kinesiology.testimonial.2.text': 'Els meus dolors crònics han millorat molt gràcies a la kinesiologia.',
    'kinesiology.testimonial.3.text': 'Un progrés increïble en la postura en poques sessions.',
    'kinesiology.testimonial.4.text': 'Finalment sento el meu cos i entenc com funciona.',
    'kinesiology.benefits.posture': 'Millora de la postura',
    'kinesiology.benefits.stress': 'Reducció de l\'estrès',
    'kinesiology.benefits.energy': 'Més energia',
    'kinesiologia.bento.structural.desc': 'Corregim el desequilibri estructural per al moviment òptim',
    'kinesiologia.bento.posture.desc': 'Millorem la postura i eliminem el malestar',
    'kinesiologia.bento.stress.desc': 'Reduïm la tensió física i emocional',
    'kinesiologia.bento.energy.desc': 'Restaurem els patrons d\'energia del cos',
    'kinesiologia.page.durationsTitle': 'Opcions de durada',
    'kinesiologia.page.durationsSubtitle': 'Tria el format adequat',
    'kinesiologia.page.duration60': '60 minuts',
    'kinesiologia.page.duration90': '90 minuts',
    'nutrition.page.benefitsTitle': 'Beneficis de la nutrició',
    'nutrition.page.benefitsSubtitle': 'Un enfocament basat en evidència per a la nutrició',
    'nutrition.testimonial.1.text': 'Finalment he trobat un enfocament sostenible per menjar bé.',
    'nutrition.testimonial.2.text': 'He perdut 8 kg en 3 mesos i em sento fantàstica.',
    'nutrition.testimonial.3.text': 'Les consultories de nutrició han canviat la meva relació amb el menjar.',
    'nutrition.testimonial.4.text': 'Més energia, millor son i ment clara — gràcies a la nutrició.',
    'nutrition.benefits.habits': 'Hàbits saludables',
    'nutrition.benefits.habits.details': 'Formem hàbits alimentaris sostenibles a llarg termini',
    'nutrition.benefits.weight': 'Control del pes',
    'nutrition.benefits.weight.details': 'Assolim i mantenim un pes saludable sense dietes estrictes',
    'nutrition.benefits.prevention': 'Prevenció',
    'nutrition.benefits.prevention.details': 'Reduïm el risc de malalties cròniques amb l\'alimentació',
    'nutrition.benefits.knowledge.details': 'Comprensió profunda de com el menjar afecta el teu cos',
    'nutrition.session.first.name': 'Consulta inicial',
    'nutrition.session.first.description': 'Avaluació completa de la nutrició i creació d\'un pla individualitzat',
    'nutrition.session.followup.name': 'Sessió de seguiment',
    'nutrition.session.followup.description': 'Seguiment del progrés i ajust del pla nutricional',
  ...
  en: {
    ...
    'personalized.business.plans.enterprise.title': 'Corporate / Enterprise',
    'personalized.business.plans.enterprise.desc': 'Highly adaptable. 100% customizable to your unique needs. Comprehensive wellness integration for large organizations.',
    'personalized.business.plans.enterprise.priceValue': 'On Request',
    'personalized.business.plans.enterprise.price': 'Custom tailored pricing',
    'personalized.business.plans.enterprise.feature1': 'Exclusive corporate health plan',
    'personalized.business.plans.enterprise.feature2': 'Sessions adapted to schedules/spaces',
    'personalized.business.plans.enterprise.feature3': 'KPI evaluation and health tracking',
    'personalized.business.plans.enterprise.feature4': 'On-site therapy & physical audits',

    'business.massage.title': 'Corporate Massage',
    'business.massage.subtitle': 'On-site tension relief',
    'business.massage.description': 'Eliminate physical stress and muscle stiffness in the office with targeted therapeutic massage sessions tailored for professionals.',
    'business.massage.b1': 'Reduces physical tension',
    'business.massage.b2': 'Improves posture & circulation',
    'business.massage.b3': 'Prevents workplace injuries',
    'business.kinesio.title': 'Executive Kinesiology',
    'business.kinesio.subtitle': 'Alignment and focus',
    'business.kinesio.description': 'Rebalance the nervous system, improve ergonomics, and enhance mental clarity through applied kinesiology and somatic movement.',
    'business.kinesio.b1': 'Enhances mental focus',
    'business.kinesio.b2': 'Corrects postural imbalances',
    'business.kinesio.b3': 'Restores nervous system',
    'business.nutrition.title': 'Corporate Nutrition',
    'business.nutrition.subtitle': 'Sustained team energy',
    'business.nutrition.description': 'Practical nutritional guidance designed to maintain high energy levels, avoid afternoon fatigue, and improve team vitality.',
    'business.nutrition.b1': 'Optimizes daily energy',
    'business.nutrition.b2': 'Prevents afternoon slumps',
    'business.nutrition.b3': 'Builds healthy routines',
    'business.360.title': 'Executive 360 Wellbeing',
    'business.360.subtitle': 'Complete health audit',
    'business.360.description': 'A comprehensive physical and emotional assessment for leaders, ensuring peak performance and sustainable health management.',
    'business.360.b1': 'Full health assessment',
    'business.360.b2': 'Drives peak performance',
    'business.360.b3': 'Long-term action plan',
    ...
    // Service page shared keys
    'services.howItWorks': 'How it works',
    'services.howItWorks.subtitle': 'A clear, structured process designed around your needs.',
    'services.step1.title': 'Initial consultation',
    'services.step1.desc': 'We assess your situation, goals, and history in a relaxed conversation.',
    'services.step1.description': 'We assess your situation, goals, and history to design a personalised plan.',
    'services.step2.title': 'Personalised session',
    'services.step2.desc': 'Hands-on work tailored to your body and what it needs that day.',
    'services.step2.description': 'We create a personalised plan of sessions designed around your needs and your pace of life.',
    'services.step3.title': 'Ongoing support',
    'services.step3.desc': 'Follow-up guidance so your progress is sustained between sessions.',
    'services.step3.description': 'We track your progress regularly and adjust the plan as needed.',
    'services.stats.clients': 'Clients helped',
    'services.stats.years': 'Years of experience',
    'services.stats.satisfaction': 'Client satisfaction',
    'services.stats.sessions': 'Sessions delivered',
    'services.reviews.title': 'What clients say',
    'services.reviews.subtitle': 'Real experiences from people who have transformed their wellbeing.',
    'services.techniques.title': 'Techniques used',
    'services.techniques.subtitle': 'An integrative toolkit drawn from the best of manual therapy and neuroscience.',
    'services.faq.title': 'Frequently asked questions',
    'services.pricing.title': 'Session options',
    'services.pricing.subtitle': 'Choose the format that fits your schedule and goals.',
    'services.benefits.title': 'What you gain',
    'services.benefits.subtitle': 'Concrete improvements you will feel from the very first session.',
    'services.cta.title': 'Ready to feel the difference?',
    'services.cta.subtitle': 'Book your first session — no commitment required.',

    // Massage page keys
    'massage.page.benefitsTitle': 'What massage does for you',
    'massage.page.benefitsSubtitle': 'Beyond relaxation — structural change you can feel.',
    'massage.page.durationsTitle': 'Session durations',
    'massage.page.durationsSubtitle': 'Choose the session length that matches your needs.',
    'massage.page.duration60': 'Ideal for targeted relief of a specific area.',
    'massage.page.duration90': 'Our most popular choice for full-body recovery.',
    'massage.page.duration120': 'Deep structural work with complete relaxation.',
    'massage.page.testimonialsTitle': 'Client stories',
    'massage.bento.title': 'Massage modalities',
    'massage.bento.subtitle': 'Each session is tailored — we draw from multiple techniques based on what your body needs.',
    'massage.techniques.deepTissue': 'Deep tissue',
    'massage.techniques.deepTissue.desc': 'Targets chronic tension in deeper muscle layers and connective tissue.',
    'massage.techniques.deepTissue.details': 'Effective for long-standing postural problems, sports-related injuries, and areas of persistent pain.',
    'massage.techniques.recovery': 'Sports & recovery',
    'massage.techniques.recovery.desc': 'Designed for athletes and active people to speed up recuperation.',
    'massage.techniques.recovery.details': 'Improves lymphatic drainage, reduces DOMS, and prepares the body for peak performance.',
    'massage.techniques.relaxation': 'Relaxation & nervous system',
    'massage.techniques.relaxation.desc': 'Activates the parasympathetic response for deep rest and stress release.',
    'massage.techniques.relaxation.details': 'Long, fluid strokes ease mental tension, reduce cortisol, and restore energy.',
    'massage.testimonial.1.text': 'After just two sessions my chronic shoulder pain disappeared. Elena really understands the body.',
    'massage.testimonial.2.text': 'The deep tissue massage was intense but so effective. I finally feel like myself again.',
    'massage.testimonial.3.text': 'I came in exhausted and left feeling completely renewed. Best massage in Barcelona.',
    'massage.testimonial.4.text': 'Professional, precise, and genuinely caring. Elena\'s touch is something else entirely.',

    // Kinesiology page keys
    'kinesiology.page.benefitsTitle': 'How kinesiology helps',
    'kinesiology.page.benefitsSubtitle': 'Working with the whole person — body, movement, and nervous system.',
    'kinesiology.testimonial.1.text': 'Kinesiology revealed blockages I had no idea existed. After four sessions I felt like a different person.',
    'kinesiology.testimonial.2.text': 'The muscle testing was surprisingly accurate — Elena found the exact source of my back pain.',
    'kinesiology.testimonial.3.text': 'My anxiety levels dropped significantly after three sessions. Absolutely recommend.',
    'kinesiology.testimonial.4.text': 'A completely different approach to health that actually works. I was sceptical but now I\'m a convert.',
    'kinesiologia.bento.structural.desc': 'Restores balance between muscle groups for pain-free, efficient movement.',
    'kinesiologia.bento.posture.desc': 'Corrects postural imbalances caused by daily habits, stress, and past injuries.',
    'kinesiologia.bento.stress.desc': 'Identifies and releases emotional stressors held in the body\'s connective tissue.',
    'kinesiologia.bento.energy.desc': 'Optimises energy flow to restore mental clarity and physical vitality.',
    'kinesiologia.page.durationsTitle': 'Session options',
    'kinesiologia.page.durationsSubtitle': 'Both sessions include a full assessment and personalised corrections.',
    'kinesiologia.page.duration60': 'Focused session targeting one specific area or concern.',
    'kinesiologia.page.duration90': 'Comprehensive work covering multiple systems — recommended for first-timers.',
    'kinesiology.benefits.posture': 'Improved posture and structural alignment',
    'kinesiology.benefits.stress': 'Reduced physical and emotional stress',
    'kinesiology.benefits.energy': 'Higher sustained energy levels',

    // Nutrition page keys
    'nutrition.page.benefitsTitle': 'Nutrition that transforms',
    'nutrition.page.benefitsSubtitle': 'Food is information — we use it to optimise every system in your body.',
    'nutrition.testimonial.1.text': 'My digestion improved dramatically within two weeks of following Elena\'s plan.',
    'nutrition.testimonial.2.text': 'The nutritional analysis was eye-opening. I had no idea how much my diet was affecting my energy.',
    'nutrition.testimonial.3.text': 'Finally a nutritionist who considers the whole person, not just calories.',
    'nutrition.testimonial.4.text': 'I lost 8 kg and kept it off — and I don\'t feel deprived at all.',
    'nutrition.benefits.habits': 'Sustainable eating habits you will actually enjoy',
    'nutrition.benefits.habits.details': 'We build protocols around your lifestyle, preferences, and cultural context.',
    'nutrition.benefits.knowledge.details': 'Understand how different foods affect your hormones, gut, and brain.',
    'nutrition.benefits.weight': 'Healthy weight management without restriction',
    'nutrition.benefits.weight.details': 'Balancing macronutrients and micronutrients for natural, lasting results.',
    'nutrition.benefits.prevention': 'Disease prevention through nutritional support',
    'nutrition.benefits.prevention.details': 'Evidence-based strategies to reduce inflammation and support immune function.',
    'nutrition.session.first.name': 'Initial consultation',
    'nutrition.session.first.description': 'Full nutritional assessment, health history review, and personalised plan.',
    'nutrition.session.followup.name': 'Follow-up session',
    'nutrition.session.followup.description': 'Progress review, adjustments, and continued guidance.',
  },
  ...
  es: {
    ...
    'personalized.business.plans.enterprise.title': 'Corporativo / Enterprise',
    'personalized.business.plans.enterprise.desc': 'Altamente adaptable. 100% personalizable para tus necesidades únicas. Integración de bienestar integral para grandes organizaciones.',
    'personalized.business.plans.enterprise.priceValue': 'Bajo Consulta',
    'personalized.business.plans.enterprise.price': 'Precios y servicios a medida',
    'personalized.business.plans.enterprise.feature1': 'Plan de salud corporativo exclusivo',
    'personalized.business.plans.enterprise.feature2': 'Sesiones adaptadas a horarios / espacios',
    'personalized.business.plans.enterprise.feature3': 'Evaluación y seguimiento de KPIs',
    'personalized.business.plans.enterprise.feature4': 'Actividades y auditorías en el lugar',

    'business.massage.title': 'Masaje Corporativo',
    'business.massage.subtitle': 'Alivio de tensiones en la oficina',
    'business.massage.description': 'Elimina el estrés físico y la rigidez muscular en la oficina con sesiones de masaje terapéutico adaptadas a profesionales.',
    'business.massage.b1': 'Reduce la tensión física',
    'business.massage.b2': 'Mejora postura y circulación',
    'business.massage.b3': 'Previene lesiones laborales',
    'business.kinesio.title': 'Kinesiología para Ejecutivos',
    'business.kinesio.subtitle': 'Alineación y concentración',
    'business.kinesio.description': 'Reequilibra el sistema nervioso, mejora la ergonomía y aumenta la claridad mental mediante kinesiología aplicada.',
    'business.kinesio.b1': 'Aumenta el enfoque mental',
    'business.kinesio.b2': 'Corrige desequilibrios posturales',
    'business.kinesio.b3': 'Restaura el sistema nervioso',
    'business.nutrition.title': 'Nutrición Corporativa',
    'business.nutrition.subtitle': 'Energía sostenida para el equipo',
    'business.nutrition.description': 'Orientación nutricional práctica diseñada para mantener altos niveles de energía y mejorar la vitalidad del equipo.',
    'business.nutrition.b1': 'Optimiza la energía diaria',
    'business.nutrition.b2': 'Evita el bajón de la tarde',
    'business.nutrition.b3': 'Crea rutinas saludables',
    'business.360.title': 'Bienestar Ejecutivo 360',
    'business.360.subtitle': 'Auditoría de salud completa',
    'business.360.description': 'Una evaluación física y emocional integral para líderes, asegurando el máximo rendimiento y una gestión de salud sostenible.',
    'business.360.b1': 'Evaluación completa',
    'business.360.b2': 'Impulsa el máximo rendimiento',
    'business.360.b3': 'Plan de acción a largo plazo',
    ...
    'how.step2.title': '2. Trabajo Personalizado',
    ...
    'services.howItWorks.subtitle': 'Un proceso claro y estructurado diseñado alrededor de tus necesidades.',
    'services.step1.title': 'Consulta inicial',
    'services.step1.desc': 'Evaluamos tu situación, objetivos e historial en una conversación relajada.',
    'services.step1.description': 'Evaluamos tu estado, historial y objetivos para diseñar un plan personalizado.',
    'services.step2.title': 'Sesión personalizada',
    'services.step2.desc': 'Trabajo manual adaptado a tu cuerpo y a lo que necesita ese día.',
    'services.step2.description': 'Creamos un plan de sesiones diseñado específicamente para tus necesidades y tu ritmo de vida.',
    'services.step3.title': 'Apoyo continuo',
    'services.step3.desc': 'Orientación de seguimiento para que tu progreso se mantenga entre sesiones.',
    'services.step3.description': 'Hacemos un seguimiento regular de tu progreso y ajustamos el plan cuando es necesario.',
    'services.stats.clients': 'Clientes atendidos',
    'services.stats.years': 'Años de experiencia',
    'services.stats.satisfaction': 'Satisfacción del cliente',
    'services.stats.sessions': 'Sesiones realizadas',
    'services.reviews.title': 'Lo que dicen los clientes',
    'services.reviews.subtitle': 'Experiencias reales de personas que han transformado su bienestar.',
    'services.techniques.title': 'Técnicas utilizadas',
    'services.techniques.subtitle': 'Un conjunto integrador de lo mejor de la terapia manual y la neurociencia.',
    'services.pricing.subtitle': 'Elige el formato que se adapte a tu agenda y tus objetivos.',
    'services.benefits.title': 'Qué ganas',
    'services.benefits.subtitle': 'Mejoras concretas que sentirás desde la primera sesión.',
    'services.cta.title': '¿Lista para sentir la diferencia?',
    'services.cta.subtitle': 'Reserva tu primera sesión — sin compromiso.',
    'massage.page.benefitsTitle': 'Qué hace el masaje por ti',
    'massage.page.benefitsSubtitle': 'Más allá de la relajación — un cambio estructural que se siente.',
    'massage.page.durationsTitle': 'Duraciones de sesión',
    'massage.page.durationsSubtitle': 'Elige la duración que mejor se adapte a tus necesidades.',
    'massage.page.duration60': 'Ideal para aliviar un área específica.',
    'massage.page.duration90': 'La opción más popular para recuperación corporal completa.',
    'massage.page.duration120': 'Trabajo estructural profundo con relajación completa.',
    'massage.page.testimonialsTitle': 'Historias de clientes',
    'massage.bento.title': 'Modalidades de masaje',
    'massage.bento.subtitle': 'Cada sesión es personalizada — combinamos técnicas según lo que necesita tu cuerpo.',
    'massage.techniques.deepTissue': 'Tejido profundo',
    'massage.techniques.deepTissue.desc': 'Trabaja la tensión crónica en capas musculares más profundas y tejido conectivo.',
    'massage.techniques.deepTissue.details': 'Eficaz para problemas posturales crónicos, lesiones deportivas y áreas de dolor persistente.',
    'massage.techniques.recovery': 'Deportes y recuperación',
    'massage.techniques.recovery.desc': 'Diseñado para deportistas y personas activas para acelerar la recuperación.',
    'massage.techniques.recovery.details': 'Mejora el drenaje linfático, reduce las agujetas y prepara el cuerpo para el máximo rendimiento.',
    'massage.techniques.relaxation': 'Relajación y sistema nervioso',
    'massage.techniques.relaxation.desc': 'Activa la respuesta parasimpática para un descanso profundo y liberación del estrés.',
    'massage.techniques.relaxation.details': 'Movimientos largos y fluidos que alivian la tensión mental, reducen el cortisol y restauran la energía.',
    'massage.testimonial.1.text': 'Tras solo dos sesiones mi dolor crónico de hombro desapareció. Elena realmente entiende el cuerpo.',
    'massage.testimonial.2.text': 'El masaje de tejido profundo fue intenso pero tan efectivo. Por fin me siento yo mismo de nuevo.',
    'massage.testimonial.3.text': 'Llegué agotada y salí completamente renovada. El mejor masaje de Barcelona.',
    'massage.testimonial.4.text': 'Profesional, precisa y genuinamente cuidadosa. El tacto de Elena es algo completamente distinto.',
    'kinesiology.page.benefitsTitle': 'Cómo ayuda la kinesiología',
    'kinesiology.page.benefitsSubtitle': 'Trabajando con la persona completa — cuerpo, movimiento y sistema nervioso.',
    'kinesiology.testimonial.1.text': 'La kinesiología reveló bloqueos que no sabía que existían. Después de cuatro sesiones me sentí como una persona diferente.',
    'kinesiology.testimonial.2.text': 'El test muscular fue sorprendentemente preciso — Elena encontró el origen exacto de mi dolor de espalda.',
    'kinesiology.testimonial.3.text': 'Mi nivel de ansiedad bajó significativamente después de tres sesiones. Lo recomiendo absolutamente.',
    'kinesiology.testimonial.4.text': 'Un enfoque completamente diferente de la salud que realmente funciona. Era escéptica pero ahora soy una seguidora.',
    'kinesiologia.bento.structural.desc': 'Restaura el equilibrio entre grupos musculares para un movimiento eficiente y sin dolor.',
    'kinesiologia.bento.posture.desc': 'Corrige desequilibrios posturales causados por hábitos diarios, estrés y lesiones pasadas.',
    'kinesiologia.bento.stress.desc': 'Identifica y libera estresores emocionales retenidos en el tejido conectivo del cuerpo.',
    'kinesiologia.bento.energy.desc': 'Optimiza el flujo de energía para restaurar la claridad mental y la vitalidad física.',
    'kinesiologia.page.durationsTitle': 'Opciones de sesión',
    'kinesiologia.page.durationsSubtitle': 'Ambas sesiones incluyen una evaluación completa y correcciones personalizadas.',
    'kinesiologia.page.duration60': 'Sesión enfocada que trabaja un área o preocupación específica.',
    'kinesiologia.page.duration90': 'Trabajo integral que abarca múltiples sistemas — recomendado para nuevos clientes.',
    'kinesiology.benefits.posture': 'Postura y alineación estructural mejoradas',
    'kinesiology.benefits.stress': 'Reducción del estrés físico y emocional',
    'kinesiology.benefits.energy': 'Niveles de energía sostenidos más altos',
    'nutrition.page.benefitsTitle': 'Nutrición que transforma',
    'nutrition.page.benefitsSubtitle': 'La comida es información — la usamos para optimizar cada sistema de tu cuerpo.',
    'nutrition.testimonial.1.text': 'Mi digestión mejoró dramáticamente en dos semanas siguiendo el plan de Elena.',
    'nutrition.testimonial.2.text': 'El análisis nutricional fue revelador. No sabía cuánto afectaba mi dieta a mi energía.',
    'nutrition.testimonial.3.text': 'Por fin una nutricionista que considera a la persona completa, no solo las calorías.',
    'nutrition.testimonial.4.text': 'Perdí 8 kg y los mantuve — y no me siento privada en absoluto.',
    'nutrition.benefits.habits': 'Hábitos alimenticios sostenibles que realmente disfrutarás',
    'nutrition.benefits.habits.details': 'Construimos protocolos alrededor de tu estilo de vida, preferencias y contexto cultural.',
    'nutrition.benefits.knowledge.details': 'Comprende cómo los diferentes alimentos afectan tus hormonas, intestino y cerebro.',
    'nutrition.benefits.weight': 'Gestión del peso saludable sin restricciones',
    'nutrition.benefits.weight.details': 'Equilibrando macronutrientes y micronutrientes para resultados naturales y duraderos.',
    'nutrition.benefits.prevention': 'Prevención de enfermedades mediante apoyo nutricional',
    'nutrition.benefits.prevention.details': 'Estrategias basadas en evidencia para reducir la inflamación y apoyar la función inmune.',
    'nutrition.session.first.name': 'Consulta inicial',
    'nutrition.session.first.description': 'Evaluación nutricional completa, revisión del historial de salud y plan personalizado.',
    'nutrition.session.followup.name': 'Sesión de seguimiento',
    'nutrition.session.followup.description': 'Revisión del progreso, ajustes y orientación continua.',
  ...
  ru: {
    ...
    'personalized.business.plans.enterprise.title': 'Корпоративный / Enterprise',
    'personalized.business.plans.enterprise.desc': 'Гибкий подход. 100% персонализация под ваши уникальные потребности. Комплексная интеграция программ здоровья для организаций.',
    'personalized.business.plans.enterprise.priceValue': 'По Запросу',
    'personalized.business.plans.enterprise.price': 'Индивидуальные цены и пакеты',
    'personalized.business.plans.enterprise.feature1': 'Эксклюзивный корпоративный план здоровья',
    'personalized.business.plans.enterprise.feature2': 'Адаптация сессий к вашему графику и зонам',
    'personalized.business.plans.enterprise.feature3': 'Оценка и отслеживание показателей здоровья',
    'personalized.business.plans.enterprise.feature4': 'Очные терапии и аудит пространства',

    'business.massage.title': 'Корпоративный Массаж',
    'business.massage.subtitle': 'Снятие напряжения в офисе',
    'business.massage.description': 'Устранение физического стресса и мышечной скованности в офисе с помощью терапевтического массажа для профессионалов.',
    'business.massage.b1': 'Снимает физическое напряжение',
    'business.massage.b2': 'Улучшает осанку и кровообращение',
    'business.massage.b3': 'Предотвращает травмы',
    'business.kinesio.title': 'Кинезиология для Руководителей',
    'business.kinesio.subtitle': 'Баланс и концентрация',
    'business.kinesio.description': 'Восстановление нервной системы, улучшение эргономики и повышение ясности ума с помощью прикладной кинезиологии.',
    'business.kinesio.b1': 'Повышает концентрацию',
    'business.kinesio.b2': 'Корректирует осанку',
    'business.kinesio.b3': 'Восстанавливает нервную систему',
    'business.nutrition.title': 'Корпоративное Питание',
    'business.nutrition.subtitle': 'Энергия для команды',
    'business.nutrition.description': 'Практические рекомендации по питанию для поддержания высокого уровня энергии и предотвращения усталости.',
    'business.nutrition.b1': 'Оптимизирует энергию',
    'business.nutrition.b2': 'Предотвращает усталость',
    'business.nutrition.b3': 'Формирует здоровые привычки',
    'business.360.title': 'Executive 360',
    'business.360.subtitle': 'Полный аудит здоровья',
    'business.360.description': 'Комплексная физическая и эмоциональная оценка для лидеров, обеспечивающая максимальную эффективность и устойчивое здоровье.',
    ...
    'how.step2.title': '2. Индивидуальная работа',
    ...
    // Service page keys
    'services.howItWorks': 'Как это работает',
    'services.step1.title': 'Первичная консультация',
    'services.step1.description': 'Оцениваем ваше состояние, историю болезней и цели, чтобы разработать персональный план.',
    'services.step2.title': 'Индивидуальный план',
    'services.step2.description': 'Создаём персональный план сессий, разработанный с учётом ваших потребностей и образа жизни.',
    'services.step3.title': 'Прогресс и поддержка',
    'services.step3.description': 'Регулярно отслеживаем ваш прогресс и корректируем план по мере необходимости.',
    'services.stats.clients': 'Клиентов',
    'services.stats.years': 'Лет опыта',
    'services.stats.satisfaction': 'Удовлетворённость',
    'services.stats.sessions': 'Сессий',
    'services.reviews.title': 'Отзывы клиентов',
    'services.reviews.subtitle': 'Реальные результаты от реальных людей',
    'services.techniques.title': 'Наши техники',
    'services.techniques.subtitle': 'Научно обоснованные подходы для достижения результатов',
    'services.pricing.subtitle': 'Прозрачные цены без скрытых комиссий',
    'services.benefits.title': 'Преимущества',
    'services.benefits.subtitle': 'Почему это работает',
    'services.cta.title': 'Готовы начать?',
    'services.cta.subtitle': 'Запишитесь на первичную консультацию сегодня',
    'services.cta.button': 'Записаться на приём',
    'massage.page.benefitsTitle': 'Преимущества массажа',
    'massage.page.benefitsSubtitle': 'Научно доказанные преимущества терапевтического массажа',
    'massage.page.durationsTitle': 'Варианты длительности',
    'massage.page.durationsSubtitle': 'Выберите время, подходящее вашему расписанию',
    'massage.page.duration60': '60 минут',
    'massage.page.duration90': '90 минут',
    'massage.page.duration120': '120 минут',
    'massage.page.testimonialsTitle': 'Отзывы о массаже',
    'massage.bento.title': 'Терапевтический массаж',
    'massage.bento.subtitle': 'Снятие боли · Восстановление · Расслабление',
    'massage.techniques.deepTissue': 'Глубокотканный',
    'massage.techniques.deepTissue.desc': 'Работа с глубокими мышечными слоями',
    'massage.techniques.deepTissue.details': 'Снимает хроническое напряжение и восстанавливает подвижность',
    'massage.techniques.recovery': 'Восстановительный',
    'massage.techniques.recovery.desc': 'Ускоряет восстановление после нагрузок',
    'massage.techniques.recovery.details': 'Уменьшает мышечную боль и ускоряет заживление',
    'massage.techniques.relaxation': 'Расслабляющий',
    'massage.techniques.relaxation.desc': 'Глубокое снятие стресса',
    'massage.techniques.relaxation.details': 'Снижает уровень стресса и улучшает сон',
    'massage.testimonial.1.text': 'После нескольких сеансов боль в спине значительно уменьшилась.',
    'massage.testimonial.2.text': 'Лучший терапевтический массаж, который я когда-либо получал.',
    'massage.testimonial.3.text': 'Заметила огромную разницу в подвижности уже после первого сеанса.',
    'massage.testimonial.4.text': 'Рекомендую всем, кто страдает от хронического мышечного напряжения.',
    'kinesiology.page.benefitsTitle': 'Преимущества кинезиологии',
    'kinesiology.page.benefitsSubtitle': 'Целостный подход к здоровью движения',
    'kinesiology.testimonial.1.text': 'Кинезиология помогла мне понять, как правильно двигаться.',
    'kinesiology.testimonial.2.text': 'Мои хронические боли значительно уменьшились благодаря кинезиологии.',
    'kinesiology.testimonial.3.text': 'Невероятный прогресс в осанке всего за несколько сеансов.',
    'kinesiology.testimonial.4.text': 'Наконец-то чувствую своё тело и понимаю, как оно работает.',
    'kinesiology.benefits.posture': 'Улучшение осанки',
    'kinesiology.benefits.stress': 'Снижение стресса',
    'kinesiology.benefits.energy': 'Больше энергии',
    'kinesiologia.bento.structural.desc': 'Исправляем структурный дисбаланс для оптимального движения',
    'kinesiologia.bento.posture.desc': 'Улучшаем осанку и устраняем дискомфорт',
    'kinesiologia.bento.stress.desc': 'Снижаем физическое и эмоциональное напряжение',
    'kinesiologia.bento.energy.desc': 'Восстанавливаем энергетические паттерны тела',
    'kinesiologia.page.durationsTitle': 'Варианты длительности',
    'kinesiologia.page.durationsSubtitle': 'Выберите подходящий формат',
    'kinesiologia.page.duration60': '60 минут',
    'kinesiologia.page.duration90': '90 минут',
    'nutrition.page.benefitsTitle': 'Преимущества нутрициологии',
    'nutrition.page.benefitsSubtitle': 'Научно обоснованный подход к питанию',
    'nutrition.testimonial.1.text': 'Наконец нашла устойчивый подход к питанию, который работает.',
    'nutrition.testimonial.2.text': 'Потеряла 8 кг за 3 месяца и чувствую себя великолепно.',
    'nutrition.testimonial.3.text': 'Консультации по питанию изменили моё отношение к еде.',
    'nutrition.testimonial.4.text': 'Больше энергии, лучший сон и ясный ум — благодаря питанию.',
    'nutrition.benefits.habits': 'Здоровые привычки',
    'nutrition.benefits.habits.details': 'Формируем устойчивые пищевые привычки на долгосрочную перспективу',
    'nutrition.benefits.weight': 'Контроль веса',
    'nutrition.benefits.weight.details': 'Достигаем и поддерживаем здоровый вес без жёстких диет',
    'nutrition.benefits.prevention': 'Профилактика',
    'nutrition.benefits.prevention.details': 'Снижаем риск хронических заболеваний с помощью питания',
    'nutrition.benefits.knowledge.details': 'Глубокое понимание того, как еда влияет на ваше тело',
    'nutrition.session.first.name': 'Первичная консультация',
    'nutrition.session.first.description': 'Полная оценка питания и разработка индивидуального плана',
    'nutrition.session.followup.name': 'Контрольная сессия',
    'nutrition.session.followup.description': 'Отслеживание прогресса и корректировка плана питания',
...
export const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'assessment.processing.label': 'ANALITZANT',
    'assessment.result.recommended.label': 'Recomanat',
    'assessment.result.trust.title': 'Amb la confiança de més de 1500 clients a Barcelona.',
    'assessment.result.join.community': 'UNEIX-TE A LA NOSTRA COMUNITAT',
    'assessment.progress.analysis': 'Anàlisi del progrés',
    'booking.analysis.title': 'Anàlisi de l\'avaluació',
    'booking.analysis.subtitle': 'El teu camí personalitzat està llest',
    'booking.label.intensity': 'Intensitat',
    'booking.label.profile': 'Perfil',
    'booking.label.mood': 'Estat d\'ànim',
    'booking.label.energy': 'Energia',
    'booking.response.time': 'Resposta en < 24h',
    'booking.emergency.prioritize': 'Prioritzar sol·licituds d\'emergència',
    'booking.label.email': 'Correu electrònic',
    'booking.label.location': 'Ubicació',
    'booking.recommended.badge': 'RECOMANAT',
    'stats.experience.label': 'Anys d\'Experiència',
    'stats.clients.label': 'Clients Atesos',
    'stats.personalized.label': 'Personalitzat',
    'stats.rating.label': 'Valoració',
    'vip.table.benefits': 'Beneficis',
    'vip.label.club': 'Club VIP EKA',
    'vip.tier.bronze': 'BRONZE',
    'vip.tier.silver': 'SILVER',
    'vip.tier.gold': 'GOLD',
    'common.mo': '/mes',
    'common.location': 'Ubicació',
    ...
    'hero.subtitle': 'T\'ajudem a sentir-te a gust amb el teu cos una altra vegada. Amb sessions personalitzades i kinesiologia pràctica, trobem la causa real del malestar per retornar-te energia.',
    ...
    'about.description1': 'Amb més de 15 anys de trajectòria, he perfeccionat un mètode que va molt més lluny que les teràpies convencionals. La meva missió és descodificar el llenguatge del teu cos per desbloquejar la seva capacitat innata de regeneració.',
    ...
    // Service: Kinesiology
    'kinesiology.title': 'Kinesiologia integrativa',
    'kinesiology.desc': 'Biofeedback de precisió. Utilitzem el test muscular neurològic per descodificar i corregir desequilibris estructurals, bioquímics i emocionals en el seu origen.',
    'kinesiology.benefit1': 'Anàlisi causal',
    ...
    'problems.badge': 'Benestar i resolució',
    'problems.title': 'Identifica els teus desequilibris',
    'problems.subtitle': "Abordatge integral de les situacions més comunes mitjançant protocols d'integració somàtica.",

    // Problem: Back Pain
    'problems.backpain.title': 'Tensió vertebral crònica',
    'problems.backpain.desc': 'Malestar estructural persistent que limita la funcionalitat i el descans.',
    'problems.backpain.solution': 'El nostre enfocament',
    ...
    'problems.stress.solution': 'El nostre enfocament',
    ...
    'problems.fatigue.solution': 'El nostre enfocament',
    ...
    'problems.injuries.solution': 'El nostre enfocament',
    ...
    'casos.problems.backPain.treatment': "Treball integral: massatge terapèutic profund, alliberament miofascial, kinesiologia per identificar l'origen (estructural, químic o emocional) i reeducació postural (Mètode Feldenkrais).",
    ...
    'seo.adults.description': "Sessions personalitzades per a adults: gestió de l'estrès, dolor crònic i millora de la qualitat de vida. Massatge, kinesiologia i més.",
    ...
    'discovery.time.standard.desc': 'Sessió profunda i integrativa.',
    ...
    'discovery.recommendation.integrative.benefit1': 'Enfocament integral',
    ...
    'personalizedServices.main.list1': 'Enfocament genèric',
    ...
    'booking.email.title': 'Envia\'ns un Correu',
    'booking.email.description': 'Prefereixes escriure? Envia\'ns un correu i et respondrem en 24 hores.',
    'booking.email.button': 'Enviar Correu',
    'booking.form.alternative': 'O demana contacte a través del formulari',
    'booking.form.show': 'Mostrar Formulari de Contacte',
    ...
    'faq.q1.answer': 'Les sessions solen durar entre 60 i 90 minuts, depenent del servei escollit i les teves necessitats específiques.',
    'faq.q2.question': 'Necessito experiència prèvia?',
    'faq.q2.answer': "No cal cap experiència prèvia. Totes les nostres sessions s'adapten al teu nivell i necessitats específiques.",
    ...
    'onboarding.approaches.kinesiology': 'Kinesiologia integrativa',
    'onboarding.approaches.feldenkrais': 'Mètode Feldenkrais',
    'onboarding.approaches.energy': 'Equilibri bioenergètic',
    'onboarding.approaches.open': 'Obert a recomanacions personalitzades',
    ...
    'recommendations.kinesiology.description': "Kinesiologia integrativa per a la regulació del sistema nerviós i la identificació precisa de l'origen del desequilibri.",
    ...
    'personalized.artists.services.title': 'Com treballem',
    ...
    'common.healthDisclaimerTitle': 'Avís de Salut',
    'common.consultDoctor': 'Consulteu sempre el vostre metge abans de prendre qualsevol decisió de salut.',
    'common.back': 'Enrere',
    ...
    // Layout footer
    'footer.legal': 'Legal',
    'footer.disclaimer': 'Avís de Salut',
    ...
    'casos.frequentCasesSubtitle': 'Situacions comunes',
    ...
    'casos.discoverIdeal': 'Descobreix el teu camí',
    'casos.bookSession': 'Reservar sessió',
    'casos.seeDetails': 'Veure detalls',
    'casos.section.badge': 'Casos reals',
    'casos.section.title': 'Identifica el teu desequilibri',
    ...
    'casos.problems.digestive.description': 'Malestar abdominal i inflor.',
    ...
    // Legal pages
    'legal.date': '15 de novembre de 2025',
    'legal.cookie.toc.notice': 'Avís de Salut',
    'legal.cookie.toc.what': 'Què Són les Cookies',
    'legal.cookie.toc.types': 'Tipus que Usem',
    'legal.cookie.toc.manage': 'Gestionar Cookies',
    'legal.wellness.notice.title': 'Avís de Benestar Complementari',
    'legal.wellness.notice.body': 'Aquest lloc web presenta serveis de benestar complementari i alternatiu. Res en aquest lloc constitueix assessorament mèdic, diagnòstic o tractament.',
    'legal.wellness.notice.warning': 'Consulteu sempre el vostre metge abans de prendre qualsevol decisió de salut.',
    'legal.wellness.notice.link': 'Avís Legal Complet →',
    'legal.cookie.what.title': '1. Què Són les Cookies (RGPD Art. 4(11))',
    'legal.cookie.what.body': 'Les cookies són petits arxius de text col·locats al vostre dispositiu quan visiteu el nostre lloc web. Ens ajuden a proporcionar una experiència funcional, segura i millorada.',
    'legal.cookie.types.title': '2. Cookies que Usem',
    'legal.cookie.essential.title': 'Cookies Essencials',
    'legal.cookie.essential.desc': 'Necessàries per al funcionament del lloc web. No es poden desactivar. S\'utilitzen per a la navegació, la seguretat i els fluxos de reserva.',
    'legal.cookie.analytics.title': 'Cookies Analítiques',
    'legal.cookie.analytics.desc': 'Ens ajuden a entendre com els visitants utilitzen el nostre lloc (p. ex., Google Analytics). S\'utilitzen de forma anònima per millorar el contingut i el rendiment.',
    'legal.cookie.preference.title': 'Cookies de Preferències',
    'legal.cookie.preference.desc': 'Recorden la configuració d\'idioma i de regió perquè no calgui tornar a seleccionar-la en cada visita.',
    'legal.cookie.alwaysActive': 'Sempre Actives',
    'legal.cookie.optional': 'Opcional',
    'legal.cookie.manage.title': '3. Gestionar les Cookies',
    'legal.cookie.manage.body1': 'Podeu gestionar, restringir o eliminar les cookies en qualsevol moment a través de la configuració del navegador. Desactivar les cookies no essencials no afectarà la funcionalitat bàsica del lloc web.',
    'legal.cookie.manage.body2': 'Podeu retirar el consentiment atorgat a través del nostre bàner en qualsevol moment eliminant les cookies del navegador i tornant a visitar el lloc.',
    'legal.cookie.browser.title': 'Configuració de Cookies del Navegador',
    'legal.cookie.browser.chrome': 'Chrome: Configuració → Privadesa → Cookies',
    'legal.cookie.browser.firefox': 'Firefox: Opcions → Privadesa → Cookies',
    'legal.cookie.browser.safari': 'Safari: Preferències → Privadesa',
    'legal.cookie.browser.edge': 'Edge: Configuració → Privadesa → Cookies',
    'legal.cookie.contact.prefix': 'Per a preguntes, contacteu:',
    'legal.gdpr.cookie': 'Aquesta Política de Cookies compleix el Reglament (UE) 2016/679 (RGPD).',
    'legal.privacy.toc.disclaimer': 'Avís de Salut',
    'legal.privacy.toc.controller': 'Responsable del Tractament',
    'legal.privacy.toc.data': 'Dades que Recollim',
    'legal.privacy.toc.basis': 'Base Legal',
    'legal.privacy.toc.rights': 'Els Vostres Drets',
    'legal.privacy.toc.contact': 'Contacte',
    'legal.privacy.warning.body': 'EKA Balance ofereix serveis de benestar complementari i alternatiu. Els nostres serveis no són diagnòstic mèdic, tractament mèdic ni substitut d\'atenció sanitària professional.',
    'legal.privacy.warning.stopMedication': 'No deixeu de prendre medicaments prescrits ni de seguir tractaments mèdics basant-vos en informació d\'aquest lloc web.',
    'legal.privacy.warning.emergency': 'Si esteu vivint una emergència mèdica, truqueu immediatament als serveis d\'emergències (112 a Espanya).',
    'legal.privacy.warning.noResponsibility': 'EKA Balance no assumeix cap responsabilitat pels resultats de salut derivats d\'accions preses sense consultar un metge autoritzat.',
    'legal.privacy.warning.link': 'Consulteu el nostre Avís Legal Complet per a tots els detalls.',
    'legal.privacy.dpo.title': 'Delegat de Protecció de Dades (DPD)',
    'legal.privacy.data.title': '1. Dades que Recollim',
    'legal.privacy.data.intro': 'Recollim dades personals necessàries per prestar els nostres serveis de benestar, incloent:',
    'legal.privacy.data.personal.title': 'Identificació Personal',
    'legal.privacy.data.personal.fullName': 'Nom complet',
    'legal.privacy.data.personal.email': 'Adreça de correu electrònic',
    'legal.privacy.data.personal.phone': 'Número de telèfon',
    'legal.privacy.data.personal.address': 'Adreça postal',
    'legal.privacy.data.personal.dob': 'Data de naixement',
    'legal.privacy.data.wellness.title': 'Dades de Benestar i Salut',
    'legal.privacy.data.wellness.item1': 'Notes sobre condició física i benestar',
    'legal.privacy.data.wellness.item2': 'Indicadors de dolor o malestar',
    'legal.privacy.data.wellness.item3': 'Historial de sessions i preferències',
    'legal.privacy.data.wellness.item4': 'Notes de benestar emocional (amb consentiment)',
    'legal.privacy.basis.title': '2. Base Legal del Tractament (RGPD Art. 6)',
    'legal.privacy.basis.consent.title': 'Consentiment (Art. 6(1)(a))',
    'legal.privacy.basis.consent.item1': 'Comunicacions de màrqueting',
    'legal.privacy.basis.consent.item2': 'Cookies no essencials',
    'legal.privacy.basis.consent.item3': 'Dades de benestar amb consentiment explícit',
    'legal.privacy.basis.contract.title': 'Necessitat Contractual',
    'legal.privacy.basis.contract.item1': 'Prestació dels serveis reservats',
    'legal.privacy.basis.contract.item2': 'Processament de pagaments',
    'legal.privacy.basis.contract.item3': 'Atenció al client',
    'legal.privacy.basis.legal.title': 'Obligacions Legals',
    'legal.privacy.basis.legal.item1': 'Fiscalitat i comptabilitat',
    'legal.privacy.basis.legal.item2': 'Requisits de salut i seguretat',
    'legal.privacy.basis.legal.item3': 'Normes de conservació de dades',
    'legal.privacy.basis.interest.title': 'Interessos Legítims',
    'legal.privacy.basis.interest.item1': 'Millora del servei',
    'legal.privacy.basis.interest.item2': 'Prevenció del frau',
    'legal.privacy.basis.interest.item3': 'Anàlisi estadística',
    'legal.privacy.rights.title': '3. Els Vostres Drets sota el RGPD (Arts. 12–22)',
    'legal.privacy.right.access': 'Accés (Art. 15)',
    'legal.privacy.right.access.desc': 'Sol·liciteu una còpia de totes les dades personals que tenim sobre vosaltres. Responem en 30 dies.',
    'legal.privacy.right.erasure': 'Supressió (Art. 17)',
    'legal.privacy.right.erasure.desc': 'Sol·liciteu l\'eliminació de les vostres dades quan ja no hi hagi cap base legal per conservar-les.',
    'legal.privacy.right.rectification': 'Rectificació (Art. 16)',
    'legal.privacy.right.rectification.desc': 'Sol·liciteu la correcció de dades personals inexactes o incompletes.',
    'legal.privacy.right.portability': 'Portabilitat (Art. 20)',
    'legal.privacy.right.portability.desc': 'Rebeu les vostres dades en un format estructurat i llegible per màquina.',
    'legal.privacy.right.objection': 'Oposició (Art. 21)',
    'legal.privacy.right.objection.desc': 'Oposeu-vos al tractament basat en interessos legítims o amb fins de màrqueting directe.',
    'legal.privacy.rights.exercise': 'Per exercir els vostres drets, contacteu:',
    'legal.privacy.contact.title': 'Contacte i Autoritat de Supervisió',
    'legal.privacy.contact.dpo': 'Contacte DPD',
    'legal.privacy.contact.authority.title': 'Autoritat de Supervisió',
    'legal.privacy.contact.authority.name': 'Agencia Española de Protección de Datos (AEPD)',
    'legal.gdpr.privacy': 'Aquesta Política de Privacitat compleix el Reglament (UE) 2016/679 (RGPD).',
    'legal.terms.toc.disclaimer': 'Avís de Salut',
    'legal.terms.toc.nature': 'Naturalesa dels Serveis',
    'legal.terms.toc.acceptance': 'Acceptació',
    'legal.terms.toc.eligibility': 'Elegibilitat',
    'legal.terms.toc.limitations': 'Limitacions',
    'legal.terms.toc.contact': 'Contacte',
    'legal.terms.warning.body': 'EKA Balance proporciona serveis de benestar complementari i alternatiu. Aquests serveis no són tractament mèdic, diagnòstic ni substitut d\'atenció sanitària professional.',
    'legal.terms.warning.stopMedication': 'No deixeu de prendre, reduïu ni canvieu els medicaments prescrits ni el tractament mèdic basant-vos en cap contingut o sessió rebuda a EKA Balance.',
    'legal.terms.warning.variability': 'Els resultats de la teràpia complementària varien per persona. No es garanteix cap resultat específic.',
    'legal.terms.warning.noLiability': 'EKA Balance no accepta cap responsabilitat per decisions de salut preses sense consultar un metge autoritzat.',
    'legal.terms.warning.emergency': 'En qualsevol emergència mèdica, truqueu immediatament al 112.',
    'legal.terms.warning.link': 'Llegiu l\'Avís Legal Complet.',
    'legal.terms.nature.title': '1. Naturalesa dels Serveis',
    'legal.terms.nature.intro': 'EKA Balance proporciona serveis de benestar complementari i integratiu, incloent massatge terapèutic, kinesiologia, orientació nutricional, educació somàtica i treball corporal. Aquests serveis són:',
    'legal.terms.nature.item1': 'De naturalesa de suport i educativa',
    'legal.terms.nature.item2': 'Complementaris — no atenció primària ni mèdica',
    'legal.terms.nature.item3': 'No destinats a diagnosticar, tractar, curar o prevenir cap malaltia o condició',
    'legal.terms.nature.item4': 'No substituts d\'atenció mèdica, psiquiàtrica o de salut mental professional',
    'legal.terms.nature.important': 'Continueu seguint les recomanacions del vostre metge. Els serveis d\'EKA Balance funcionen conjuntament amb la medicina convencional, no en substitució.',
    'legal.terms.acceptance.title': '2. Acceptació dels Termes',
    'legal.terms.acceptance.body': 'En reservar, accedir o utilitzar els serveis d\'EKA Balance, confirmeu que heu llegit, entès i acceptat aquests Termes i la nostra Política de Privacitat.',
    'legal.terms.acceptance.intro': 'El vostre ús constitueix consentiment explícit a:',
    'legal.terms.acceptance.item1': 'La recollida i el tractament de dades personals tal com es descriu a la nostra Política de Privacitat',
    'legal.terms.acceptance.item2': 'L\'ús de cookies tal com es descriu a la nostra Política de Cookies',
    'legal.terms.acceptance.item3': 'La naturalesa dels serveis de benestar complementari tal com es descriu en aquests Termes',
    'legal.terms.eligibility.title': '3. Elegibilitat',
    'legal.terms.eligibility.intro': 'En utilitzar els nostres serveis, confirmeu que:',
    'legal.terms.eligibility.item1': 'Teniu almenys 18 anys, o disposeu de consentiment parental si teniu entre 16–18 anys',
    'legal.terms.eligibility.item2': 'Teniu capacitat legal per celebrar acords vinculants',
    'legal.terms.eligibility.item3': 'Proporcionareu informació precisa i completa',
    'legal.terms.eligibility.item4': 'Complireu totes les lleis aplicables',
    'legal.terms.limitations.title': '4. Limitació de Responsabilitat',
    'legal.terms.limitations.intro': 'EKA Balance i els seus terapeutes no són responsables de cap resultat de salut, directe o indirecte, derivat de:',
    'legal.terms.limitations.item1': 'Decisions preses sense consultar un metge autoritzat',
    'legal.terms.limitations.item2': 'Aturar o modificar el tractament mèdic prescrit',
    'legal.terms.limitations.item3': 'Qualsevol condició mèdica preexistent no revelada abans de les sessions',
    'legal.terms.limitations.item4': 'Variació individual en la resposta a la teràpia complementària',
    'legal.terms.contact.title': '5. Contacte',
    'legal.terms.contact.legal': 'Consultes Legals',
    'legal.terms.contact.dpo': 'Delegat de Protecció de Dades',
    'legal.gdpr.terms': 'Aquests Termes compleixen la legislació aplicable de protecció del consumidor i de protecció de dades de la UE i Espanya.',
    'legal.disclaimer.subtitle': 'Llegiu-ho abans de reservar o usar qualsevol servei d\'EKA Balance',
    'legal.disclaimer.what.title': 'Què És EKA Balance',
    'legal.disclaimer.what.body1': 'EKA Balance ofereix serveis de benestar complementari i alternatiu, incloent massatge holístic, coaching de moviment, orientació nutricional, treball corporal somàtic i sessions de benestar integratiu.',
    'legal.disclaimer.what.body2': 'Aquests serveis estan dissenyats per donar suport al vostre benestar general conjuntament amb — no en comptes de — la medicina convencional. Els nostres terapeutes són professionals de benestar format, no metges autoritzats.',
    'legal.disclaimer.not.title': 'Què No És EKA Balance',
    'legal.disclaimer.not.item1': 'EKA Balance no proporciona diagnòstic mèdic de cap malaltia, trastorn o condició.',
    'legal.disclaimer.not.item2': 'EKA Balance no proporciona tractament mèdic, prescripció ni cura.',
    'legal.disclaimer.not.item3': 'Les sessions d\'EKA Balance no substitueixen les consultes amb el vostre metge, especialista o professional de salut mental autoritzat.',
    'legal.disclaimer.not.item4': 'Cap contingut d\'aquest lloc web constitueix assessorament mèdic.',
    'legal.disclaimer.not.item5': 'EKA Balance no afirma tractar, curar, prevenir ni mitigar cap condició mèdica.',
    'legal.disclaimer.consult.title': 'Consulteu Sempre el Vostre Metge Primer',
    'legal.disclaimer.consult.intro': 'Abans de començar qualsevol servei de benestar complementari o alternatiu, consulteu el vostre metge autoritzat, especialment si:',
    'legal.disclaimer.consult.item1': 'Teniu una condició de salut preexistent o una preocupació de benestar continuada',
    'legal.disclaimer.consult.item2': 'Esteu prenent medicació prescrita',
    'legal.disclaimer.consult.item3': 'Esteu embarassada o en període de lactància',
    'legal.disclaimer.consult.item4': 'Heu tingut recentment una operació o un procediment mèdic',
    'legal.disclaimer.consult.item5': 'Experimenteu preocupacions físiques persistents, agudes o inexplicades',
    'legal.disclaimer.consult.item6': 'Esteu sota la cura d\'un especialista (cardiòleg, oncòleg, psiquiatra, etc.)',
    'legal.disclaimer.consult.warning': 'No atureu, reduïu ni modifiqueu cap pla d\'atenció sanitària prescrit basant-vos en res rebut o llegit a EKA Balance.',
    'legal.disclaimer.liability.title': 'Limitació de Responsabilitat',
    'legal.disclaimer.liability.intro': 'EKA Balance i els seus terapeutes no accepten cap responsabilitat mèdica ni legal per qualsevol resultat de salut — positiu o negatiu — derivat de:',
    'legal.disclaimer.liability.item1': 'Decisions preses sense consultar prèviament un metge autoritzat',
    'legal.disclaimer.liability.item2': 'Qualsevol modificació o suspensió de l\'atenció mèdica prescrita',
    'legal.disclaimer.liability.item3': 'Variació individual en la resposta als serveis complementaris',
    'legal.disclaimer.liability.item4': 'Condicions preexistents no revelades abans de les sessions',
    'legal.disclaimer.liability.vary': 'Els resultats dels serveis de benestar complementari varien de persona a persona. No es garanteix cap resultat específic.',
    'legal.disclaimer.emergency.title': 'Emergència Mèdica',
    'legal.disclaimer.emergency.call': 'Si esteu vivint una emergència mèdica, truqueu immediatament als serveis d\'emergències.',
    'legal.disclaimer.emergency.spain': 'Espanya (UE)',
    'legal.disclaimer.emergency.general': 'Emergència General',
    'legal.disclaimer.emergency.crisis': 'Línia de Crisi (ES)',
    'legal.disclaimer.footer.law': 'Aquest avís es proporciona de conformitat amb la llei espanyola de protecció del consumidor (Reial Decret Legislatiu 1/2007), la Directiva UE 2011/83/UE sobre drets dels consumidors i els estàndards professionals aplicables.',
    'legal.disclaimer.footer.confirm': 'En reservar o usar qualsevol servei d\'EKA Balance, confirmeu que heu llegit i entès aquest avís.',
    'legal.disclaimer.links.terms': 'Condicions de Servei',
    'legal.disclaimer.links.privacy': 'Política de Privacitat',
    'legal.disclaimer.links.booking': 'Contacta\'ns i Reserva',
  },
  ...
  en: {
    ...
    'assessment.processing.label': 'ANALYZING',
    'assessment.result.recommended.label': 'Recommended',
    'assessment.result.trust.title': 'Trusted by 1500+ clients seeking somatic relief in Barcelona.',
    'assessment.result.join.community': 'JOIN OUR COMMUNITY',
    'assessment.progress.analysis': 'Progress Analysis',
    'booking.analysis.title': 'Assessment Analysis',
    'booking.analysis.subtitle': 'Your personalized path is ready',
    'booking.label.intensity': 'Intensity',
    'booking.label.profile': 'Profile',
    'booking.label.mood': 'Mood',
    'booking.label.energy': 'Energy',
    'booking.response.time': 'Response in < 24h',
    'booking.emergency.prioritize': 'Prioritize Emergency Requests',
    'booking.label.email': 'Email Address',
    'booking.label.location': 'Location',
    'booking.recommended.badge': 'RECOMMENDED',
    'stats.experience.label': 'Years Experience',
    'stats.clients.label': 'Clients Helped',
    'stats.personalized.label': 'Personalized',
    'stats.rating.label': 'Client Rating',
    'vip.table.benefits': 'Benefits',
    'nav.home': 'Home',
    ...
    'elena.approach.desc': 'I believe that your body, mind, and emotions are not separate parts, but a single, living system. My approach goes beyond addressing surface discomfort—I seek the root cause to help your body rediscover its natural ability to heal and self-regulate. By integrating advanced bodywork with nervous system re-education—using techniques like Movement Lesson, JKA, ChildSpace, Feldenkrais, and Biodynamics—I offer a gentle yet profound pathway to release deep tension, rewire old patterns, and restore the joy of effortless movement.',
    ...
    'hero.subtitle': 'Feel at ease in your body again. Through somatic therapy and kinesiology we help you release long-held tension, restore ease of movement, and rediscover your natural energy.',
    'hero.firstTime': 'First time here?',
    ...
    'services.revision360.subtitle': 'Comprehensive Functional Assessment',
    ...
    'elena.description1': 'I specialize in therapeutic massage, kinesiology, and somatic integration. My work is built on a simple belief: real healing happens when you truly listen to the whole person.',
    ...
    'casos.description': "Pain, fatigue, or tension are often just the surface—signals from a body seeking balance. At EKA Balance, we don't just quiet these signals; we listen to what they mean. By addressing the root cause, we've helped hundreds of people transform their relationship with their bodies. Explore these common journeys to see what's possible for you.",
    ...
    'booking.email.title': 'Send us an Email',
    'booking.email.description': 'Prefer to write? Drop us an email and we will get back to you within 24 hours.',
    'booking.email.button': 'Mail Us',
    'booking.form.alternative': 'Or request contact through our form',
    'booking.form.show': 'Show Contact Form',
    ...
    'booking.form.objectivePlaceholder': 'Briefly describe what brings you here...',
    ...
    'musicians.results.title': 'What you will gain',
    'musicians.results.point1': 'Relief from pain and recovery of sensitivity',
    ...
    'musicians.plan1.name': 'Initial evaluation',
    'musicians.plan1.desc': 'Initial assessment and first relief session',
    ...
    'musicians.plan1.result': 'Full assessment and noticeable relief',
    ...
    'personalized.musicians.faq.q1': 'Can this help with tendonitis or carpal tunnel issues?',
    ...
    'personalized.musicians.faq.q2': 'Will sessions affect my playing technique?',
    ...
    'personalized.musicians.testimonial.quote': 'After working with Elena my focal dystonia improved significantly and I was able to return to the concert stage with full confidence.',
    ...
    'personalized.artists.services.title': 'How we work',
    ...
    'common.healthDisclaimerTitle': 'Important Health Disclaimer',
    'common.consultDoctor': 'Always consult your doctor before making any health decision.',
    'common.back': 'Back',
    ...
    // Layout footer
    'footer.legal': 'Legal',
    'footer.disclaimer': 'Wellness Disclaimer',
    ...
    'discovery.emotional.focus_physical.desc': "I'm not sure, let's just focus on the body.",
    ...
    'vip.service.health.description': "We don't just support; we track. Regular assessments ensure your physical health is always progressing.",
    ...
    'about.description1': 'With over 15 years of professional practice, I have refined a method that truly listens to the body. My mission is to help you reconnect with yourself and restore your natural capacity for wellbeing.',
    ...
    'kinesiology.desc': 'Precision biofeedback. We use neurological muscle testing to decode and correct structural, biochemical, and emotional imbalances.',
    'kinesiology.benefit1': 'Root cause identification',
    ...
    // Problems
    'problems.badge': 'Wellbeing & resolution',
    'problems.title': 'Identify your imbalances',
    'problems.subtitle': 'An integrative approach to common challenges through somatic integration.',
    'problems.backpain.title': 'Chronic back tension',
    ...
    // Legal pages
    'legal.date': '15 November 2025',
    'legal.cookie.toc.notice': 'Health Notice',
    'legal.cookie.toc.what': 'What Are Cookies',
    'legal.cookie.toc.types': 'Types We Use',
    'legal.cookie.toc.manage': 'Manage Cookies',
    'legal.wellness.notice.title': 'Complementary Wellness Notice',
    'legal.wellness.notice.body': 'This website presents complementary and alternative wellness services. Nothing on this site constitutes medical advice, diagnosis, or treatment.',
    'legal.wellness.notice.warning': 'Always consult your doctor before making any health decisions.',
    'legal.wellness.notice.link': 'Full Legal Disclaimer →',
    'legal.cookie.what.title': '1. What Are Cookies (GDPR Art. 4(11))',
    'legal.cookie.what.body': 'Cookies are small text files placed on your device when you visit our website. They help us provide a functional, secure, and improved experience.',
    'legal.cookie.types.title': '2. Cookies We Use',
    'legal.cookie.essential.title': 'Essential Cookies',
    'legal.cookie.essential.desc': 'Required for the website to function. Cannot be disabled. Used for navigation, security, and booking flows.',
    'legal.cookie.analytics.title': 'Analytics Cookies',
    'legal.cookie.analytics.desc': 'Help us understand how visitors use our site (e.g., Google Analytics). Used anonymously to improve content and performance.',
    'legal.cookie.preference.title': 'Preference Cookies',
    'legal.cookie.preference.desc': 'Remember your language and region settings so you do not need to reselect them on each visit.',
    'legal.cookie.alwaysActive': 'Always Active',
    'legal.cookie.optional': 'Optional',
    'legal.cookie.manage.title': '3. Managing Cookies',
    'legal.cookie.manage.body1': 'You can manage, restrict, or delete cookies at any time through your browser settings. Disabling non-essential cookies will not affect the core functionality of the website.',
    'legal.cookie.manage.body2': 'You may withdraw consent given via our banner at any time by deleting browser cookies and revisiting the site.',
    'legal.cookie.browser.title': 'Browser Cookie Settings',
    'legal.cookie.browser.chrome': 'Chrome: Settings → Privacy → Cookies',
    'legal.cookie.browser.firefox': 'Firefox: Options → Privacy → Cookies',
    'legal.cookie.browser.safari': 'Safari: Preferences → Privacy',
    'legal.cookie.browser.edge': 'Edge: Settings → Privacy → Cookies',
    'legal.cookie.contact.prefix': 'For questions, contact:',
    'legal.gdpr.cookie': 'This Cookie Policy complies with Regulation (EU) 2016/679 (GDPR).',
    'legal.privacy.toc.disclaimer': 'Health Notice',
    'legal.privacy.toc.controller': 'Data Controller',
    'legal.privacy.toc.data': 'Data We Collect',
    'legal.privacy.toc.basis': 'Legal Basis',
    'legal.privacy.toc.rights': 'Your Rights',
    'legal.privacy.toc.contact': 'Contact',
    'legal.privacy.warning.body': 'EKA Balance offers complementary and alternative wellness services. Our services are not medical diagnosis, medical treatment, or a substitute for professional healthcare.',
    'legal.privacy.warning.stopMedication': 'Do not stop taking prescribed medications or following medical treatments based on information from this website.',
    'legal.privacy.warning.emergency': 'If you are experiencing a medical emergency, call emergency services immediately (112 in Spain).',
    'legal.privacy.warning.noResponsibility': 'EKA Balance assumes no responsibility for health outcomes resulting from actions taken without consulting a licensed physician.',
    'legal.privacy.warning.link': 'Please see our Full Legal Disclaimer for all details.',
    'legal.privacy.dpo.title': 'Data Protection Officer (DPO)',
    'legal.privacy.data.title': '1. Data We Collect',
    'legal.privacy.data.intro': 'We collect personal data necessary to deliver our wellness services, including:',
    'legal.privacy.data.personal.title': 'Personal Identification',
    'legal.privacy.data.personal.fullName': 'Full name',
    'legal.privacy.data.personal.email': 'Email address',
    'legal.privacy.data.personal.phone': 'Phone number',
    'legal.privacy.data.personal.address': 'Postal address',
    'legal.privacy.data.personal.dob': 'Date of birth',
    'legal.privacy.data.wellness.title': 'Wellness & Health Data',
    'legal.privacy.data.wellness.item1': 'Physical condition and wellness notes',
    'legal.privacy.data.wellness.item2': 'Pain or discomfort indicators',
    'legal.privacy.data.wellness.item3': 'Session history and preferences',
    'legal.privacy.data.wellness.item4': 'Emotional wellness notes (with consent)',
    'legal.privacy.basis.title': '2. Legal Basis for Processing (GDPR Art. 6)',
    'legal.privacy.basis.consent.title': 'Consent (Art. 6(1)(a))',
    'legal.privacy.basis.consent.item1': 'Marketing communications',
    'legal.privacy.basis.consent.item2': 'Non-essential cookies',
    'legal.privacy.basis.consent.item3': 'Wellness data with explicit consent',
    'legal.privacy.basis.contract.title': 'Contractual Necessity',
    'legal.privacy.basis.contract.item1': 'Delivery of booked services',
    'legal.privacy.basis.contract.item2': 'Payment processing',
    'legal.privacy.basis.contract.item3': 'Customer support',
    'legal.privacy.basis.legal.title': 'Legal Obligations',
    'legal.privacy.basis.legal.item1': 'Tax and accounting requirements',
    'legal.privacy.basis.legal.item2': 'Health and safety requirements',
    'legal.privacy.basis.legal.item3': 'Data retention regulations',
    'legal.privacy.basis.interest.title': 'Legitimate Interests',
    'legal.privacy.basis.interest.item1': 'Service improvement',
    'legal.privacy.basis.interest.item2': 'Fraud prevention',
    'legal.privacy.basis.interest.item3': 'Statistical analysis',
    'legal.privacy.rights.title': '3. Your Rights under GDPR (Arts. 12–22)',
    'legal.privacy.right.access': 'Access (Art. 15)',
    'legal.privacy.right.access.desc': 'Request a copy of all personal data we hold about you. We respond within 30 days.',
    'legal.privacy.right.erasure': 'Erasure (Art. 17)',
    'legal.privacy.right.erasure.desc': 'Request deletion of your data where there is no longer a legal basis to retain it.',
    'legal.privacy.right.rectification': 'Rectification (Art. 16)',
    'legal.privacy.right.rectification.desc': 'Request correction of inaccurate or incomplete personal data.',
    'legal.privacy.right.portability': 'Portability (Art. 20)',
    'legal.privacy.right.portability.desc': 'Receive your data in a structured, machine-readable format.',
    'legal.privacy.right.objection': 'Objection (Art. 21)',
    'legal.privacy.right.objection.desc': 'Object to processing based on legitimate interests or for direct marketing.',
    'legal.privacy.contact.authority.title': 'Supervisory Authority',
    'legal.privacy.contact.authority.name': 'Agencia Española de Protección de Datos (AEPD)',
    'legal.gdpr.privacy': 'This Privacy Policy complies with Regulation (EU) 2016/679 (GDPR).',
    'legal.terms.toc.disclaimer': 'Health Notice',
    'legal.terms.toc.nature': 'Nature of Services',
    'legal.terms.toc.acceptance': 'Acceptance',
    'legal.terms.toc.eligibility': 'Eligibility',
    'legal.terms.toc.limitations': 'Limitations',
    'legal.terms.toc.contact': 'Contact',
    'legal.terms.warning.body': 'EKA Balance provides complementary and alternative wellness services. These services are not medical treatment, diagnosis, or a substitute for professional healthcare.',
    'legal.terms.warning.stopMedication': 'Do not stop, reduce, or change prescribed medication or medical treatment based on any content or session received at EKA Balance.',
    'legal.terms.warning.variability': 'Results from complementary therapy vary per person. No specific outcome is guaranteed.',
    'legal.terms.warning.noLiability': 'EKA Balance accepts no liability for health decisions made without consulting a licensed physician.',
    'legal.terms.warning.emergency': 'In any medical emergency, call 112 immediately.',
    'legal.terms.warning.link': 'Read the Full Legal Disclaimer.',
    'legal.terms.nature.title': '1. Nature of Services',
    'legal.terms.nature.intro': 'EKA Balance provides complementary and integrative wellness services, including therapeutic massage, kinesiology, nutritional guidance, somatic education, and bodywork. These services are:',
    'legal.terms.nature.item1': 'Supportive and educational in nature',
    'legal.terms.nature.item2': 'Complementary — not primary or medical care',
    'legal.terms.nature.item3': 'Not intended to diagnose, treat, cure, or prevent any disease or condition',
    'legal.terms.nature.item4': 'Not a substitute for professional medical, psychiatric, or mental health care',
    'legal.terms.nature.important': 'Continue to follow your doctor\'s recommendations. EKA Balance services work alongside conventional medicine, not in place of it.',
    'legal.terms.acceptance.title': '2. Acceptance of Terms',
    'legal.terms.acceptance.body': 'By booking, accessing, or using EKA Balance services, you confirm that you have read, understood, and agreed to these Terms and our Privacy Policy.',
    'legal.terms.acceptance.intro': 'Your use constitutes explicit consent to:',
    'legal.terms.acceptance.item1': 'The collection and processing of personal data as described in our Privacy Policy',
    'legal.terms.acceptance.item2': 'The use of cookies as described in our Cookie Policy',
    'legal.terms.acceptance.item3': 'The nature of complementary wellness services as described in these Terms',
    'legal.terms.eligibility.title': '3. Eligibility',
    'legal.terms.eligibility.intro': 'By using our services, you confirm that:',
    'legal.terms.eligibility.item1': 'You are at least 18 years old, or have parental consent if aged 16–18',
    'legal.terms.eligibility.item2': 'You have legal capacity to enter binding agreements',
    'legal.terms.eligibility.item3': 'You will provide accurate and complete information',
    'legal.terms.eligibility.item4': 'You will comply with all applicable laws',
    'legal.terms.limitations.title': '4. Limitation of Liability',
    'legal.terms.limitations.intro': 'EKA Balance and its therapists are not liable for any health outcome, direct or indirect, resulting from:',
    'legal.terms.limitations.item1': 'Decisions made without consulting a licensed physician',
    'legal.terms.limitations.item2': 'Stopping or modifying prescribed medical treatment',
    'legal.terms.limitations.item3': 'Any undisclosed pre-existing medical condition before sessions',
    'legal.terms.limitations.item4': 'Individual variation in response to complementary therapy',
    'legal.terms.contact.title': '5. Contact',
    'legal.terms.contact.legal': 'Legal Enquiries',
    'legal.terms.contact.dpo': 'Data Protection Officer',
    'legal.gdpr.terms': 'These Terms comply with applicable EU and Spanish consumer protection and data protection legislation.',
    'legal.disclaimer.subtitle': 'Read this before booking or using any EKA Balance service',
    'legal.disclaimer.what.title': 'What EKA Balance Is',
    'legal.disclaimer.what.body1': 'EKA Balance offers complementary and alternative wellness services, including holistic massage, movement coaching, nutritional guidance, somatic bodywork, and integrative wellness sessions.',
    'legal.disclaimer.what.body2': 'These services are designed to support your overall wellbeing alongside — not instead of — conventional medicine. Our therapists are trained wellness professionals, not licensed physicians.',
    'legal.disclaimer.not.title': 'What EKA Balance Is Not',
    'legal.disclaimer.not.item1': 'EKA Balance does not provide medical diagnosis of any disease, disorder, or condition.',
    'legal.disclaimer.not.item2': 'EKA Balance does not provide medical treatment, prescription, or cure.',
    'legal.disclaimer.not.item3': 'EKA Balance sessions are not a substitute for consultations with your doctor, specialist, or licensed mental health professional.',
    'legal.disclaimer.not.item4': 'No content on this website constitutes medical advice.',
    'legal.disclaimer.not.item5': 'EKA Balance does not claim to treat, cure, prevent, or mitigate any medical condition.',
    'legal.disclaimer.consult.title': 'Always Consult Your Doctor First',
    'legal.disclaimer.consult.intro': 'Before beginning any complementary or alternative wellness service, consult your licensed physician, especially if:',
    'legal.disclaimer.consult.item1': 'You have a pre-existing health condition or ongoing wellness concern',
    'legal.disclaimer.consult.item2': 'You are taking prescribed medication',
    'legal.disclaimer.consult.item3': 'You are pregnant or breastfeeding',
    'legal.disclaimer.consult.item4': 'You have recently had surgery or a medical procedure',
    'legal.disclaimer.consult.item5': 'You are experiencing persistent, acute, or unexplained physical concerns',
    'legal.disclaimer.consult.item6': 'You are under the care of a specialist (cardiologist, oncologist, psychiatrist, etc.)',
    'legal.disclaimer.consult.warning': 'Do not stop, reduce, or modify any prescribed healthcare plan based on anything received or read at EKA Balance.',
    'legal.disclaimer.liability.title': 'Limitation of Liability',
    'legal.disclaimer.liability.intro': 'EKA Balance and its therapists accept no medical or legal liability for any health outcome — positive or negative — resulting from:',
    'legal.disclaimer.liability.item1': 'Decisions made without first consulting a licensed physician',
    'legal.disclaimer.liability.item2': 'Any modification or discontinuation of prescribed medical care',
    'legal.disclaimer.liability.item3': 'Individual variation in response to complementary services',
    'legal.disclaimer.liability.item4': 'Pre-existing conditions not disclosed before sessions',
    'legal.disclaimer.liability.vary': 'Results from complementary wellness services vary from person to person. No specific outcome is guaranteed.',
    'legal.disclaimer.emergency.title': 'Medical Emergency',
    'legal.disclaimer.emergency.call': 'If you are experiencing a medical emergency, call emergency services immediately.',
    'legal.disclaimer.emergency.spain': 'Spain (EU)',
    'legal.disclaimer.emergency.general': 'General Emergency',
    'legal.disclaimer.emergency.crisis': 'Crisis Line (ES)',
    'legal.disclaimer.footer.law': 'This notice is provided in accordance with Spanish consumer protection law (Real Decreto Legislativo 1/2007), EU Directive 2011/83/EU on consumer rights, and applicable professional standards.',
    'legal.disclaimer.footer.confirm': 'By booking or using any EKA Balance service, you confirm that you have read and understood this notice.',
    'legal.disclaimer.links.terms': 'Terms of Service',
    'legal.disclaimer.links.privacy': 'Privacy Policy',
    'legal.disclaimer.links.booking': 'Contact Us & Book',
  },
  es: {
    // Navigation
    'common.clickToCopy': 'Haz clic para copiar',
    'common.copied': '¡Copiado!',
    'vip.seo.title': 'Programa Wellness VIP | EKA Balance Barcelona',
    'vip.seo.description': 'Acceso exclusivo a sesiones personalizadas, reserva prioritaria y acompañamiento integral para perfiles de alto rendimiento.',
    'vip.seo.keywords': 'bienestar vip barcelona, kinesiología premium, masaje a domicilio barcelona, salud ejecutiva',
    'vip.services.title': 'Servicios Signature',
    'vip.services.subtitle': 'Una selección de nuestras terapias más exclusivas adaptadas a tu estilo de vida.',
    'vip.pricing.title': 'Planes de Acompañamiento',
    'vip.pricing.subtitle': 'Escoge el nivel de excelencia que mejor se adapte a tus necesidades.',
    'booking.smart.close': 'Cerrar asistente',
    'agenyz.redirect.notice': 'Estás siendo redirigido a la tienda oficial de Agenyz.',
    'casos.approach': 'Nuestro enfoque',
    'casos.concerns': 'Puntos de dolor',
    'casos.results': 'Resultados obtenidos',
    'casos.causes': 'Causas detectadas',
    'assessment.processing.label': 'ANALIZANDO',
    'assessment.result.recommended.label': 'Recomendado',
    'assessment.result.trust.title': 'Con la confianza de más de 1500 clientes en Barcelona.',
    'assessment.result.join.community': 'ÚNETE A NUESTRA COMUNIDAD',
    'assessment.progress.analysis': 'Análisis de progreso',
    'booking.analysis.title': 'Análisis de la evaluación',
    'booking.analysis.subtitle': 'Tu camino personalizado está listo',
    'booking.label.intensity': 'Intensidad',
    'booking.label.profile': 'Perfil',
    'booking.label.mood': 'Estado de ánimo',
    'booking.label.energy': 'Energía',
    'booking.response.time': 'Respuesta en < 24h',
    'booking.emergency.prioritize': 'Priorizar solicitudes de emergencia',
    'nav.home': 'Inicio',
    ...
    'elena.approach.desc': "En el núcleo de mi trabajo yace una profunda comprensión de que el cuerpo, el cerebro y las emociones son un sistema unificado. No me quedo en la superficie, sino que busco la causa raíz, ayudando al organismo a restaurar su capacidad natural de autorregulación. Mi método combina técnicas avanzadas de trabajo con el cuerpo y el sistema nervioso: Movement Lesson, JKA (Jeremy Krauss Approach), ChildSpace, Feldenkrais y biodinámica. Es una influencia suave pero poderosa que reentrena el sistema nervioso, libera tensiones profundas y restaura la facilidad de movimiento y la claridad mental.",
    ...
    'about.description1': 'Con más de 15 años de experiencia, he perfeccionado un método que realmente escucha al cuerpo. Mi misión es ayudarte a reconectar contigo mismo y restaurar tu capacidad natural de bienestar.',
    ...
    'hero.subtitle': 'Vuelve a sentirte cómodo en tu cuerpo. A través de la terapia somática y la kinesiología te ayudamos a liberar la tensión acumulada, recuperar la facilidad de movimiento y reencontrar tu energía natural.',
    ...
    // Services Section
    'services.badge': 'Bienestar integral',
    ...
    // Service: Kinesiology
    'kinesiology.title': 'Kinesiología integrativa',
    ...
    // Service: Nutrition
    'nutrition.title': 'Nutrición funcional',
    ...
    // Problems / Casos Section
    'problems.badge': 'Bienestar y resolución',
    'problems.title': 'Identifica tus desequilibrios',
    'problems.subtitle': 'Abordaje integral de las situaciones más comunes a través de estrategias terapéuticas personalizadas.',

    // Problem: Back Pain
    'problems.backpain.title': 'Tensión vertebral crónica',
    'problems.backpain.desc': 'Malestar estructural persistente que compromete el descanso y la funcionalidad.',
    'problems.backpain.solution': 'Nuestro enfoque',
    ...
    'problems.stress.solution': 'Nuestro enfoque',
    ...
    'problems.fatigue.solution': 'Nuestro enfoque',
    ...
    'problems.injuries.solution': 'Nuestro enfoque',
    ...
    'booking.hero.title': 'Solicita tu sesión',
    ...
    'booking.email.title': 'Envíanos un Correo',
    'booking.email.description': '¿Prefieres escribir? Envíanos un correo y te responderemos en 24 horas.',
    'booking.email.button': 'Enviar Correo',
    'booking.form.alternative': 'O solicita contacto a través de nuestro formulario',
    'booking.form.show': 'Mostrar Formulario',
    'booking.form.title': 'Solicitud de cita',
    'booking.form.description': 'Facilita tus datos para preparar la sesión',
    'booking.form.button': 'Iniciar solicitud',
    'booking.form.hide': 'Cerrar formulario',
    'booking.form.location': 'Ubicación',
    ...
    'booking.options.service.kinesiology': 'Kinesiología integrativa',
    'booking.options.service.osteobalance': 'Osteobalance',
    'booking.options.service.movementLesson': 'Movement Lesson',
    ...
    'athletes.challenges.title': 'Desafíos habituales',
    ...
    'athletes.help.title': 'Cómo ayudamos',
    ...
    'athletes.result.title': 'Resultados reales',
    ...
    'artists.challenges.title': 'Desafíos habituales',
    ...
    'artists.help.title': 'Cómo ayudamos',
    ...
    'artists.result.title': 'Resultados reales',
    ...
    'musicians.problems.title': 'Desequilibrios comunes',
    'musicians.problems.subtitle': 'Situaciones frecuentes que trabajamos con músicos e intérpretes profesionales',
    ...
    'musicians.problem2.title': 'Tensión postural',
    ...
    'musicians.results.title': 'Qué conseguirás',
    'musicians.results.point1': 'Alivio del dolor y recuperación de la sensibilidad',
    ...
    'musicians.plans.subtitle': 'Selecciona el nivel de acompañamiento que necesitas',
    'musicians.plan1.name': 'Evaluación inicial',
    'musicians.plan1.desc': 'Valoración inicial y primera sesión de alivio',
    ...
    'musicians.plan1.benefit4': 'Plan de sesiones personalizado',
    'musicians.plan1.result': 'Evaluación completa y alivio en la primera sesión',
    ...
    'common.healthDisclaimerTitle': 'Aviso de Salud Importante',
    'common.consultDoctor': 'Consulte siempre a su médico antes de tomar cualquier decisión de salud.',
    'common.back': 'Atrás',
    ...
    'personalized.students.services.subtitle': 'Sesiones especializadas para la optimización del estudio',
    ...
    'personalized.officeWorkers.hero.description': 'Ergonomía y gestión del estrés para el entorno ejecutivo.',
    ...
    'personalized.officeWorkers.services.title': 'Cómo trabajamos',
    ...
    'personalized.artists.understanding.title': 'Desafíos habituales',
    ...
    'personalized.artists.services.title': 'Cómo trabajamos',
    'personalized.artists.services.subtitle': 'Tratamientos especializados para artistas',
    'personalized.artists.benefits.title': 'Qué lograrás',
    ...
    'personalized.musicians.understanding.callToAction': 'Solicitar evaluación',
    ...
    'personalized.parents.understanding.description2': 'Ofrecemos un espacio de calma y regeneración para prevenir el agotamiento.',
    ...
    'casos.discoverIdeal': 'Descubre tu camino',
    'casos.bookSession': 'Reservar sesión',
    'casos.seeDetails': 'Ver detalles',
    'casos.section.badge': 'Casos reales',
    'casos.section.title': 'Identifica tu desequilibrio',
    ...
    'casos.problems.digestive.description': 'Malestar abdominal e hinchazón.',
    ...
    'personalized.officeWorkers.method.title': "Protocolo de Bienestar Corporativo",
    'personalized.officeWorkers.method.step1.title': "Descompresión Postural",
    'personalized.officeWorkers.method.step1.desc': "Nos enfocamos en las líneas fasciales acortadas por estar sentado, abriendo el pecho y liberando la tensión del cuello.",
    'personalized.officeWorkers.method.step2.title': "Reinicio del Sistema Nervioso",
    'personalized.officeWorkers.method.step3.title': "Realineamiento Ergonómico",
    'personalized.officeWorkers.method.step3.desc': "Integramos señales somáticas simples para ayudarte a mantener una alineación neutral sin esfuerzo durante el día.",
    'personalized.officeWorkers.benefits.title': "Beneficios clave",
    'personalized.officeWorkers.benefit1': "Alivio inmediato del dolor crónico de cuello, hombros y espalda baja.",
    'personalized.officeWorkers.benefit2': "Reducción de dolores de cabeza tensionales y fatiga ocular mediante liberación craneal.",
    'personalized.officeWorkers.faq.title': "Preguntas frecuentes",
    'personalized.officeWorkers.faq.q1': "Tengo \"cuello de texto\". ¿La terapia somática puede arreglar mi postura?",
    'personalized.officeWorkers.faq.q2': "¿Es adecuado para la atención preventiva?",
    'personalized.officeWorkers.faq.q3': "¿Tendré que hacer ejercicios en mi escritorio?",
    'personalized.officeWorkers.faq.a3': "Proporcionamos micro-movimientos sutiles que restablecen tu sistema nervioso y postura sin interrumpir el flujo de trabajo.",
    'personalized.musicians.method.step1.title': "Análisis Instrumental",
    'personalized.musicians.method.step1.desc': "Evaluamos las demandas biomecánicas únicas de tu instrumento, identificando patrones asimétricos.",
    'personalized.musicians.method.step2.title': "Liberación de Motor Fino",
    'personalized.musicians.method.step2.desc': "Nos enfocamos en la musculatura delicada de manos y brazos, y en la tensión central que restringe la respiración.",
    'personalized.musicians.benefits.title': "Beneficios clave",
    'personalized.musicians.benefit1': "Prevención y tratamiento de lesiones por esfuerzo repetitivo (RSI) y tendinitis.",
    'personalized.musicians.benefit2': "Mejor control de la respiración y resonancia para músicos de viento y vocalistas.",
    'personalized.musicians.benefit3': "Mayor fluidez y reducción de tensión en la postura de tocar.",
    'personalized.musicians.faq.title': "Preguntas frecuentes",
    'personalized.musicians.faq.q1': "¿Esto puede ayudar con la tendinitis o el túnel carpiano?",
    'personalized.musicians.faq.q2': "¿El tratamiento afectará mi técnica?",
    'personalized.musicians.faq.a2': "La refinará. Al eliminar la tensión innecesaria, podrás tocar con más facilidad, velocidad y resistencia.",
    'personalized.musicians.faq.q3': "Toco un instrumento asimétrico. ¿Cómo ayudan?",
    'personalized.musicians.faq.a3': "Nos enfocamos en deshacer los patrones de rotación, restaurando la simetría en tu postura de descanso.",
    'personalized.athletes.method.title': "Nuestro protocolo de rendimiento",
    'personalized.athletes.method.step1.title': "Evaluación biomecánica",
    'personalized.athletes.method.step1.desc': "Analizamos tus patrones de movimiento para identificar ineficiencias neuromusculares y restricciones fasciales.",
    'personalized.athletes.method.step2.title': "Liberación estratégica y activación",
    'personalized.athletes.method.step3.title': "Integración del rendimiento",
    'personalized.athletes.method.step3.desc': "Reentrenamos tu sistema nervioso para estrategias de movimiento eficientes, mejorando la potencia y reduciendo el tiempo de recuperación.",
    'personalized.athletes.benefits.title': "Beneficios clave",
    'personalized.athletes.benefit1': "Tiempos de recuperación acelerados mediante drenaje linfático mejorado y liberación fascial.",
    'personalized.athletes.benefit2': "Prevención de lesiones por sobrecarga corrigiendo patrones de movimiento compensatorios.",
    'personalized.athletes.benefit3': "Biomecánica optimizada que lleva a una mayor potencia explosiva y resistencia.",
    'personalized.athletes.benefit4': "Mayor conciencia propioceptiva para una mejor координация y agilidad.",
    'personalized.athletes.faq.title': "Preguntas frecuentes",
    ...
    // Legal pages
    'legal.date': '15 de noviembre de 2025',
    'legal.cookie.toc.notice': 'Aviso de Salud',
    'legal.cookie.toc.what': 'Qué Son las Cookies',
    'legal.cookie.toc.types': 'Tipos que Usamos',
    'legal.cookie.toc.manage': 'Gestionar Cookies',
    'legal.wellness.notice.title': 'Aviso de Bienestar Complementario',
    'legal.wellness.notice.body': 'Este sitio web presenta servicios de bienestar complementario y alternativo. Nada en este sitio constituye asesoramiento médico, diagnóstico o tratamiento.',
    'legal.wellness.notice.warning': 'Consulte siempre a su médico antes de tomar cualquier decisión de salud.',
    'legal.wellness.notice.link': 'Aviso Legal Completo →',
    'legal.cookie.what.title': '1. Qué Son las Cookies (RGPD Art. 4(11))',
    'legal.cookie.what.body': 'Las cookies son pequeños archivos de texto colocados en su dispositivo cuando visita nuestro sitio web. Nos ayudan a proporcionar una experiencia funcional, segura y mejorada.',
    'legal.cookie.types.title': '2. Cookies que Usamos',
    'legal.cookie.essential.title': 'Cookies Esenciales',
    'legal.cookie.essential.desc': 'Necesarias para el funcionamiento del sitio web. No se pueden desactivar. Se utilizan para la navegación, la seguridad y los flujos de reserva.',
    'legal.cookie.analytics.title': 'Cookies Analíticas',
    'legal.cookie.analytics.desc': 'Nos ayudan a entender cómo los visitantes usan nuestro sitio (p. ej., Google Analytics). Se utilizan de forma anónima para mejorar el contenido y el rendimiento.',
    'legal.cookie.preference.title': 'Cookies de Preferencias',
    'legal.cookie.preference.desc': 'Recuerdan su configuración de idioma y región para que no tenga que volver a seleccionarla en cada visita.',
    'legal.cookie.alwaysActive': 'Siempre Activas',
    'legal.cookie.optional': 'Opcional',
    'legal.cookie.manage.title': '3. Gestionar las Cookies',
    'legal.cookie.manage.body1': 'Puede gestionar, restringir o eliminar las cookies en cualquier momento a través de la configuración del navegador. Desactivar las cookies no esenciales no afectará la funcionalidad básica del sitio web.',
    'legal.cookie.manage.body2': 'Puede retirar el consentimiento otorgado a través de nuestro banner en cualquier momento eliminando las cookies del navegador y volviendo a visitar el sitio.',
    'legal.cookie.browser.title': 'Configuración de Cookies del Navegador',
    'legal.cookie.browser.chrome': 'Chrome: Configuración → Privacidad → Cookies',
    'legal.cookie.browser.firefox': 'Firefox: Opciones → Privacidad → Cookies',
    'legal.cookie.browser.safari': 'Safari: Preferencias → Privacidad',
    'legal.cookie.browser.edge': 'Edge: Configuración → Privacidad → Cookies',
    'legal.cookie.contact.prefix': 'Para preguntas, contacte:',
    'legal.gdpr.cookie': 'Esta Política de Cookies cumple con el Reglamento (UE) 2016/679 (RGPD).',
    'legal.privacy.toc.disclaimer': 'Aviso de Salud',
    'legal.privacy.toc.controller': 'Responsable del Tratamiento',
    'legal.privacy.toc.data': 'Datos que Recogemos',
    'legal.privacy.toc.basis': 'Base Legal',
    'legal.privacy.toc.rights': 'Sus Derechos',
    'legal.privacy.toc.contact': 'Contacto',
    'legal.privacy.warning.body': 'EKA Balance ofrece servicios de bienestar complementario y alternativo. Nuestros servicios no son diagnóstico médico, tratamiento médico ni sustituto de atención sanitaria profesional.',
    'legal.privacy.warning.stopMedication': 'No deje de tomar medicamentos prescritos ni de seguir tratamientos médicos basándose en información de este sitio web.',
    'legal.privacy.warning.emergency': 'Si está viviendo una emergencia médica, llame inmediatamente a los servicios de emergencias (112 en España).',
    'legal.privacy.warning.noResponsibility': 'EKA Balance no asume ninguna responsabilidad por los resultados de salud derivados de acciones tomadas sin consultar a un médico autorizado.',
    'legal.privacy.warning.link': 'Consulte nuestro Aviso Legal Completo para todos los detalles.',
    'legal.privacy.dpo.title': 'Delegado de Protección de Datos (DPD)',
    'legal.privacy.data.title': '1. Datos que Recogemos',
    'legal.privacy.data.intro': 'Recogemos datos personales necesarios para prestar nuestros servicios de bienestar, incluyendo:',
    'legal.privacy.data.personal.title': 'Identificación Personal',
    'legal.privacy.data.personal.fullName': 'Nombre completo',
    'legal.privacy.data.personal.email': 'Dirección de correo electrónico',
    'legal.privacy.data.personal.phone': 'Número de teléfono',
    'legal.privacy.data.personal.address': 'Dirección postal',
    'legal.privacy.data.personal.dob': 'Fecha de nacimiento',
    'legal.privacy.data.wellness.title': 'Datos de Bienestar y Salud',
    'legal.privacy.data.wellness.item1': 'Notas sobre condición física y bienestar',
    'legal.privacy.data.wellness.item2': 'Indicadores de dolor o malestar',
    'legal.privacy.data.wellness.item3': 'Historial de sesiones y preferencias',
    'legal.privacy.data.wellness.item4': 'Notas de bienestar emocional (con consentimiento)',
    'legal.privacy.basis.title': '2. Base Legal del Tratamiento (RGPD Art. 6)',
    'legal.privacy.basis.consent.title': 'Consentimiento (Art. 6(1)(a))',
    'legal.privacy.basis.consent.item1': 'Comunicaciones de marketing',
    'legal.privacy.basis.consent.item2': 'Cookies no esenciales',
    'legal.privacy.basis.consent.item3': 'Datos de bienestar con consentimiento explícito',
    'legal.privacy.basis.contract.title': 'Necesidad Contractual',
    'legal.privacy.basis.contract.item1': 'Prestación de los servicios reservados',
    'legal.privacy.basis.contract.item2': 'Procesamiento de pagos',
    'legal.privacy.basis.contract.item3': 'Atención al cliente',
    'legal.privacy.basis.legal.title': 'Obligaciones Legales',
    'legal.privacy.basis.legal.item1': 'Fiscalidad y contabilidad',
    'legal.privacy.basis.legal.item2': 'Requisitos de salud y seguridad',
    'legal.privacy.basis.legal.item3': 'Normas de conservación de datos',
    'legal.privacy.basis.interest.title': 'Intereses Legítimos',
    'legal.privacy.basis.interest.item1': 'Mejora del servicio',
    'legal.privacy.basis.interest.item2': 'Prevención del fraude',
    'legal.privacy.basis.interest.item3': 'Análisis estadístico',
    'legal.privacy.rights.title': '3. Sus Derechos bajo el RGPD (Arts. 12–22)',
    'legal.privacy.right.access': 'Acceso (Art. 15)',
    'legal.privacy.right.access.desc': 'Solicite una copia de todos los datos personales que tenemos sobre usted. Respondemos en 30 días.',
    'legal.privacy.right.erasure': 'Supresión (Art. 17)',
    'legal.privacy.right.erasure.desc': 'Solicite la eliminación de sus datos cuando ya no exista una base legal para conservarlos.',
    'legal.privacy.right.rectification': 'Rectificación (Art. 16)',
    'legal.privacy.right.rectification.desc': 'Solicite la corrección de datos personales inexactos o incompletos.',
    'legal.privacy.right.portability': 'Portabilidad (Art. 20)',
    'legal.privacy.right.portability.desc': 'Reciba sus datos en un formato estructurado y legible por máquina.',
    'legal.privacy.right.objection': 'Oposición (Art. 21)',
    'legal.privacy.right.objection.desc': 'Opóngase al tratamiento basado en intereses legítimos o para marketing directo.',
    'legal.privacy.contact.authority.title': 'Autoridad de Supervisión',
    'legal.privacy.contact.authority.name': 'Agencia Española de Protección de Datos (AEPD)',
    'legal.gdpr.privacy': 'Esta Política de Privacidad cumple con el Reglamento (UE) 2016/679 (RGPD).',
    'legal.terms.toc.disclaimer': 'Aviso de Salud',
    'legal.terms.toc.nature': 'Naturaleza de los Servicios',
    'legal.terms.toc.acceptance': 'Aceptación',
    'legal.terms.toc.eligibility': 'Elegibilidad',
    'legal.terms.toc.limitations': 'Limitaciones',
    'legal.terms.toc.contact': 'Contacto',
    'legal.terms.warning.body': 'EKA Balance proporciona servicios de bienestar complementario y alternativo. Estos servicios no son tratamiento médico, diagnóstico ni sustituto de atención sanitaria profesional.',
    'legal.terms.warning.stopMedication': 'No deje de tomar, reduzca ni cambie los medicamentos prescritos ni el tratamiento médico basándose en ningún contenido o sesión recibida en EKA Balance.',
    'legal.terms.warning.variability': 'Los resultados de la terapia complementaria varían por persona. No se garantiza ningún resultado específico.',
    'legal.terms.warning.noLiability': 'EKA Balance no acepta ninguna responsabilidad por decisiones de salud tomadas sin consultar a un médico autorizado.',
    'legal.terms.warning.emergency': 'En cualquier emergencia médica, llame inmediatamente al 112.',
    'legal.terms.warning.link': 'Lea el Aviso Legal Completo.',
    'legal.terms.nature.title': '1. Naturaleza de los Servicios',
    'legal.terms.nature.intro': 'EKA Balance proporciona servicios de bienestar complementario e integrativo, incluyendo masaje terapéutico, kinesiología, orientación nutricional, educación somática y trabajo corporal. Estos servicios son:',
    'legal.terms.nature.item1': 'De naturaleza de apoyo y educativa',
    'legal.terms.nature.item2': 'Complementarios — no atención primaria ni médica',
    'legal.terms.nature.item3': 'No destinados a diagnosticar, tratar, curar o prevenir ninguna enfermedad o condición',
    'legal.terms.nature.item4': 'No sustitutos de atención médica, psiquiátrica o de salud mental profesional',
    'legal.terms.nature.important': 'Continúe siguiendo las recomendaciones de su médico. Los servicios de EKA Balance funcionan junto a la medicina convencional, no en sustitución de ella.',
    'legal.terms.acceptance.title': '2. Aceptación de los Términos',
    'legal.terms.acceptance.body': 'Al reservar, acceder o utilizar los servicios de EKA Balance, confirma que ha leído, entendido y aceptado estos Términos y nuestra Política de Privacidad.',
    'legal.terms.acceptance.intro': 'Su uso constituye consentimiento explícito a:',
    'legal.terms.acceptance.item1': 'La recogida y el tratamiento de datos personales tal como se describe en nuestra Política de Privacidad',
    'legal.terms.acceptance.item2': 'El uso de cookies tal como se describe en nuestra Política de Cookies',
    'legal.terms.acceptance.item3': 'La naturaleza de los servicios de bienestar complementario tal como se describe en estos Términos',
    'legal.terms.eligibility.title': '3. Elegibilidad',
    'legal.terms.eligibility.intro': 'Al utilizar nuestros servicios, confirma que:',
    'legal.terms.eligibility.item1': 'Tiene al menos 18 años, o dispone de consentimiento parental si tiene entre 16–18 años',
    'legal.terms.eligibility.item2': 'Tiene capacidad legal para celebrar acuerdos vinculantes',
    'legal.terms.eligibility.item3': 'Proporcionará información precisa y completa',
    'legal.terms.eligibility.item4': 'Cumplirá todas las leyes aplicables',
    'legal.terms.limitations.title': '4. Limitación de Responsabilidad',
    'legal.terms.limitations.intro': 'EKA Balance y sus terapeutas no son responsables de ningún resultado de salud, directo o indirecto, derivado de:',
    'legal.terms.limitations.item1': 'Decisiones tomadas sin consultar a un médico autorizado',
    'legal.terms.limitations.item2': 'Detener o modificar el tratamiento médico prescrito',
    'legal.terms.limitations.item3': 'Cualquier condición médica preexistente no revelada antes de las sesiones',
    'legal.terms.limitations.item4': 'Variación individual en la respuesta a la terapia complementaria',
    'legal.terms.contact.title': '5. Contacto',
    'legal.terms.contact.legal': 'Consultas Legales',
    'legal.terms.contact.dpo': 'Delegado de Protección de Datos',
    'legal.gdpr.terms': 'Estos Términos cumplen con la legislación aplicable de protección del consumidor y de protección de datos de la UE y España.',
    'legal.disclaimer.subtitle': 'Léalo antes de reservar o usar cualquier servicio de EKA Balance',
    'legal.disclaimer.what.title': 'Qué Es EKA Balance',
    'legal.disclaimer.what.body1': 'EKA Balance ofrece servicios de bienestar complementario y alternativo, incluyendo masaje holístico, coaching de movimiento, orientación nutricional, trabajo corporal somático y sesiones de bienestar integrativo.',
    'legal.disclaimer.what.body2': 'Estos servicios están diseñados para apoyar su bienestar general junto a — no en lugar de — la medicina convencional. Nuestros terapeutas son profesionales de bienestar formados, no médicos autorizados.',
    'legal.disclaimer.not.title': 'Qué No Es EKA Balance',
    'legal.disclaimer.not.item1': 'EKA Balance no proporciona diagnóstico médico de ninguna enfermedad, trastorno o condición.',
    'legal.disclaimer.not.item2': 'EKA Balance no proporciona tratamiento médico, prescripción ni cura.',
    'legal.disclaimer.not.item3': 'Las sesiones de EKA Balance no sustituyen las consultas con su médico, especialista o profesional de salud mental autorizado.',
    'legal.disclaimer.not.item4': 'Ningún contenido de este sitio web constituye asesoramiento médico.',
    'legal.disclaimer.not.item5': 'EKA Balance no afirma tratar, curar, prevenir ni mitigar ninguna condición médica.',
    'legal.disclaimer.consult.title': 'Consulte Siempre a Su Médico Primero',
    'legal.disclaimer.consult.intro': 'Antes de comenzar cualquier servicio de bienestar complementario o alternativo, consulte a su médico autorizado, especialmente si:',
    'legal.disclaimer.consult.item1': 'Tiene una condición de salud preexistente o una preocupación de bienestar continua',
    'legal.disclaimer.consult.item2': 'Está tomando medicación prescrita',
    'legal.disclaimer.consult.item3': 'Está embarazada o en período de lactancia',
    'legal.disclaimer.consult.item4': 'Ha tenido recientemente una operación o un procedimiento médico',
    'legal.disclaimer.consult.item5': 'Experimenta preocupaciones físicas persistentes, agudas o inexplicadas',
    'legal.disclaimer.consult.item6': 'Está bajo la atención de un especialista (cardiólogo, oncólogo, psiquiatra, etc.)',
    'legal.disclaimer.consult.warning': 'No detenga, reduzca ni modifique ningún plan de atención sanitaria prescrito basándose en nada recibido o leído en EKA Balance.',
    'legal.disclaimer.liability.title': 'Limitación de Responsabilidad',
    'legal.disclaimer.liability.intro': 'EKA Balance y sus terapeutas no aceptan ninguna responsabilidad médica ni legal por ningún resultado de salud — positivo o negativo — derivado de:',
    'legal.disclaimer.liability.item1': 'Decisiones tomadas sin consultar previamente a un médico autorizado',
    'legal.disclaimer.liability.item2': 'Cualquier modificación o suspensión de la atención médica prescrita',
    'legal.disclaimer.liability.item3': 'Variación individual en la respuesta a los servicios complementarios',
    'legal.disclaimer.liability.item4': 'Condiciones preexistentes no reveladas antes de las sesiones',
    'legal.disclaimer.liability.vary': 'Los resultados de los servicios de bienestar complementario varían de persona a persona. No se garantiza ningún resultado específico.',
    'legal.disclaimer.emergency.title': 'Emergencia Médica',
    'legal.disclaimer.emergency.call': 'Si está viviendo una emergencia médica, llame inmediatamente a los servicios de emergencias.',
    'legal.disclaimer.emergency.spain': 'España (UE)',
    'legal.disclaimer.emergency.general': 'Emergencia General',
    'legal.disclaimer.emergency.crisis': 'Línea de Crisis (ES)',
    'legal.disclaimer.footer.law': 'Este aviso se proporciona de conformidad con la ley española de protección del consumidor (Real Decreto Legislativo 1/2007), la Directiva UE 2011/83/UE sobre derechos de los consumidores y los estándares profesionales aplicables.',
    'legal.disclaimer.footer.confirm': 'Al reservar o usar cualquier servicio de EKA Balance, confirma que ha leído y entendido este aviso.',
    'legal.disclaimer.links.terms': 'Condiciones de Servicio',
    'legal.disclaimer.links.privacy': 'Política de Privacidad',
    'legal.disclaimer.links.booking': 'Contáctenos y Reserve',
  },
  ...
  ru: {
    ...
    'vip.seo.title': 'Программа Wellness VIP | EKA Balance Барселона',
    'vip.seo.description': 'Эксклюзивный доступ к персональным сессиям, приоритетное бронирование и комплексная поддержка для высокоэффективных людей.',
    'vip.seo.keywords': 'wellness vip барселона, премиальная кинезиология, массаж на дому барселона, здоровье руководителей',
    'vip.services.title': 'Signature Услуги',
    'vip.services.subtitle': 'Подборка наших самых эксклюзивных процедур, адаптированных к вашему образу жизни.',
    'vip.pricing.title': 'Планы Сопровождения',
    'vip.pricing.subtitle': 'Выберите уровень совершенства, который лучше всего соответствует вашим потребностям.',
    'booking.smart.close': 'Закрыть помощник',
    'agenyz.redirect.notice': 'Вы перенаправляетесь в официальный магазин Agenyz.',
    'casos.approach': 'Наш подход',
    'casos.concerns': 'Болевые точки',
    'casos.results': 'Полученные результаты',
    'casos.causes': 'Выявленные причины',
    'assessment.processing.label': 'АНАЛИЗ',
    'assessment.result.recommended.label': 'Рекомендуется',
    'assessment.result.trust.title': 'Нам доверяют более 1500 клиентов в Барселоне.',
    'assessment.result.join.community': 'ПРИСОЕДИНЯЙТЕСЬ К НАШЕМУ СООБЩЕСТВУ',
    'assessment.progress.analysis': 'Анализ прогресса',
    'booking.analysis.title': 'Анализ оценки',
    'booking.analysis.subtitle': 'Ваш персональный путь готов',
    'booking.label.intensity': 'Интенсивность',
    'booking.label.profile': 'Профиль',
    'booking.label.mood': 'Настроение',
    'booking.label.energy': 'Энергия',
    'booking.response.time': 'Ответ менее чем за 24 часа',
    'booking.emergency.prioritize': 'Приоритет для срочных запросов',
    'nav.home': 'Главная',
    'nav.services': 'Услуги',
    ...
    'elena.approach.desc': "В основе моей работы лежит глубокое понимание того, что тело, мозг и эмоции — это единая система. Я не остаюсь на поверхности, а ищу первопричину дискомфорта, помогая организму восстановить естественную способность к саморегуляции. Мой метод объединяет передовые техники работы с телом и нервной системой: Movement Lesson, JKA (Jeremy Krauss Approach), ChildSpace, Feldenkrais и биодинамику. Это мягкое, но мощное воздействие, которое переобучает нервную систему, снимает глубинные напряжения и возвращает легкость движения и ясность ума.",
    ...
    'about.description1': 'За 15 лет работы я создала метод, который по-настоящему слушает тело. Моя миссия — помочь вам восстановить связь с собой и вернуть естественное состояние благополучия.',
    ...
    'hero.subtitle': 'Снова почувствуйте лёгкость в своём теле. Через соматическую терапию и кинезиологию мы помогаем снять накопленное напряжение, восстановить свободу движения и вернуть природную энергию.',
    'hero.firstTime': 'Вы здесь впервые?',
    ...
    // Service: Kinesiology
    'kinesiology.title': 'Интегративная кинезиология',
    'kinesiology.desc': 'Биологическая обратная связь высокой точности. Мы используем неврологический мышечный тест для расшифровки и коррекции структурных, биохимических и эмоциональных дисбалансов.',
    'kinesiology.benefit1': 'Выявление корневых причин',
    ...
    // Problems / Casos Section
    'problems.badge': 'Здоровье и равновесие',
    'problems.title': 'Найдите свой дисбаланс',
    'problems.subtitle': 'Интегративный подход к распространённым ситуациям через персональные терапевтические стратегии.',

    // Problem: Back Pain
    'problems.backpain.title': 'Хроническое напряжение спины',
    'problems.backpain.desc': 'Постоянный структурный дискомфорт, нарушающий отдых и профессиональную деятельность.',
    'problems.backpain.solution': 'Наш подход',
    ...
    'problems.stress.solution': 'Наш подход',
    ...
    'problems.fatigue.solution': 'Наш подход',
    ...
    'problems.injuries.solution': 'Наш подход',
    ...
    'personalizedServices.main.list1': 'Общий подход',
    ...
    'personalizedServices.artists.benefit1': 'Специализированная работа с руками, запястьями и предплечьями.',
    ...
    'booking.email.title': 'Отправьте нам email',
    'booking.email.description': 'Предпочитаете писать? Отправьте нам письмо, и мы ответим в течение 24 часов.',
    'booking.email.button': 'Отправить email',
    'booking.form.alternative': 'Или оставьте заявку через нашу форму',
    'booking.form.show': 'Показать форму',
    ...
    'booking.form.objectivePlaceholder': 'Кратко расскажите, что привело вас к нам...',
    ...
    'musicians.plan1.benefit2': 'Работа со специфическими напряжениями',
    ...
    'common.contents': 'Содержание',
    'common.healthDisclaimerTitle': 'Важное медицинское предупреждение',
    'common.consultDoctor': 'Всегда консультируйтесь с врачом перед принятием любых решений, касающихся здоровья.',
    'common.back': 'Назад',
    ...
    'footer.disclaimer': 'Оздоровительный отказ от ответственности',
    ...
    // Elena SEO
    'elena.seo.title': 'Елена Кучерова | холистический терапевт в Барселоне',
    'elena.seo.desc': 'Метод Елены Кучеровой — интегративная соматическая терапия: массаж, кинезиология, нутрициология. Более 10 лет опыта в Барселоне.',
    'elena.seo.keywords': 'Елена Кучерова, соматическая терапия, массаж Барселона, кинезиология, холистический терапевт',
    ...
    'onboarding.goals.pain': 'Работа с физической и структурной болью',
    ...
    'onboarding.approaches.kinesiology': 'Интегративная кинезиология',
    'onboarding.approaches.feldenkrais': 'Метод фельденкрайза',
    'onboarding.approaches.energy': 'Биоэнергетический баланс',
    'onboarding.approaches.open': 'Открыт к персональным рекомендациям',
    ...
    'recommendations.kinesiology.description': 'Интегративная кинезиология для системной регуляции и точного выявления источника дисбаланса.',
    ...
    'pricing.plan.pack5.desc': 'Комплексный путь для глубоких изменений',
    ...
    'pricing.cta.unsure.subtitle': 'Пройдите нашу бесплатную оценку и узнайте, какой подход лучше всего подходит для ваших нужд',
    ...
    'personalized.officeWorkers.method.step1.title': "Постуральная Декомпрессия",
    'personalized.officeWorkers.method.step1.desc': "Мы сосредотачиваемся на фасциальных линиях, укороченных от сидения, раскрывая грудную клетку и снимая напряжение с шеи.",
    'personalized.officeWorkers.method.step2.title': "Перезагрузка Нервной Системы",
    'personalized.officeWorkers.method.step3.title': "Эргономичное Выравнивание",
    'personalized.officeWorkers.method.step3.desc': "Мы интегрируем простые соматические сигналы, чтобы помочь вам поддерживать нейтральное выравнивание без усилий в течение дня.",
    'personalized.officeWorkers.benefits.title': "Ключевые преимущества",
    'personalized.officeWorkers.benefit1': "Немедленное облегчение хронической боли в шее, плечах и пояснице.",
    'personalized.officeWorkers.benefit2': "Уменьшение головных болей напряжения и усталости глаз за счет краниального освобождения.",
    'personalized.officeWorkers.faq.title': "Частые вопросы",
    'personalized.officeWorkers.faq.q1': "У меня \"текстовая шея\". Может ли соматическая терапия исправить мою осанку?",
    'personalized.officeWorkers.faq.q2': "Подходит ли это для профилактики?",
    'personalized.officeWorkers.faq.q3': "Придется ли мне делать упражнения за столом?",
    'personalized.officeWorkers.faq.a3': "Мы предлагаем тонкие микродвижения, которые восстанавливают вашу нервную систему и осанку, не прерывая рабочий процесс.",
    'personalized.musicians.method.step1.title': "Инструментальный Анализ",
    'personalized.musicians.method.step1.desc': "Мы оцениваем уникальные биомеханические требования вашего инструмента, выявляя асимметричные паттерны.",
    'personalized.musicians.method.step2.title': "Освобождение Мелкой Моторики",
    'personalized.musicians.method.step2.desc': "Мы сосредотачиваемся на тонкой мускулатуре рук и кистей, а также на напряжении кора, которое ограничивает дыхание.",
    'personalized.musicians.benefits.title': "Ключевые преимущества",
    'personalized.musicians.benefit1': "Профилактика и восстановление при травмах от повторяющихся нагрузок (RSI) и тендините.",
    'personalized.musicians.benefit2': "Улучшение контроля дыхания и резонанса для духовиков и вокалистов.",
    'personalized.musicians.benefit3': "Большая плавность и снижение напряжения в игровой позе.",
    'personalized.musicians.faq.title': "Частые вопросы",
    'personalized.musicians.faq.q1': "Может ли это помочь при тендините или запястном туннельном синдроме?",
    'personalized.musicians.faq.q2': "Повлияют ли сеансы на мою технику?",
    'personalized.musicians.faq.a2': "Оно усовершенствует ее. Сняв ненужное напряжение, вы сможете играть с большей легкостью, скоростью и выносливостью.",
    'personalized.musicians.faq.q3': "Я играю на асимметричном инструменте. Как вы помогаете?",
    'personalized.musicians.faq.a3': "Мы сосредотачиваемся на устранении паттернов ротации, восстанавливая симметрию в вашей позе отдыха.",
    'personalized.athletes.method.title': "Наш протокол производительности",
    'personalized.athletes.method.step1.title': "Биомеханическая оценка",
    'personalized.athletes.method.step1.desc': "Мы анализируем ваши паттерны движений для выявления нервно-мышечной неэффективности и фасциальных ограничений.",
    'personalized.athletes.method.step2.title': "Стратегическое освобождение и активация",
    'personalized.athletes.method.step3.title': "Интеграция производительности",
    'personalized.athletes.method.step3.desc': "Мы переобучаем вашу нервную систему эффективным стратегиям движения, повышая мощность и сокращая время восстановления.",
    'personalized.athletes.benefits.title': "Ключевые преимущества",
    'personalized.athletes.benefit1': "Ускоренное время восстановления за счет улучшенного лимфодренажа и фасциального освобождения.",
    'personalized.athletes.benefit2': "Профилактика травм от перенапряжения за счет коррекции компенсаторных паттернов движения.",
    'personalized.athletes.benefit3': "Оптимизированная биомеханика, ведущая к большей взрывной мощности и выносливости.",
    'personalized.athletes.benefit4': "Большая проприоцептивная осознанность для лучшей координации и ловкости.",
    'personalized.athletes.faq.title': "Частые вопросы",
    'personalized.athletes.faq.a1': "В то время как спортивный массаж фокусируется на расслаблении мышц, соматическая терапия воздействует на контроль нервной системы над этими мышцами. Мы работаем с первопричиной.",
    'personalized.athletes.faq.a2': "Да. Хронические травмы часто сохраняются потому, что тело застряло в защитном паттерне. Наш подход помогает вашей нервной системе почувствовать себя достаточно безопасно, чтобы отключить эти механизмы.",
    'personalized.athletes.faq.q3': "Когда мне следует планировать сеанс относительно моих соревнований?",
    'personalized.athletes.faq.a3': 'Для глубокой проработки мы рекомендуем за 3-5 дней до важного мероприятия. Для регуляции и активации нервной системы идеально за 24-48 часов.',
    ...
    // Legal pages
    'legal.date': '15 ноября 2025 г.',
    'legal.cookie.toc.notice': 'Уведомление о здоровье',
    'legal.cookie.toc.what': 'Что такое файлы cookie',
    'legal.cookie.toc.types': 'Типы, которые мы используем',
    'legal.cookie.toc.manage': 'Управление cookie',
    'legal.wellness.notice.title': 'Уведомление о комплементарном оздоровлении',
    'legal.wellness.notice.body': 'Этот сайт представляет услуги комплементарного и альтернативного оздоровления. Ничто на этом сайте не является медицинской консультацией, диагнозом или лечением.',
    'legal.wellness.notice.warning': 'Всегда консультируйтесь со своим врачом перед принятием любых решений о здоровье.',
    'legal.wellness.notice.link': 'Полный юридический отказ от ответственности →',
    'legal.cookie.what.title': '1. Что такое файлы cookie (GDPR ст. 4(11))',
    'legal.cookie.what.body': 'Файлы cookie — это небольшие текстовые файлы, размещаемые на вашем устройстве при посещении нашего сайта. Они помогают нам обеспечить функциональный, безопасный и улучшенный пользовательский опыт.',
    'legal.cookie.types.title': '2. Файлы cookie, которые мы используем',
    'legal.cookie.essential.title': 'Основные файлы cookie',
    'legal.cookie.essential.desc': 'Необходимы для работы сайта. Не могут быть отключены. Используются для навигации, безопасности и процессов бронирования.',
    'legal.cookie.analytics.title': 'Аналитические файлы cookie',
    'legal.cookie.analytics.desc': 'Помогают нам понять, как посетители используют наш сайт (например, Google Analytics). Используются анонимно для улучшения контента и производительности.',
    'legal.cookie.preference.title': 'Файлы cookie предпочтений',
    'legal.cookie.preference.desc': 'Запоминают ваши настройки языка и региона, чтобы вам не приходилось выбирать их заново при каждом посещении.',
    'legal.cookie.alwaysActive': 'Всегда активны',
    'legal.cookie.optional': 'Необязательные',
    'legal.cookie.manage.title': '3. Управление файлами cookie',
    'legal.cookie.manage.body1': 'Вы можете управлять, ограничивать или удалять файлы cookie в любое время через настройки браузера. Отключение необязательных файлов cookie не повлияет на основную функциональность сайта.',
    'legal.cookie.manage.body2': 'Вы можете отозвать согласие, данное через наш баннер, в любое время, удалив файлы cookie браузера и повторно посетив сайт.',
    'legal.cookie.browser.title': 'Настройки cookie в браузере',
    'legal.cookie.browser.chrome': 'Chrome: Настройки → Конфиденциальность → Файлы cookie',
    'legal.cookie.browser.firefox': 'Firefox: Настройки → Приватность → Файлы cookie',
    'legal.cookie.browser.safari': 'Safari: Настройки → Конфиденциальность',
    'legal.cookie.browser.edge': 'Edge: Настройки → Конфиденциальность → Файлы cookie',
    'legal.cookie.contact.prefix': 'По вопросам обращайтесь:',
    'legal.gdpr.cookie': 'Данная Политика в отношении файлов cookie соответствует Регламенту (ЕС) 2016/679 (GDPR).',
    'legal.privacy.toc.disclaimer': 'Уведомление о здоровье',
    'legal.privacy.toc.controller': 'Контролёр данных',
    'legal.privacy.toc.data': 'Данные, которые мы собираем',
    'legal.privacy.toc.basis': 'Правовое основание',
    'legal.privacy.toc.rights': 'Ваши права',
    'legal.privacy.toc.contact': 'Контакт',
    'legal.privacy.warning.body': 'EKA Balance предлагает услуги комплементарного и альтернативного оздоровления. Наши услуги не являются медицинским диагнозом, медицинским лечением или заменой профессиональной медицинской помощи.',
    'legal.privacy.warning.stopMedication': 'Не прекращайте приём назначенных лекарств и не отказывайтесь от медицинского лечения на основании информации с этого сайта.',
    'legal.privacy.warning.emergency': 'Если вы переживаете медицинскую экстренную ситуацию, немедленно позвоните в службу скорой помощи (112 в Испании).',
    'legal.privacy.warning.noResponsibility': 'EKA Balance не несёт ответственности за последствия для здоровья, возникшие в результате действий, предпринятых без консультации с лицензированным врачом.',
    'legal.privacy.warning.link': 'Ознакомьтесь с нашим Полным юридическим отказом от ответственности для получения подробной информации.',
    'legal.privacy.dpo.title': 'Сотрудник по защите данных (DPO)',
    'legal.privacy.data.title': '1. Данные, которые мы собираем',
    'legal.privacy.data.intro': 'Мы собираем персональные данные, необходимые для предоставления наших оздоровительных услуг, включая:',
    'legal.privacy.data.personal.title': 'Персональная идентификация',
    'legal.privacy.data.personal.fullName': 'Полное имя',
    'legal.privacy.data.personal.email': 'Адрес электронной почты',
    'legal.privacy.data.personal.phone': 'Номер телефона',
    'legal.privacy.data.personal.address': 'Почтовый адрес',
    'legal.privacy.data.personal.dob': 'Дата рождения',
    'legal.privacy.data.wellness.title': 'Данные об оздоровлении и здоровье',
    'legal.privacy.data.wellness.item1': 'Заметки о физическом состоянии и самочувствии',
    'legal.privacy.data.wellness.item2': 'Показатели боли или дискомфорта',
    'legal.privacy.data.wellness.item3': 'История сеансов и предпочтения',
    'legal.privacy.data.wellness.item4': 'Заметки об эмоциональном состоянии (с согласия)',
    'legal.privacy.basis.title': '2. Правовое основание обработки (GDPR ст. 6)',
    'legal.privacy.basis.consent.title': 'Согласие (ст. 6(1)(a))',
    'legal.privacy.basis.consent.item1': 'Маркетинговые коммуникации',
    'legal.privacy.basis.consent.item2': 'Необязательные файлы cookie',
    'legal.privacy.basis.consent.item3': 'Оздоровительные данные с явного согласия',
    'legal.privacy.basis.contract.title': 'Договорная необходимость',
    'legal.privacy.basis.contract.item1': 'Предоставление забронированных услуг',
    'legal.privacy.basis.contract.item2': 'Обработка платежей',
    'legal.privacy.basis.contract.item3': 'Обслуживание клиентов',
    'legal.privacy.basis.legal.title': 'Юридические обязательства',
    'legal.privacy.basis.legal.item1': 'Налоговые и бухгалтерские требования',
    'legal.privacy.basis.legal.item2': 'Требования охраны здоровья и безопасности',
    'legal.privacy.basis.legal.item3': 'Правила хранения данных',
    'legal.privacy.basis.interest.title': 'Законные интересы',
    'legal.privacy.basis.interest.item1': 'Улучшение сервиса',
    'legal.privacy.basis.interest.item2': 'Предотвращение мошенничества',
    'legal.privacy.basis.interest.item3': 'Статистический анализ',
    'legal.privacy.rights.title': '3. Ваши права по GDPR (ст. 12–22)',
    'legal.privacy.right.access': 'Доступ (ст. 15)',
    'legal.privacy.right.access.desc': 'Запросите копию всех персональных данных, которые мы храним о вас. Мы отвечаем в течение 30 дней.',
    'legal.privacy.right.erasure': 'Удаление (ст. 17)',
    'legal.privacy.right.erasure.desc': 'Запросите удаление ваших данных, если для их хранения больше нет правового основания.',
    'legal.privacy.right.rectification': 'Исправление (ст. 16)',
    'legal.privacy.right.rectification.desc': 'Запросите исправление неточных или неполных персональных данных.',
    'legal.privacy.right.portability': 'Переносимость (ст. 20)',
    'legal.privacy.right.portability.desc': 'Получите ваши данные в структурированном, машиночитаемом формате.',
    'legal.privacy.right.objection': 'Возражение (ст. 21)',
    'legal.privacy.right.objection.desc': 'Возразите против обработки на основании законных интересов или для прямого маркетинга.',
    'legal.privacy.contact.authority.title': 'Надзорный орган',
    'legal.privacy.contact.authority.name': 'Агентство по защите данных Испании (AEPD)',
    'legal.gdpr.privacy': 'Данная Политика конфиденциальности соответствует Регламенту (ЕС) 2016/679 (GDPR).',
    'legal.terms.toc.disclaimer': 'Уведомление о здоровье',
    'legal.terms.toc.nature': 'Характер услуг',
    'legal.terms.toc.acceptance': 'Принятие условий',
    'legal.terms.toc.eligibility': 'Право на использование',
    'legal.terms.toc.limitations': 'Ограничения',
    'legal.terms.toc.contact': 'Контакт',
    'legal.terms.warning.body': 'EKA Balance предоставляет услуги комплементарного и альтернативного оздоровления. Эти услуги не являются медицинским лечением, диагнозом или заменой профессиональной медицинской помощи.',
    'legal.terms.warning.stopMedication': 'Не прекращайте, не сокращайте и не изменяйте назначенные лекарства или медицинское лечение на основании любого контента или сеанса, полученного в EKA Balance.',
    'legal.terms.warning.variability': 'Результаты комплементарной терапии варьируются от человека к человеку. Никакой конкретный результат не гарантируется.',
    'legal.terms.warning.noLiability': 'EKA Balance не принимает никакой ответственности за решения о здоровье, принятые без консультации с лицензированным врачом.',
    'legal.terms.warning.emergency': 'В любой медицинской экстренной ситуации немедленно позвоните по номеру 112.',
    'legal.terms.warning.link': 'Прочитайте Полный юридический отказ от ответственности.',
    'legal.terms.nature.title': '1. Характер услуг',
    'legal.terms.nature.intro': 'EKA Balance предоставляет услуги комплементарного и интегративного оздоровления, включая терапевтический массаж, кинезиологию, нутрициологическое руководство, соматическое образование и работу с телом. Эти услуги:',
    'legal.terms.nature.item1': 'Носят поддерживающий и образовательный характер',
    'legal.terms.nature.item2': 'Являются дополнительными — не первичной или медицинской помощью',
    'legal.terms.nature.item3': 'Не предназначены для диагностики, лечения, излечения или предотвращения каких-либо заболеваний или состояний',
    'legal.terms.nature.item4': 'Не заменяют профессиональную медицинскую, психиатрическую или психологическую помощь',
    'legal.terms.nature.important': 'Продолжайте следовать рекомендациям вашего врача. Услуги EKA Balance работают совместно с традиционной медициной, а не вместо неё.',
    'legal.terms.acceptance.title': '2. Принятие условий',
    'legal.terms.acceptance.body': 'Бронируя, получая доступ или используя услуги EKA Balance, вы подтверждаете, что прочитали, поняли и согласны с настоящими Условиями и нашей Политикой конфиденциальности.',
    'legal.terms.acceptance.intro': 'Ваше использование означает явное согласие на:',
    'legal.terms.acceptance.item1': 'Сбор и обработку персональных данных, как описано в нашей Политике конфиденциальности',
    'legal.terms.acceptance.item2': 'Использование файлов cookie, как описано в нашей Политике в отношении файлов cookie',
    'legal.terms.acceptance.item3': 'Характер услуг комплементарного оздоровления, как описано в настоящих Условиях',
    'legal.terms.eligibility.title': '3. Право на использование',
    'legal.terms.eligibility.intro': 'Используя наши услуги, вы подтверждаете, что:',
    'legal.terms.eligibility.item1': 'Вам не менее 18 лет, или у вас есть родительское согласие, если вам 16–18 лет',
    'legal.terms.eligibility.item2': 'Вы обладаете правоспособностью для заключения обязывающих соглашений',
    'legal.terms.eligibility.item3': 'Вы предоставите точную и полную информацию',
    'legal.terms.eligibility.item4': 'Вы будете соблюдать все применимые законы',
    'legal.terms.limitations.title': '4. Ограничение ответственности',
    'legal.terms.limitations.intro': 'EKA Balance и её терапевты не несут ответственности за какие-либо последствия для здоровья, прямые или косвенные, возникшие в результате:',
    'legal.terms.limitations.item1': 'Решений, принятых без консультации с лицензированным врачом',
    'legal.terms.limitations.item2': 'Прекращения или изменения назначенного медицинского лечения',
    'legal.terms.limitations.item3': 'Любых нераскрытых ранее существующих медицинских состояний',
    'legal.terms.limitations.item4': 'Индивидуальной вариабельности реакции на комплементарную терапию',
    'legal.terms.contact.title': '5. Контакт',
    'legal.terms.contact.legal': 'Юридические запросы',
    'legal.terms.contact.dpo': 'Сотрудник по защите данных',
    'legal.gdpr.terms': 'Настоящие Условия соответствуют применимому законодательству ЕС и Испании о защите прав потребителей и персональных данных.',
    'legal.disclaimer.subtitle': 'Прочитайте это перед бронированием или использованием любой услуги EKA Balance',
    'legal.disclaimer.what.title': 'Что такое EKA Balance',
    'legal.disclaimer.what.body1': 'EKA Balance предлагает услуги комплементарного и альтернативного оздоровления, включая холистический массаж, тренинг движения, нутрициологическое руководство, соматическую работу с телом и интегративные оздоровительные сеансы.',
    'legal.disclaimer.what.body2': 'Эти услуги разработаны для поддержки вашего общего самочувствия совместно с — а не вместо — традиционной медициной. Наши терапевты — обученные специалисты по оздоровлению, а не лицензированные врачи.',
    'legal.disclaimer.not.title': 'Чем EKA Balance не является',
    'legal.disclaimer.not.item1': 'EKA Balance не ставит медицинских диагнозов каких-либо заболеваний, расстройств или состояний.',
    'legal.disclaimer.not.item2': 'EKA Balance не предоставляет медицинского лечения, рецептов или излечения.',
    'legal.disclaimer.not.item3': 'Сеансы EKA Balance не заменяют консультации с вашим врачом, специалистом или лицензированным специалистом по психическому здоровью.',
    'legal.disclaimer.not.item4': 'Никакой контент на этом сайте не является медицинской консультацией.',
    'legal.disclaimer.not.item5': 'EKA Balance не претендует на лечение, излечение, профилактику или смягчение каких-либо медицинских состояний.',
    'legal.disclaimer.consult.title': 'Всегда сначала консультируйтесь с врачом',
    'legal.disclaimer.consult.intro': 'Перед началом любой услуги комплементарного или альтернативного оздоровления проконсультируйтесь с вашим лицензированным врачом, особенно если:',
    'legal.disclaimer.consult.item1': 'У вас есть ранее существующее состояние здоровья или продолжающаяся оздоровительная проблема',
    'legal.disclaimer.consult.item2': 'Вы принимаете назначенные лекарства',
    'legal.disclaimer.consult.item3': 'Вы беременны или кормите грудью',
    'legal.disclaimer.consult.item4': 'Вы недавно перенесли операцию или медицинскую процедуру',
    'legal.disclaimer.consult.item5': 'Вы испытываете стойкие, острые или необъяснимые физические проблемы',
    'legal.disclaimer.consult.item6': 'Вы находитесь под наблюдением специалиста (кардиолога, онколога, психиатра и т.д.)',
    'legal.disclaimer.consult.warning': 'Не прекращайте, не сокращайте и не изменяйте никакой назначенный план медицинской помощи на основании чего-либо полученного или прочитанного в EKA Balance.',
    'legal.disclaimer.liability.title': 'Ограничение ответственности',
    'legal.disclaimer.liability.intro': 'EKA Balance и её терапевты не принимают никакой медицинской или юридической ответственности за какие-либо последствия для здоровья — положительные или отрицательные — возникшие в результате:',
    'legal.disclaimer.liability.item1': 'Решений, принятых без предварительной консультации с лицензированным врачом',
    'legal.disclaimer.liability.item2': 'Любого изменения или прекращения назначенной медицинской помощи',
    'legal.disclaimer.liability.item3': 'Индивидуальной вариабельности реакции на комплементарные услуги',
    'legal.disclaimer.liability.item4': 'Ранее существующих состояний, не раскрытых до сеансов',
    'legal.disclaimer.liability.vary': 'Результаты услуг комплементарного оздоровления варьируются от человека к человеку. Никакой конкретный результат не гарантируется.',
    'legal.disclaimer.emergency.title': 'Медицинская экстренная ситуация',
    'legal.disclaimer.emergency.call': 'Если вы переживаете медицинскую экстренную ситуацию, немедленно позвоните в службу скорой помощи.',
    'legal.disclaimer.emergency.spain': 'Испания (ЕС)',
    'legal.disclaimer.emergency.general': 'Общая экстренная помощь',
    'legal.disclaimer.emergency.crisis': 'Кризисная линия (ES)',
    'legal.disclaimer.footer.law': 'Данное уведомление предоставляется в соответствии с испанским законодательством о защите прав потребителей (Real Decreto Legislativo 1/2007), Директивой ЕС 2011/83/EU о правах потребителей и применимыми профессиональными стандартами.',
    'legal.disclaimer.footer.confirm': 'Бронируя или используя любую услугу EKA Balance, вы подтверждаете, что прочитали и поняли данное уведомление.',
    'legal.disclaimer.links.terms': 'Условия обслуживания',
    'legal.disclaimer.links.privacy': 'Политика конфиденциальности',
    'legal.disclaimer.links.booking': 'Свяжитесь с нами и забронируйте',
  }
};

export function getDictionary(locale: Language) {
  return { ...guaranteedTranslations[locale], ...translations[locale] };
}
