...
var TranslationExtensions_1 = require("./TranslationExtensions");
var Revision360Translations_1 = require("./Revision360Translations");
var TechniqueTranslations_1 = require("./TechniqueTranslations");
var AgenyzTranslations_1 = require("./AgenyzTranslations");
var BentoTranslations_1 = require("./BentoTranslations");
...
var getInitialLanguage = function () {
    if (typeof window !== 'undefined') {
        var saved = localStorage.getItem('eka-language');
...
function LanguageProvider(_a) {
    ...
    var _b = (0, react_1.useState)('en'), language = _b[0], setLanguageState = _b[1];
    var _c = (0, react_1.useState)(false), showLanguagePopup = _c[0], setShowLanguagePopup = _c[1];
    var _d = (0, react_1.useState)(false), languageConfirmed = _d[0], setLanguageConfirmed = _d[1];
    ...
    var t = function (key, params) {
        ...
        var text = ((_a = guaranteedTranslations[language]) === null || _a === void 0 ? void 0 : _a[key]) ||
            ((_b = guaranteedTranslations.en) === null || _b === void 0 ? void 0 : _b[key]) ||
            ((_c = translations[language]) === null || _c === void 0 ? void 0 : _c[key]) ||
            ((_d = TranslationExtensions_1.servicesTranslations[language]) === null || _d === void 0 ? void 0 : _d[key]) ||
            ((_e = Revision360Translations_1.revision360Translations[language]) === null || _e === void 0 ? void 0 : _e[key]) ||
            ((_f = TechniqueTranslations_1.techniqueTranslations[language]) === null || _f === void 0 ? void 0 : _f[key]) ||
            ((_g = AgenyzTranslations_1.agenyzTranslations[language]) === null || _g === void 0 ? void 0 : _g[key]) ||
            ((_h = BentoTranslations_1.bentoTranslations[language]) === null || _h === void 0 ? void 0 : _h[key]) ||
            ((_j = translations.en) === null || _j === void 0 ? void 0 : _j[key]) ||
            ((_k = TranslationExtensions_1.servicesTranslations.en) === null || _k === void 0 ? void 0 : _k[key]) ||
            ((_l = Revision360Translations_1.revision360Translations.en) === null || _l === void 0 ? void 0 : _l[key]) ||
            ((_m = TechniqueTranslations_1.techniqueTranslations.en) === null || _m === void 0 ? void 0 : _m[key]) ||
            ((_o = AgenyzTranslations_1.agenyzTranslations.en) === null || _o === void 0 ? void 0 : _o[key]) ||
            ((_p = BentoTranslations_1.bentoTranslations.en) === null || _p === void 0 ? void 0 : _p[key]) ||
            key;
        if (params) {
    ...
    return (react_1.default.createElement(LanguageContext.Provider, { value: {
            language: language,
...
exports.translations = translations; exports.guaranteedTranslations = guaranteedTranslations;
