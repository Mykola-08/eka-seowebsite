      ...
      <div className="relative z-10 text-center text-white px-6 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/first-time" className="group" onClick={() => logEvent('hero_first_time_click')}>
            <Button size="xl" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-2xl font-medium transition-all duration-200 ease-out-quart hover:scale-105 shadow-xl normal-case">
              {t('hero.firstTime')}
            </Button>
          </Link>

          <Link href="/services" className="group" onClick={() => logEvent('hero_services_click')}>
            <Button size="xl" className="bg-[#FFB405] hover:bg-[#e8a204] text-[#000035] px-8 py-4 rounded-2xl font-medium transition-all duration-200 ease-out-quart hover:scale-105 shadow-xl normal-case">
