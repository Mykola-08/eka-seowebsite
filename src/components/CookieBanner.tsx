    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-60 p-4 pb-24 md:pb-6 md:p-6 md:left-auto md:right-6 md:w-md"
          data-testid="cookie-banner"
        >
          <div
            className="bg-background/95 backdrop-blur-xl border border-border/60 rounded-3xl overflow-hidden pointer-events-auto"
