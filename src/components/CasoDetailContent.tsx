  ...
  const Hero = (
     <div className="relative pt-32 pb-24 bg-secondary">
        <div className="section-container text-center max-w-4xl mx-auto">
          ...
          <div className={`w-24 h-24 mx-auto rounded-apple ${accentColorClass} flex items-center justify-center mb-8 `}>
        ...
        <div className="section-container max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
            ...
            <div>
              ...
              <ul className="space-y-4">
                {concerns.map((item, idx) => (
                  <li key={idx} className="p-6 rounded-apple bg-muted/40">
            ...
            <div>
              ...
              <ul className="space-y-4">
                {causes.map((item, idx) => (
                  <li key={idx} className="p-6 rounded-apple bg-card border border-border">
          ...
          <div className="bg-foreground rounded-apple p-8 md:p-16 text-primary-foreground relative overflow-hidden">
