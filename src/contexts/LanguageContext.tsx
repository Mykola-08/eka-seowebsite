...
const guaranteedTranslations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'services.disclaimerBody': 'Aquest contingut es informatiu. Els nostres mètodes son complementaris i no substitueixen atencio medica o psicologica.',
...
const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'elena.role': 'Especialista en integració somÃ tica i kinesiologia',
    ...
    'elena.description1': "Explora un enfocament únic que uneix la ciència moderna amb la saviesa somÃ tica ancestral.",
    ...
    'elena.approach.desc': 'Al nucli del meu treball hi ha una profunda comprensió que el cos, el cervell i les emocions són un sistema unificat. No tracto símptomes, sinó que busco la seva causa arrel, ajudant l\'organisme a restaurar la seva capacitat natural d\'autoregulació. El meu mètode combina tècniques avançades de treball amb el cos i el sistema nerviós: Movement Lesson, JKA (Jeremy Krauss Approach), Child’Space, Feldenkrais i BiodinÃ mica. És una influència suau però poderosa que reentrena el sistema nerviós, allibera tensions profundes i restaura la facilitat de moviment i la claredat mental.',

    'elena.target.adults.title': 'Adults',
    'elena.target.adults.desc': 'Per a aquells que senten fatiga crònica, mal d\'esquena o coll, o els efectes de l\'estrès i el trauma. T\'ajudo a restaurar el teu estat de recursos, millorar la postura, alliberar bloquejos psicosomÃ tics i recuperar la lleugeresa en moure\'t. No és només un massatge o una terÃ pia; és un reinici del teu sistema nerviós per elevar la teva qualitat de vida.',
    ...
    'hero.subtitle': 'Restaura la teva vitalitat sistèmica. Centre de referència en terÃ pies somÃ tiques i regulació del sistema nerviós a Barcelona. Integració clínica i benestar profund.',
    ...
    'about.role': 'Especialista en integració somÃ tica i kinesiologia',
    'about.description1': 'Amb més de 15 anys de prÃ ctica clínica, he perfeccionat un mètode que va més enllÃ  del tractament convencional. La meva missió és descodificar el llenguatge del teu cos per desbloquejar la seva capacitat innata de regeneració.',
    'about.description2': 'Fusiono la precisió de la neurociència aplicada amb la profunditat de les terÃ pies manuals. Cada sessió és una intervenció estratègica en el teu sistema nerviós per desactivar patrons de dolor i restaurar l\'equilibri vital.',
    ...
    // Service: Massage
    'massage.title': 'TerÃ pia manual avançada',
    ...
    'problems.subtitle': 'Abordatge clínic de les disfuncions més comunes mitjançant protocols d\'integració somÃ tica.',
    ...
    'problems.stress.desc': 'Hiperactivació simpÃ tica, ansietat sistèmica i alteració del cicle de son.',
    ...
    'problems.injuries.desc': 'Limitacions biomecÃ niques que comprometen el rendiment atlètic.',
    ...
    'casos.problems.backPain.symptom4': 'Sensació de cÃ rrega o pesadesa a les espatlles, trapezi i base del crani.',
    'casos.problems.backPain.cause1': 'Postures mantingudes, ergonomia deficient i hÃ bits posturals compensatoris.',
    'casos.problems.backPain.cause2': 'CÃ rrega emocional somatitzada (estrès, ansietat) que es manifesta com a tensió muscular.',
    ...
    'casos.problems.stress.cause1': 'SobrecÃ rrega de responsabilitats, pressió laboral o familiar i falta de límits.',
    ...
    // Digestive
    'casos.problems.digestive.symptom1': 'Malestar digestiu: inflor, gasos, acidesa, reflux o pesadesa després dels Ã pats.',
    ...
    'casos.problems.digestive.symptom4': 'Relació conflictiva amb el menjar o sospita d\'intolerÃ ncies.',
    'casos.problems.digestive.cause1': 'IntolerÃ ncies o sensibilitats alimentÃ ries no diagnosticades.',
    'casos.problems.digestive.cause2': 'HÃ bits alimentaris inadequats: menjar rÃ pid, amb estrès o a deshores.',
    ...
    // Migraines
    'casos.problems.migraines.symptom1': 'Dolor pulsÃ til intens, sovint unilateral, que pot afectar la visió.',
    'casos.problems.migraines.symptom2': 'Sensació de pressió al cap,"casc" o tensió ocular.',
    'casos.problems.migraines.symptom3': 'Símptomes associats: nÃ usees, vòmits o inestabilitat.',
    ...
    'casos.problems.migraines.cause3': 'SobrecÃ rrega mental, estrès visual o falta de descans real.',
    'casos.problems.migraines.cause4': 'Factors metabòlics: desequilibris hormonals, histamina o toxicitat hepÃ tica.',
    'casos.problems.migraines.treatment': 'TerÃ pia manual cranial (Osteobalance), alliberament de la tensió cervical i mandibular, i regulació del sistema nerviós i hormonal amb kinesiologia.',
    'casos.problems.migraines.results': 'Reducció drÃ stica de la freqüència i intensitat de les crisis. En molts casos, desaparició total del dolor. Major claredat mental i benestar.',
    ...
    // Discovery New Keys
    'discovery.step.description.minChars': 'carÃ cters mínim',
    ...
    'casos.problems.sleep.cause4': 'Causes orgÃ niques: digestions pesades, dolor crònic o desequilibris hormonals.',
    ...
    'casos.problems.sleep.results': 'Son profund, continu i reparador. Despertar-se amb energia i sensació de descans real. Millora de l\'estat d\'Ã nim i la salut global.',
    ...
    'casos.additionalProblems.carpalTunnel': 'Síndrome del túnel carpiÃ ',
    ...
    'testimonials.externalReviews': 'Pots llegir més valoracions a les nostres pÃ gines externes',
    ...
    // SEO
    'seo.home.title': 'EKA Balance - centre de terÃ pies holístiques a Barcelona | massatge & kinesiologia',
    ...
    'seo.home.keywords': 'Massatge terapèutic Barcelona, kinesiologia Barcelona, Osteobalance, centre terÃ pies holístiques, benestar integral, relaxació Barcelona, plaça universitat',
    'seo.contact.title': 'Contacte - EKA Balance | centre de terÃ pies holístiques a Barcelona',
    ...
    'seo.contact.keywords': 'Contacte EKA Balance, reserves massatge Barcelona, terÃ pies holístiques Rubí, centre benestar Barcelona',
    'seo.services.title': 'Serveis de terÃ pies holístiques a Barcelona | EKA Balance',
    ...
    'seo.services.keywords': 'Serveis terapèutics Barcelona, massatge, kinesiologia, nutrició, revisió integral, terÃ pies holístiques',
    'seo.personalized.title': 'Serveis personalitzats - EKA Balance Barcelona',
    'seo.personalized.description': 'Tria el servei que més s\'adapta a tu: treballadors d\'oficina, esportistes, artistes, músics i estudiants. Cuida el teu cos amb terÃ pies personalitzades.',
    ...
    'seo.students.title': 'TerÃ pies per a estudiants - gestió de l\'Estrès i Concentració | EKA Balance',
    ...
    'seo.students.keywords': 'TerÃ pies estudiants, estrès estudis, concentració, ansietat acadèmica, kinesiologia estudiants, massatge relaxant Barcelona',
    ...
    'seo.musicians.title': 'TerÃ pies per a músics - expressió corporal i flow musical | EKA Balance',
    ...
    'seo.musicians.keywords': 'TerÃ pies músics, expressió corporal, ansietat escènica, flow musical, Feldenkrais músics, kinesiologia performance Barcelona',

    'seo.athletes.title': 'TerÃ pies per a esportistes - recuperació i rendiment | EKA Balance',
    ...
    'seo.nutrition.keywords': 'Nutrició Barcelona, assessorament nutricional, hÃ bits alimentaris, energia, gestió pes, salut alimentÃ ria',
    ...
    'discovery.userTypes.woman.desc': 'Harmonització del cicle i reconnexió somÃ tica.',
    ...
    'discovery.userTypes.athlete.desc': 'Optimització biomecÃ nica i recuperació activa.',
    ...
    'discovery.recommendation.emotional.desc': 'TerÃ pia holística per gestionar estrès, ansietat o tristesa. Se centra a superar problemes emocionals i recuperar harmonia i felicitat.',
    ...
    'discovery.diagnosis.cause.stress': 'Tensió psicosomÃ tica',
    ...
    'office.seo.desc': 'TerÃ pies especialitzades per a treballadors d\'oficina: alleuja tensions, millora postura i gestiona l\'estrès laboral. Sessions d\'1 hora per 70â‚¬.',
    ...
    'athletes.seo.desc': 'TerÃ pies especialitzades per esportistes: recuperació muscular, millora de flexibilitat i gestió d\'estrès pre-competició. Sessions d\'1 hora per 70â‚¬.',
    ...
    'musicians.seo.desc': 'TerÃ pies especialitzades per a músics: prevenció de lesions, millora tècnica i gestió de l\'ansietat escènica. Sessions d\'1 hora per 70â‚¬.',
    'musicians.seo.keywords': 'FisioterÃ pia músics Barcelona, lesions músics, ansietat escènica, tècnica musical',

    // Students SEO
    'students.seo.title': 'Serveis per a estudiants - EKA Balance Barcelona',
    'students.seo.desc': 'TerÃ pies per a estudiants: gestió de l\'estrès d\'exÃ mens, millora de la concentració i correcció postural. Sessions d\'1 hora per 70â‚¬.',
    'students.seo.keywords': 'Estrès exÃ mens Barcelona, concentració estudi, postura estudiants, ansietat acadèmica',
    ...
    'contact.faq.q3.answer': 'Sí, tenim plans VIP amb descomptes de fins al 25% i avantatges exclusius com reserves prioritÃ ries i consultes telefòniques gratuïtes.',
    ...
    'personalizedServices.special.list1': 'Precisió biomecÃ nica',
    ...
    'personalizedServices.officeWorkers.result': 'MÃ xima productivitat sense desgast físic.',
    'personalizedServices.athletes': 'Esportistes d\'elit',
    'personalizedServices.athletes.desc': 'Optimització biomecÃ nica, prevenció de lesions i recuperació accelerada per a un rendiment superior.',
    ...
    'personalizedServices.students.benefit3': 'Regulació del son i l\'ansietat abans d\'exÃ mens.',
    'personalizedServices.students.result': 'Ment desperta en un cos relaxat.',

    // Booking page
    'booking.title': 'Sol·licita la teva sessió - EKA Balance',
    'booking.description': 'Gestiona la teva cita de benestar a Barcelona amb facilitat. Atenció personalitzada i resposta prioritÃ ria via WhatsApp.',
    'booking.badge': 'Gestió de cites simplificada',
    'booking.hero.title': 'Inicia el teu procés de recuperació',
    'booking.hero.subtitle': 'Un sistema Ã gil dissenyat per connectar-te immediatament amb la solució que necessites.',
    ...
    'athletes.result.desc': 'Recuperació més rÃ pida, millor rendiment i menys lesions',
    ...
    'musicians.hero.subtitle': 'TerÃ pies especialitzades per músics: mans, braços, postura i tècnica',
    ...
    'musicians.problem1.desc': 'Dolor a mans, canells i avantbraços per la prÃ ctica intensiva',
    ...
    'students.challenge1.title': 'Estrès d\'exÃ mens',
    ...
    'students.help1.desc': 'Tècniques de relaxació per reduir l\'ansietat d\'exÃ mens',
    ...
    'faq.q5.answer': 'Sí, pots cancel·lar o reprogramar amb 24 hores d\'antelació sense cap cÃ rrec addicional.',

    // First Time Visitor Form
    'firstTime.seo.title': 'No saps què triar? - Troba el teu servei ideal a EKA Balance',
    'firstTime.seo.desc': 'Sistema personalitzat intel·ligent per descobrir el servei de terÃ pia holística perfecte per a les teves necessitats específiques. Recomanacions empÃ tiques basades en qui ets i què busques.',
    'firstTime.seo.keywords': 'No sé què triar, formulari personalitzat, recomanacions terÃ pia, servei ideal, Barcelona, onboarding intel·ligent',
    ...
    'form.userType.generalDesc': 'Cap de les anteriors o combinació de vÃ ries',
    ...
    'form.step4.question': 'Quina experiència tens amb terÃ pies corporals?',
    ...
    'form.recommendation.officeWorker.desc': 'TerÃ pia especialitzada per alleujar tensions del treball sedentari, millorar la postura i reduir l\'estrès laboral',
    ...
    'form.recommendation.musician.desc': 'TerÃ pia especialitzada per a músics: prevenció de lesions, millora de la tècnica i gestió de l\'ansietat escènica',
    ...
    'form.recommendation.student.benefit1': 'Redueix estrès d\'exÃ mens',
    ...
    'form.recommendation.kinesiology.desc': 'TerÃ pia que combina tècniques corporals i emocionals per reequilibrar el teu estat general',
    ...
    'onboarding.results.title': 'La teva experiència personalitzada estÃ  llesta',
    ...
    'onboarding.goals.bodyAwareness': 'Integració somÃ tica i consciència corporal',
    ...
    'onboarding.feelings.confident': 'Seguretat somÃ tica i presència plena',
    ...
    'recommendations.massage.description': 'TerÃ pia manual avançada per a la restauració estructural i l\'alleujament profund de la tensió acumulada.',
    ...
    'recommendations.feldenkrais.description': 'Reeducació neuromuscular Feldenkrais per a l\'optimització biomecÃ nica i l\'alliberament de patrons restrictius.',
    ...
    'personalized.students.services.kinesiologyStress.description': 'TerÃ pia específica per equilibrar el sistema nerviós i gestionar l\'ansietat d\'exÃ mens.',
    ...
    'personalized.students.testimonial.quote': 'Després de les sessions amb Elena, puc estudiar durant més hores sense tenir dolor d\'esquena i em sento molt més relaxada durant els exÃ mens.',
    ...
    'personalized.officeWorkers.testimonial.quote': 'Treballava 8 hores diÃ ries amb dolor constant al coll. Després del tractament amb Elena, puc treballar còmodament i tinc més energia al final del dia.',
    ...
    'personalized.musicians.services.kinesiologyPerformance.description': 'TerÃ pia per gestionar l\'ansietat abans de les actuacions i millorar la confiança escènica.',
    ...
    'personalized.athletes.testimonial.quote': 'Des que vaig començar les sessions, la meva recuperació és molt més rÃ pida i puc entrenar amb més intensitat sense por a lesionar-me.',
    ...
    'personalized.parents.services.emotionalKinesiology.description': 'TerÃ pia específica per gestionar l\'estrès familiar i recuperar l\'equilibri emocional.',
    ...
    'cookies.description': 'Utilitzem cookies essencials per a la funcionalitat del lloc web i analítiques anònimes per millorar els nostres serveis. No utilitzem cookies publicitÃ ries ni de seguiment. En continuar utilitzant el nostre lloc, acceptes l\'ús de cookies.',
    ...
    'vip.hero.title.beyond': 'Més enllÃ ',
    ...
    'vip.plans.subtitle': 'Cada pla estÃ  meticulosament dissenyat per oferir una experiència inoblidable.',
    ...
    'vip.plan.platinum.desc': 'La mÃ xima expressió de l\'exclusivitat i el servei personalitzat.',
    ...
    'whyChoose.subtitle': 'Som més que un centre de terÃ pia; som els teus socis dedicats en el benestar holístic.',
    'whyChoose.personalized.title': 'Plans veritablement personalitzats',
    'whyChoose.personalized.description': 'El teu cos és únic, i la teva terÃ pia també ho hauria de ser. Adaptem cada sessió a la teva fisiologia i història específiques per obtenir resultats més rÃ pids i sostenibles.',
    ...
    'pricing.guarantee.satisfaction.desc': 'Si no estÃ s satisfet amb la primera sessió, te la reemborsen',
    ...
    'pricing.guarantee.equipment.desc': 'Utilitzem només equip i productes de mÃ xima qualitat',
    ...
    'booking.whatsapp.preference': 'Preferència horÃ ria',
  ...
  es: {
    ...
    'discovery.budget.standard.title': 'Estándar (60-90â‚¬)',
    ...
    'office.seo.desc': 'Terapias especializadas para oficinistas: alivia la tensión, mejora la postura y gestiona el estrés laboral. Sesiones de 1 hora por 70â‚¬.',
    ...
    'athletes.seo.desc': 'Terapias especializadas para atletas: recuperación muscular, mejora de flexibilidad y gestión del estrés pre-competición. Sesiones de 1 hora por 70â‚¬.',
    ...
    'musicians.seo.desc': 'Terapias especializadas para músicos: prevención de lesiones, mejora técnica y gestión de ansiedad escénica. Sesiones de 1 hora por 70â‚¬.',
    ...
    'students.seo.desc': 'Terapias para estudiantes: gestión de estrés de exámenes, mejora de concentración y corrección postural. Sesiones de 1 hora por 70â‚¬.',
  ...
  ru: {
    ...
    'elena.approach.desc': 'Ð’ Ð¾ÑÐ½Ð¾Ð²Ðµ Ð¼Ð¾ÐµÐ¹ Ñ€Ð°Ð±Ð¾Ñ‚Ñ‹ Ð»ÐµÐ¶Ð¸Ñ‚ Ð³Ð»ÑƒÐ±Ð¾ÐºÐ¾Ðµ Ð¿Ð¾Ð½Ð¸Ð¼Ð°Ð½Ð¸Ðµ Ñ‚Ð¾Ð³Ð¾, Ñ‡Ñ‚Ð¾ Ñ‚ÐµÐ»Ð¾, Ð¼Ð¾Ð·Ð³ Ð¸ ÑÐ¼Ð¾Ñ†Ð¸Ð¸ — ÑÑ‚Ð¾ ÐµÐ´Ð¸Ð½Ð°Ñ ÑÐ¸ÑÑ‚ÐµÐ¼Ð°. Ð¯ Ñ€Ð°Ð±Ð¾Ñ‚Ð°ÑŽ Ð½Ðµ Ñ ÑÐ¸Ð¼Ð¿Ñ‚Ð¾Ð¼Ð°Ð¼Ð¸, Ð° Ð¸Ñ‰Ñƒ Ð¸Ñ… Ð¿ÐµÑ€Ð²Ð¾Ð¿Ñ€Ð¸Ñ‡Ð¸Ð½Ñƒ, Ð¿Ð¾Ð¼Ð¾Ð³Ð°Ñ Ð¾Ñ€Ð³Ð°Ð½Ð¸Ð·Ð¼Ñƒ Ð²Ð¾ÑÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ ÐµÑÑ‚ÐµÑÑ‚Ð²ÐµÐ½Ð½ÑƒÑŽ ÑÐ¿Ð¾ÑÐ¾Ð±Ð½Ð¾ÑÑ‚ÑŒ Ðº ÑÐ°Ð¼Ð¾Ñ€ÐµÐ³ÑƒÐ»ÑÑ†Ð¸Ð¸. ÐœÐ¾Ð¹ Ð¼ÐµÑ‚Ð¾Ð´ Ð¾Ð±ÑŠÐµÐ´Ð¸Ð½ÑÐµÑ‚ Ð¿ÐµÑ€ÐµÐ´Ð¾Ð²Ñ‹Ðµ Ñ‚ÐµÑ…Ð½Ð¸ÐºÐ¸ Ñ€Ð°Ð±Ð¾Ñ‚Ñ‹ Ñ Ñ‚ÐµÐ»Ð¾Ð¼ Ð¸ Ð½ÐµÑ€Ð²Ð½Ð¾Ð¹ ÑÐ¸ÑÑ‚ÐµÐ¼Ð¾Ð¹: Movement Lesson, JKA (Jeremy Krauss Approach), child’space, Feldenkrais Ð¸ Ð±Ð¸Ð¾Ð´Ð¸Ð½Ð°Ð¼Ð¸ÐºÑƒ. Ð­Ñ‚Ð¾ Ð¼ÑÐ³ÐºÐ¾Ðµ, Ð½Ð¾ Ð¼Ð¾Ñ‰Ð½Ð¾Ðµ Ð²Ð¾Ð·Ð´ÐµÐ¹ÑÑ‚Ð²Ð¸Ðµ, ÐºÐ¾Ñ‚Ð¾Ñ€Ð¾Ðµ Ð¿ÐµÑ€ÐµÐ¾Ð±ÑƒÑ‡Ð°ÐµÑ‚ Ð½ÐµÑ€Ð²Ð½ÑƒÑŽ ÑÐ¸ÑÑ‚ÐµÐ¼Ñƒ, ÑÐ½Ð¸Ð¼Ð°ÐµÑ‚ Ð³Ð»ÑƒÐ±Ð¸Ð½Ð½Ñ‹Ðµ Ð½Ð°Ð¿Ñ€ÑÐ¶ÐµÐ½Ð¸Ñ Ð¸ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‰Ð°ÐµÑ‚ Ð»ÐµÐ³ÐºÐ¾ÑÑ‚ÑŒ Ð´Ð²Ð¸Ð¶ÐµÐ½Ð¸Ñ Ð¸ ÑÑÐ½Ð¾ÑÑ‚ÑŒ ÑƒÐ¼Ð°.',
    ...
    'services.kinesiology.description': 'Ð’Ð°ÑˆÐµ Ñ‚ÐµÐ»Ð¾ Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ Ð¾Ñ‚Ð²ÐµÑ‚Ñ‹. Ð¡ Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒÑŽ Ñ‚Ð¾Ñ‡Ð½Ð¾Ð³Ð¾ Ð¼Ñ‹ÑˆÐµÑ‡Ð½Ð¾Ð³Ð¾ Ñ‚ÐµÑÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ Ð¼Ñ‹ Ð½Ð°Ñ…Ð¾Ð´Ð¸Ð¼ ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ðµ Ð¸ÑÑ‚Ð¾Ñ‡Ð½Ð¸ÐºÐ¸ Ð´Ð¸ÑÐ±Ð°Ð»Ð°Ð½ÑÐ° — Ð±ÑƒÐ´ÑŒ Ñ‚Ð¾ Ñ„Ð¸Ð·Ð¸Ñ‡ÐµÑÐºÐ°Ñ Ñ‚Ñ€Ð°Ð²Ð¼Ð°, ÑÐ¼Ð¾Ñ†Ð¸Ð¾Ð½Ð°Ð»ÑŒÐ½Ñ‹Ð¹ ÑÑ‚Ñ€ÐµÑÑ Ð¸Ð»Ð¸ Ð±Ð¸Ð¾Ñ…Ð¸Ð¼Ð¸Ñ‡ÐµÑÐºÐ¸Ðµ Ð¿Ð¾Ñ‚Ñ€ÐµÐ±Ð½Ð¾ÑÑ‚Ð¸. ÐšÐ¸Ð½ÐµÐ·Ð¸Ð¾Ð»Ð¾Ð³Ð¸Ñ — ÑÑ‚Ð¾ ÐºÐ»ÑŽÑ‡ Ðº Ð¿Ð¾Ð½Ð¸Ð¼Ð°Ð½Ð¸ÑŽ Ñ‚Ð¾Ð³Ð¾, Ñ‡Ñ‚Ð¾ Ð¸Ð¼ÐµÐ½Ð½Ð¾ Ð½ÑƒÐ¶Ð½Ð¾ Ð²Ð°ÑˆÐµÐ¹ ÑÐ¸ÑÑ‚ÐµÐ¼Ðµ Ð¿Ñ€ÑÐ¼Ð¾ ÑÐµÐ¹Ñ‡Ð°Ñ Ð´Ð»Ñ Ð¸ÑÑ†ÐµÐ»ÐµÐ½Ð¸Ñ.',
    ...
    'services.nutrition.description': 'ÐŸÐ¸Ñ‚Ð°Ð½Ð¸Ðµ — ÑÑ‚Ð¾ Ð±Ð¸Ð¾Ñ…Ð¸Ð¼Ð¸Ñ, Ð° Ð½Ðµ Ð¿Ñ€Ð¾ÑÑ‚Ð¾ ÐºÐ°Ð»Ð¾Ñ€Ð¸Ð¸. ÐœÑ‹ Ñ€Ð°Ð·Ñ€Ð°Ð±Ð°Ñ‚Ñ‹Ð²Ð°ÐµÐ¼ Ð¿ÐµÑ€ÑÐ¾Ð½Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð¿Ð»Ð°Ð½Ñ‹ Ð´Ð»Ñ Ð¾Ð¿Ñ‚Ð¸Ð¼Ð¸Ð·Ð°Ñ†Ð¸Ð¸ Ð²Ð°ÑˆÐµÐ¹ ÑÐ½ÐµÑ€Ð³Ð¸Ð¸, Ð¾Ð·Ð´Ð¾Ñ€Ð¾Ð²Ð»ÐµÐ½Ð¸Ñ ÐºÐ¸ÑˆÐµÑ‡Ð½Ð¸ÐºÐ° Ð¸ Ð¿Ð¾Ð´Ð´ÐµÑ€Ð¶ÐºÐ¸ Ð½ÐµÑ€Ð²Ð½Ð¾Ð¹ ÑÐ¸ÑÑ‚ÐµÐ¼Ñ‹.',
    ...
    'elena.quote': "Ð¢ÐµÐ»Ð¾ Ð¾Ð±Ð»Ð°Ð´Ð°ÐµÑ‚ Ð²Ñ€Ð¾Ð¶Ð´ÐµÐ½Ð½Ð¾Ð¹ ÑÐ¿Ð¾ÑÐ¾Ð±Ð½Ð¾ÑÑ‚ÑŒÑŽ Ð¸ÑÑ†ÐµÐ»ÑÑ‚ÑŒ ÑÐµÐ±Ñ; Ð¼Ð¾Ñ Ð·Ð°Ð´Ð°Ñ‡Ð° — Ð½Ð°Ð¿Ð¾Ð¼Ð½Ð¸Ñ‚ÑŒ ÐµÐ¼Ñƒ, ÐºÐ°Ðº ÑÑ‚Ð¾ Ð´ÐµÐ»Ð°Ñ‚ÑŒ.",
    ...
    'casos.description': 'Ð¡Ð¸Ð¼Ð¿Ñ‚Ð¾Ð¼Ñ‹, Ñ‚Ð°ÐºÐ¸Ðµ ÐºÐ°Ðº Ð±Ð¾Ð»ÑŒ, ÑƒÑÑ‚Ð°Ð»Ð¾ÑÑ‚ÑŒ Ð¸Ð»Ð¸ Ð½Ð°Ð¿Ñ€ÑÐ¶ÐµÐ½Ð¸Ðµ, Ñ‡Ð°ÑÑ‚Ð¾ ÑÐ²Ð»ÑÑŽÑ‚ÑÑ Ð»Ð¸ÑˆÑŒ Ð²ÐµÑ€Ñ…ÑƒÑˆÐºÐ¾Ð¹ Ð°Ð¹ÑÐ±ÐµÑ€Ð³Ð° — ÑÐ¸Ð³Ð½Ð°Ð»Ð°Ð¼Ð¸ ÑÐ¸ÑÑ‚ÐµÐ¼Ñ‹, Ð¸Ñ‰ÑƒÑ‰ÐµÐ¹ Ñ€Ð°Ð²Ð½Ð¾Ð²ÐµÑÐ¸Ñ. Ð’ EKA Balance Ð¼Ñ‹ Ð½Ðµ Ð·Ð°Ð³Ð»ÑƒÑˆÐ°ÐµÐ¼ ÑÑ‚Ð¸ ÑÐ¸Ð³Ð½Ð°Ð»Ñ‹, Ð¼Ñ‹ Ð¸Ñ… Ñ€Ð°ÑÑˆÐ¸Ñ„Ñ€Ð¾Ð²Ñ‹Ð²Ð°ÐµÐ¼. Ð£ÑÑ‚Ñ€Ð°Ð½ÑÑ Ð¿ÐµÑ€Ð²Ð¾Ð¿Ñ€Ð¸Ñ‡Ð¸Ð½Ñƒ, Ð¼Ñ‹ Ð¿Ð¾Ð¼Ð¾Ð³Ð»Ð¸ ÑÐ¾Ñ‚Ð½ÑÐ¼ ÐºÐ»Ð¸ÐµÐ½Ñ‚Ð¾Ð² Ñ‚Ñ€Ð°Ð½ÑÑ„Ð¾Ñ€Ð¼Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ ÑÐ²Ð¾Ð¸ Ð¾Ñ‚Ð½Ð¾ÑˆÐµÐ½Ð¸Ñ Ñ Ñ‚ÐµÐ»Ð¾Ð¼. Ð˜Ð·ÑƒÑ‡Ð¸Ñ‚Ðµ ÑÑ‚Ð¸ Ð¸ÑÑ‚Ð¾Ñ€Ð¸Ð¸, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð¿Ð¾Ð½ÑÑ‚ÑŒ, Ñ‡Ñ‚Ð¾ Ð²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ Ð´Ð»Ñ Ð²Ð°Ñ.',
    ...
    'casos.problems.digestive.description': 'ÐšÐ¾Ð³Ð´Ð° Ð¿Ð¸Ñ‰ÐµÐ²Ð°Ñ€Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð°Ñ ÑÐ¸ÑÑ‚ÐµÐ¼Ð° Ð±Ð»Ð¾ÐºÐ¸Ñ€ÑƒÐµÑ‚ÑÑ, Ñ‚Ñ€ÑƒÐ´Ð½Ð¾ Ð¿ÐµÑ€ÐµÐ²Ð°Ñ€Ð¸Ð²Ð°Ñ‚ÑŒ Ð½Ðµ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ ÐµÐ´Ñƒ —Ð½Ð¾ Ñ‚Ð°ÐºÐ¶Ðµ ÑÐ¼Ð¾Ñ†Ð¸Ð¸ Ð¸ Ð¿Ð¾Ð²ÑÐµÐ´Ð½ÐµÐ²Ð½ÑƒÑŽ Ð¶Ð¸Ð·Ð½ÑŒ.',
    ...
    'casos.problems.lowEnergy.description': 'ÐšÐ¾Ð³Ð´Ð° Ð²ÑÐµ Ð´Ð°ÐµÑ‚ÑÑ Ñ Ñ‚Ñ€ÑƒÐ´Ð¾Ð¼, ÐºÐ¾Ð³Ð´Ð° Ð¿Ñ€Ð¾ÑÑ‹Ð¿Ð°ÐµÑˆÑŒÑÑ ÑƒÑÑ‚Ð°Ð²ÑˆÐ¸Ð¼ Ð¸Ð»Ð¸ Ñ‡ÑƒÐ²ÑÑ‚Ð²ÑƒÐµÑˆÑŒ, Ñ‡Ñ‚Ð¾ Ñ‚ÐµÐ»Ð¾"Ð½Ðµ Ð¾Ñ‚Ð²ÐµÑ‡Ð°ÐµÑ‚". ÑÑ‚Ð¾ Ð½Ðµ Ð»ÐµÐ½ÑŒ —ÑÑ‚Ð¾ Ð½ÐµÐ´Ð¾ÑÑ‚Ð°Ñ‚Ð¾Ðº Ð²Ð½ÑƒÑ‚Ñ€ÐµÐ½Ð½ÐµÐ¹ Ñ€ÐµÐ³ÑƒÐ»ÑÑ†Ð¸Ð¸.',
    ...
    'casos.problems.backPain.results': 'ÐœÐ³Ð½Ð¾Ð²ÐµÐ½Ð½Ð¾Ðµ Ð¾Ð±Ð»ÐµÐ³Ñ‡ÐµÐ½Ð¸Ðµ Ð±Ð¾Ð»Ð¸ Ð¸ Ð½Ð°Ð¿Ñ€ÑÐ¶ÐµÐ½Ð¸Ñ. Ð’Ð¾ÑÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ Ð¿Ð¾Ð´Ð²Ð¸Ð¶Ð½Ð¾ÑÑ‚Ð¸ Ð¸ Ð»ÐµÐ³ÐºÐ¾ÑÑ‚Ð¸. Ð’ Ð´Ð¾Ð»Ð³Ð¾ÑÑ€Ð¾Ñ‡Ð½Ð¾Ð¹ Ð¿ÐµÑ€ÑÐ¿ÐµÐºÑ‚Ð¸Ð²Ðµ — Ð±Ð¾Ð»ÐµÐµ ÑÐ¸Ð»ÑŒÐ½Ð°Ñ, Ð³Ð¸Ð±ÐºÐ°Ñ ÑÐ¿Ð¸Ð½Ð° Ð±ÐµÐ· Ñ€ÐµÑ†Ð¸Ð´Ð¸Ð²Ð¸Ñ€ÑƒÑŽÑ‰ÐµÐ¹ Ð±Ð¾Ð»Ð¸.',
    ...
    'casos.problems.migraines.results': 'Ð Ð°Ð´Ð¸ÐºÐ°Ð»ÑŒÐ½Ð¾Ðµ ÑÐ½Ð¸Ð¶ÐµÐ½Ð¸Ðµ Ñ‡Ð°ÑÑ‚Ð¾Ñ‚Ñ‹ Ð¸ Ð¸Ð½Ñ‚ÐµÐ½ÑÐ¸Ð²Ð½Ð¾ÑÑ‚Ð¸ Ð¿Ñ€Ð¸ÑÑ‚ÑƒÐ¿Ð¾Ð². Ð’Ð¾ Ð¼Ð½Ð¾Ð³Ð¸Ñ… ÑÐ»ÑƒÑ‡Ð°ÑÑ… — Ð¿Ð¾Ð»Ð½Ð¾Ðµ Ð¸ÑÑ‡ÐµÐ·Ð½Ð¾Ð²ÐµÐ½Ð¸Ðµ Ð±Ð¾Ð»Ð¸. Ð¯ÑÐ½Ð¾ÑÑ‚ÑŒ ÑƒÐ¼Ð° Ð¸ ÑƒÐ»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ðµ ÑÐ°Ð¼Ð¾Ñ‡ÑƒÐ²ÑÑ‚Ð²Ð¸Ñ.',
    ...
    'whyChoose.holistic.description': 'ÐœÑ‹ Ð»ÐµÑ‡Ð¸Ð¼ Ð²Ð°Ñ Ñ†ÐµÐ»Ð¸ÐºÐ¾Ð¼ — ÑÑ‚Ñ€ÑƒÐºÑ‚ÑƒÑ€Ð½Ð¾, Ñ…Ð¸Ð¼Ð¸Ñ‡ÐµÑÐºÐ¸ Ð¸ ÑÐ¼Ð¾Ñ†Ð¸Ð¾Ð½Ð°Ð»ÑŒÐ½Ð¾. Ð˜ÑÑ‚Ð¸Ð½Ð½Ð¾Ðµ Ð¸ÑÑ†ÐµÐ»ÐµÐ½Ð¸Ðµ Ð¿Ñ€Ð¾Ð¸ÑÑ…Ð¾Ð´Ð¸Ñ‚, ÐºÐ¾Ð³Ð´Ð° Ð²ÑÐµ Ð²Ð°ÑˆÐ¸ ÑÐ¸ÑÑ‚ÐµÐ¼Ñ‹ Ñ€Ð°Ð±Ð¾Ñ‚Ð°ÑŽÑ‚ Ð² Ð³Ð°Ñ€Ð¼Ð¾Ð½Ð¸Ð¸.',
