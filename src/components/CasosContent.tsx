            ...
            {mainProblems.map((problem) => {
              ...
              return (
                <Link
                  ...
                  className="group relative bg-card rounded-apple p-8 flex flex-col h-full border border-border/50 transition duration-300 active:scale-[0.97]"
                >
                  <div className="w-14 h-14 rounded-apple bg-muted/40 flex items-center justify-center mb-6 text-foreground">
        ...
        <div className="section-container max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {additionalProblemsKeys.map((key) => (
              <div 
                key={key} 
                className="flex items-center p-4 rounded-apple bg-secondary hover:bg-muted transition-colors duration-200 cursor-default"
              >
