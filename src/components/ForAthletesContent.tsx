          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-8">
            <div className="bg-orange-50/50 border border-orange-100 rounded-[2rem] shadow-sm p-8 sm:p-12 transition-all duration-500 ease-out">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                ...
                {/* Benefits List */}
                <div className="mt-8 bg-white/60 rounded-xl p-6 border border-orange-100/50">
                   <h3 className="font-bold text-orange-900 mb-4">{t('personalized.athletes.benefits.title')}</h3>
                   <ul className="space-y-2">
                      {(t('personalized.athletes.benefits.list') as unknown as string[]).map((benefit, i) => (
                ...
                <p className="font-medium text-orange-900 mt-6">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-8">
             <h2 className="heading-2 mb-12 font-bold text-center text-eka-dark">
                {t('personalized.athletes.method.title')}
             </h2>
             <div className="grid md:grid-cols-3 gap-8">
                {[1, 2, 3].map((step) => (
                  <div key={step} className="bg-orange-50/30 rounded-2xl p-8 border border-orange-100">
                     <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 font-bold mb-4">
                        {step}
                     </div>
                     <h3 className="font-bold text-xl mb-3 text-gray-900">
                        {t(`personalized.athletes.method.step${step}.title`, {})}
                     </h3>
                     <p className="text-gray-600">
                        {t(`personalized.athletes.method.step${step}.desc`, {})}
                     </p>
                  </div>
                ))}
             </div>
